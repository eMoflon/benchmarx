package org.benchmarx.examples.ast2dag.implementations.medini;
...
public class MediniQVTAst2Dag extends BXToolForEMF<ast.Model, dag.Model, Decisions> {
	...
	private static final String fwdDir = "dagModel";
	private static final String bwdDir = "astModel";
...
//		transformation = "set2oset";
	...
	protected void collectMetaModels(Collection<EPackage> metaPackages) {
		metaPackages.add(ast.AstPackage.eINSTANCE);
		metaPackages.add(dag.DagPackage.eINSTANCE);
	}
