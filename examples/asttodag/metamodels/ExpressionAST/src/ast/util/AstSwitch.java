...
public class AstSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case AstPackage.NUMBER: {
				ast.Number number = (ast.Number)theEObject;
	 ...
	 * @generated
	 */
	public T caseNumber(ast.Number object) {
		return null;
	}
