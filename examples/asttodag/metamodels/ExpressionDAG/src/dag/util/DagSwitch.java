...
public class DagSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DagPackage.MODEL: {
				Model model = (Model)theEObject;
				T result = caseModel(model);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DagPackage.EXPRESSION: {
				Expression expression = (Expression)theEObject;
				T result = caseExpression(expression);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DagPackage.OPERATOR: {
			...
			case DagPackage.NUMBER: {
				dag.Number number = (dag.Number)theEObject;
	 ...
	 * @generated
	 */
	public T caseNumber(dag.Number object) {
		return null;
	}
