package org.benchmarx.examples.bag12bag2.implementations.medini;
...
public class MediniQVTBag12Bag2 extends BXToolForEMF<bags1.MyBag, bags2.MyBag, Decisions> {
	...
	private static final String fwdDir = "bagModel2";
	private static final String bwdDir = "bagModel1";
	...
	public MediniQVTBag12Bag2() {
		...
		basePath = "./src/org/benchmarx/examples/bag12bag2/implementations/medini/base/";
...
//		transformation = "set2oset";
	...
	public void initiateSynchronisationDialogue() {
		...
		File tracesFolder = new File("./src/org/benchmarx/examples/bag12bag2/implementations/medini/base/traces/");
	...
	private void launchFWD() {
		...
		try {
			...
			RULESET = "bag12bag2.qvt";
			transformation = "bag12bag2";

			qvtRuleSet = new FileReader(basePath + RULESET);
			this.transform(qvtRuleSet, transformation, fwdDir);
	...
	private void launchBWD() {		
		...
		try {
			...
			RULESET = "bag22bag1.qvt";
			transformation = "bag22bag1";

			qvtRuleSet = new FileReader(basePath + RULESET);
			this.transform(qvtRuleSet, transformation, bwdDir);
		} catch (FileNotFoundException fileNotFoundException) {
			fileNotFoundException.printStackTrace();
			return;
		} catch (Throwable throwable) {
	...
	protected void collectMetaModels(Collection<EPackage> metaPackages) {
		metaPackages.add(bags1.Bags1Package.eINSTANCE);
		metaPackages.add(bags2.Bags2Package.eINSTANCE);
	}
