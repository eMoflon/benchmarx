...
public class SYNC_App extends SYNC {
	...
	protected void registerUserMetamodels() throws IOException {
		...
		loadAndRegisterMetamodel("BenchmarxEcoreToSQL/lib/eMoflon/" + options.projectName() + ".ecore");
	}

	protected Resource loadFlattenedTGGResource() throws IOException {
		return loadResource("BenchmarxEcoreToSQL/lib/eMoflon/" + options.projectName() + "_flattened.tgg.xmi");
	}

	protected Resource loadTGGResource() throws IOException {
		return loadResource("BenchmarxEcoreToSQL/lib/eMoflon/" + options.projectName() + ".tgg.xmi");
	}
