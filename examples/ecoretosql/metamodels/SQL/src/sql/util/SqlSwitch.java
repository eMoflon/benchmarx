	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SqlPackage.PRIMARY_KEY: {
				...
				if (result == null) result = caseKey(primaryKey);
			...
			case SqlPackage.FOREIGN_KEY: {
				...
				if (result == null) result = caseKey(foreignKey);
				if (result == null) result = caseModelElement(foreignKey);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SqlPackage.EVENT: {
			...
			case SqlPackage.MODEL_ELEMENT: {
				ModelElement modelElement = (ModelElement)theEObject;
				T result = caseModelElement(modelElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SqlPackage.ANNOTATION: {
