...
namespace TTC2026.FamiliesToPersons.NMF.Persons
{
    ...
    public abstract partial class Person : ModelElement, IPerson, IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> BirthdayChanged;
        
        /// <summary>
        /// Gets fired before the Birthday property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> BirthdayChanging;
        
        /// <summary>
        /// Gets fired before the PersonsInverse property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> PersonsInverseChanging;
        
        /// <summary>
        /// Gets fired when the PersonsInverse property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> PersonsInverseChanged;
        
        private static ITypedElement RetrieveNameAttribute()
        {
            return ((ITypedElement)(((ModelElement)(TTC2026.FamiliesToPersons.NMF.Persons.Person.ClassInstance)).Resolve("name")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(TTC2026.FamiliesToPersons.NMF.Persons.Person.ClassInstance)).Resolve("birthday")));
        }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.BirthdayChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.BirthdayChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            return ((ITypedElement)(((ModelElement)(TTC2026.FamiliesToPersons.NMF.Persons.Person.ClassInstance)).Resolve("personsInverse")));
        }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.PersonsInverseChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.PersonsInverseChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        protected override void SetFeature(string feature, object value)
        {
            ...
            if ((feature == "BIRTHDAY"))
            {
                this.Birthday = ((System.DateTime)(value));
                return;
            }
        ...
        protected override INotifyExpression<object> GetExpressionForAttribute(string attribute)
        {
            ...
            if ((attribute == "BIRTHDAY"))
            {
                return Observable.Box(new BirthdayProxy(this));
            }
        ...
        /// </summary>
        private sealed class BirthdayProxy : ModelPropertyChange<IPerson, Nullable<System.DateTime>>
        {
