...
public class PersonsAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected PersonsSwitch<Adapter> modelSwitch = new PersonsSwitch<Adapter>() {
		@Override
		public Adapter casePersonRegister(PersonRegister object) {
			return createPersonRegisterAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link Persons.PersonRegister <em>Person Register</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createPersonRegisterAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link Persons.Person <em>Person</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
