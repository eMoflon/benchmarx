...
public class SingleElemImpl extends CorrElemImpl implements SingleElem {
	...
	protected EClass eStaticClass() {
		return CorrModelPackage.Literals.SINGLE_ELEM;
	}
		...
		if (element != null && element.eIsProxy()) {
			...
			if (element != oldElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CorrModelPackage.SINGLE_ELEM__ELEMENT, oldElement, element));
			}
		}
		return element;
	}
	...
	public void setElement(EObject newElement) {
		...
		element = newElement;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorrModelPackage.SINGLE_ELEM__ELEMENT, oldElement, element));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CorrModelPackage.SINGLE_ELEM__ELEMENT:
