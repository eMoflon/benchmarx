package containerstominiyaml.testsuite.scalability;

import static containerstominiyaml.helpers.MiniYAMLHelper.getOrCreateMapEntry;
import static containerstominiyaml.helpers.MiniYAMLHelper.scalar;
...
import containerstominiyaml.testsuite.BXToolTimer;
...
public class ScalabilityMeasurements {
	...
	private static final BXTool<Composition, miniyaml.Map, Decisions> tool1 = new YAMTLContainersToMiniYAML_BXTool("YAMTL", new MiniYAMLComparator());
