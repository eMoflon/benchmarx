 ...
 * </p>
 * <ul>
 *   <li>{@link containers.impl.CompositionImpl#getNodes <em>Nodes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CompositionImpl extends MinimalEObjectImpl.Container implements Composition {
	...
	protected EClass eStaticClass() {
		return ContainersPackage.Literals.COMPOSITION;
	}
	...
	public EList<Node> getNodes() {
		if (nodes == null) {
			nodes = new EObjectContainmentEList<Node>(Node.class, this, ContainersPackage.COMPOSITION__NODES);
		}
		return nodes;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ContainersPackage.COMPOSITION__NODES:
