 ...
 * </p>
 * <ul>
 *   <li>{@link miniyaml.impl.MapImpl#getEntries <em>Entries</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MapImpl extends ValueImpl implements Map {
	...
	protected EClass eStaticClass() {
		return MiniyamlPackage.Literals.MAP;
	}
	...
	public EList<MapEntry> getEntries() {
		if (entries == null) {
			entries = new EObjectContainmentEList<MapEntry>(MapEntry.class, this, MiniyamlPackage.MAP__ENTRIES);
		}
		return entries;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MiniyamlPackage.MAP__ENTRIES:
