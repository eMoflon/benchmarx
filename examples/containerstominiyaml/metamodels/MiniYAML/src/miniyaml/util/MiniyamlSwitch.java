 ...
 * @generated
 */
public class MiniyamlSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MiniyamlPackage.VALUE: {
				Value value = (Value)theEObject;
				T result = caseValue(value);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MiniyamlPackage.MAP: {
			...
			case MiniyamlPackage.SCALAR: {
				Scalar scalar = (Scalar)theEObject;
				T result = caseScalar(scalar);
				if (result == null) result = caseValue(scalar);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
