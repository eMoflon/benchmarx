...
public class ContainersSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ContainersPackage.COMPOSITION: {
				Composition composition = (Composition)theEObject;
				T result = caseComposition(composition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ContainersPackage.NODE: {
				Node node = (Node)theEObject;
				T result = caseNode(node);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ContainersPackage.NAMED_ELEMENT: {
			...
			case ContainersPackage.IMAGE: {
				...
				if (result == null) result = caseNode(image);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ContainersPackage.CONTAINER: {
			...
			case ContainersPackage.VOLUME_MOUNT: {
			...
			case ContainersPackage.VOLUME: {
				...
				if (result == null) result = caseNode(volume);
