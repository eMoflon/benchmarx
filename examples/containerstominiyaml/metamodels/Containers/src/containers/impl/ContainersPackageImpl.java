...
public class ContainersPackageImpl extends EPackageImpl implements ContainersPackage {
	 ...
	 * @generated
	 */
	public EAttribute getContainer_Replicas() {
	 ...
	 * @generated
	 */
	public EReference getVolumeMount_Volume() {
		return (EReference)volumeMountEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getVolumeMount_Path() {
	...
	public void createPackageContents() {
		...
		createEReference(compositionEClass, COMPOSITION__NODES);
		...
		createEAttribute(containerEClass, CONTAINER__REPLICAS);
		...
		createEReference(volumeMountEClass, VOLUME_MOUNT__VOLUME);
		createEAttribute(volumeMountEClass, VOLUME_MOUNT__PATH);
	...
	public void initializePackageContents() {
		...
		imageEClass.getESuperTypes().add(this.getNode());
		containerEClass.getESuperTypes().add(this.getNode());
		containerEClass.getESuperTypes().add(this.getNamedElement());
		volumeEClass.getESuperTypes().add(this.getNode());
		volumeEClass.getESuperTypes().add(this.getNamedElement());

		// Initialize classes, features, and operations; add parameters
		initEClass(compositionEClass, Composition.class, "Composition", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getComposition_Nodes(), this.getNode(), null, "nodes", null, 0, -1, Composition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getContainer_Replicas(), ecorePackage.getEInt(), "replicas", "1", 0, 1, containers.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContainer_Image(), this.getImage(), null, "image", null, 0, 1, containers.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContainer_DependsOn(), this.getContainer(), null, "dependsOn", null, 0, -1, containers.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContainer_VolumeMounts(), this.getVolumeMount(), null, "volumeMounts", null, 0, -1, containers.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(volumeMountEClass, VolumeMount.class, "VolumeMount", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getVolumeMount_Volume(), this.getVolume(), null, "volume", null, 0, 1, VolumeMount.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVolumeMount_Path(), ecorePackage.getEString(), "path", null, 0, 1, VolumeMount.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
