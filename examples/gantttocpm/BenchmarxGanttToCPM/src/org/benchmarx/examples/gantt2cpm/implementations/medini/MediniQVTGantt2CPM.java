package org.benchmarx.examples.gantt2cpm.implementations.medini;
...
public class MediniQVTGantt2CPM extends BXToolForEMF<GanttDiagram, CPMNetwork, Decisions> {
	private static final String RULESET = "gantt2cpm.qvt";
	...
	private static final String fwdDir = "network";
	private static final String bwdDir = "diagram";
	...
	public void initiateSynchronisationDialogue() {
		...
		source.getContents().add(gantt.GanttFactory.eINSTANCE.createGanttDiagram());
		launchFWD();
	}
	...
	protected void collectMetaModels(Collection<EPackage> metaPackages) {
		metaPackages.add(gantt.GanttPackage.eINSTANCE);
		metaPackages.add(cpm.CpmPackage.eINSTANCE);
	}
