...
import de.university.hof.genai.f2p.IncrementalModelTransformer;

public class GPTFamiliesToPersonsIncremental extends BXToolForEMF<FamilyRegister, PersonRegister, Decisions> {
	private ResourceSet set = new ResourceSetImpl();
	private Resource source;
	private Resource target;
	private Resource corr;
	private IncrementalModelTransformer gptTrans;
	...
	public GPTFamiliesToPersonsIncremental() {
	...
	public String getName() {
		return "Incremental ChatGPT Transformation";
	}
	...
	public void initiateSynchronisationDialogue() {
		...
		gptTrans = new IncrementalModelTransformer(source, target);
