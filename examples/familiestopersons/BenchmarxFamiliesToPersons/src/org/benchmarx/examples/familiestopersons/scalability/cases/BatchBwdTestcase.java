...
public class BatchBwdTestcase extends BenchTestcase {
	public static void main(String args[]) {
		new BatchBwdTestcase(args[0], Integer.valueOf(args[1])).execute();
	}

	public BatchBwdTestcase(String toolName, int scaleFactor) {
