...
public interface FamiliesToPersonsIBeXTGGPackage extends SmartPackage {
	...
	int PROTOCOL_NODE__DAUGHTER_OF_EXISTING_FAMILY_TO_FEMALE__CREAT_E__SOURC_E__FM = 9;
	int PROTOCOL_NODE__DAUGHTER_OF_EXISTING_FAMILY_TO_FEMALE__CREAT_E__CORRESPONDENC_E__FAMILY_MEMBER2_PERSONS = 10;
	int PROTOCOL_NODE__DAUGHTER_OF_EXISTING_FAMILY_TO_FEMALE__CONTEX_T__TARGE_T__PERSONS = 11;
	int PROTOCOL_NODE__DAUGHTER_OF_EXISTING_FAMILY_TO_FEMALE__CREAT_E__TARGE_T__P = 12;
	int PROTOCOL_NODE__DAUGHTER_OF_EXISTING_FAMILY_TO_FEMALE_FEATURE_COUNT = 6;
	int PROTOCOL_NODE__DAUGHTER_OF_EXISTING_FAMILY_TO_FEMALE_OPERATION_COUNT = 0;
	
	int PROTOCOL_NODE__DAUGHTER_TO_FEMALE = 5;
	int PROTOCOL_NODE__DAUGHTER_TO_FEMALE__CONTEX_T__SOURC_E__FAMILIES = 13;
	int PROTOCOL_NODE__DAUGHTER_TO_FEMALE__CREAT_E__SOURC_E__F = 14;
	int PROTOCOL_NODE__DAUGHTER_TO_FEMALE__CREAT_E__SOURC_E__FM = 15;
	int PROTOCOL_NODE__DAUGHTER_TO_FEMALE__CREAT_E__CORRESPONDENC_E__FAMILY_MEMBER2_PERSONS = 16;
	int PROTOCOL_NODE__DAUGHTER_TO_FEMALE__CONTEX_T__TARGE_T__PERSONS = 17;
	int PROTOCOL_NODE__DAUGHTER_TO_FEMALE__CREAT_E__TARGE_T__P = 18;
	int PROTOCOL_NODE__DAUGHTER_TO_FEMALE_FEATURE_COUNT = 7;
	int PROTOCOL_NODE__DAUGHTER_TO_FEMALE_OPERATION_COUNT = 0;
	
	int PROTOCOL_NODE__FAMILIES2_PERSONS = 6;
	int PROTOCOL_NODE__FAMILIES2_PERSONS__CREAT_E__SOURC_E__FAMILIES = 19;
	int PROTOCOL_NODE__FAMILIES2_PERSONS__CREAT_E__CORRESPONDENC_E__FAMILIES2PERSONS = 20;
	int PROTOCOL_NODE__FAMILIES2_PERSONS__CREAT_E__TARGE_T__PERSONS = 21;
	...
	int PROTOCOL_NODE__FATHER_OF_EXISTING_FAMILY_TO_MALE__CONTEX_T__SOURC_E__F = 22;
	int PROTOCOL_NODE__FATHER_OF_EXISTING_FAMILY_TO_MALE__CREAT_E__SOURC_E__FM = 23;
	int PROTOCOL_NODE__FATHER_OF_EXISTING_FAMILY_TO_MALE__CREAT_E__CORRESPONDENC_E__FAMILY_MEMBER2_PERSONS = 24;
	int PROTOCOL_NODE__FATHER_OF_EXISTING_FAMILY_TO_MALE__CONTEX_T__TARGE_T__PERSONS = 25;
	int PROTOCOL_NODE__FATHER_OF_EXISTING_FAMILY_TO_MALE__CREAT_E__TARGE_T__P = 26;
	int PROTOCOL_NODE__FATHER_OF_EXISTING_FAMILY_TO_MALE_FEATURE_COUNT = 6;
	int PROTOCOL_NODE__FATHER_OF_EXISTING_FAMILY_TO_MALE_OPERATION_COUNT = 0;
	
	int PROTOCOL_NODE__FATHER_TO_MALE = 8;
	int PROTOCOL_NODE__FATHER_TO_MALE__CONTEX_T__SOURC_E__FAMILIES = 27;
	int PROTOCOL_NODE__FATHER_TO_MALE__CREAT_E__SOURC_E__F = 28;
	int PROTOCOL_NODE__FATHER_TO_MALE__CREAT_E__SOURC_E__FM = 29;
	int PROTOCOL_NODE__FATHER_TO_MALE__CREAT_E__CORRESPONDENC_E__FAMILY_MEMBER2_PERSONS = 30;
	int PROTOCOL_NODE__FATHER_TO_MALE__CONTEX_T__TARGE_T__PERSONS = 31;
	int PROTOCOL_NODE__FATHER_TO_MALE__CREAT_E__TARGE_T__P = 32;
	int PROTOCOL_NODE__FATHER_TO_MALE_FEATURE_COUNT = 7;
	int PROTOCOL_NODE__FATHER_TO_MALE_OPERATION_COUNT = 0;
	
	int PROTOCOL_NODE__MOTHER_OF_EXISTING_FAMILY_TO_FEMALE = 9;
	int PROTOCOL_NODE__MOTHER_OF_EXISTING_FAMILY_TO_FEMALE__CONTEX_T__SOURC_E__F = 33;
	int PROTOCOL_NODE__MOTHER_OF_EXISTING_FAMILY_TO_FEMALE__CREAT_E__SOURC_E__FM = 34;
	int PROTOCOL_NODE__MOTHER_OF_EXISTING_FAMILY_TO_FEMALE__CREAT_E__CORRESPONDENC_E__FAMILY_MEMBER2_PERSONS = 35;
	int PROTOCOL_NODE__MOTHER_OF_EXISTING_FAMILY_TO_FEMALE__CONTEX_T__TARGE_T__PERSONS = 36;
	int PROTOCOL_NODE__MOTHER_OF_EXISTING_FAMILY_TO_FEMALE__CREAT_E__TARGE_T__P = 37;
	int PROTOCOL_NODE__MOTHER_OF_EXISTING_FAMILY_TO_FEMALE_FEATURE_COUNT = 6;
	int PROTOCOL_NODE__MOTHER_OF_EXISTING_FAMILY_TO_FEMALE_OPERATION_COUNT = 0;
	
	int PROTOCOL_NODE__MOTHER_TO_FEMALE = 10;
	int PROTOCOL_NODE__MOTHER_TO_FEMALE__CONTEX_T__SOURC_E__FAMILIES = 38;
	int PROTOCOL_NODE__MOTHER_TO_FEMALE__CREAT_E__SOURC_E__F = 39;
	int PROTOCOL_NODE__MOTHER_TO_FEMALE__CREAT_E__SOURC_E__FM = 40;
	int PROTOCOL_NODE__MOTHER_TO_FEMALE__CREAT_E__CORRESPONDENC_E__FAMILY_MEMBER2_PERSONS = 41;
	int PROTOCOL_NODE__MOTHER_TO_FEMALE__CONTEX_T__TARGE_T__PERSONS = 42;
	int PROTOCOL_NODE__MOTHER_TO_FEMALE__CREAT_E__TARGE_T__P = 43;
	int PROTOCOL_NODE__MOTHER_TO_FEMALE_FEATURE_COUNT = 7;
	int PROTOCOL_NODE__MOTHER_TO_FEMALE_OPERATION_COUNT = 0;
	
	int PROTOCOL_NODE__SON_OF_EXISTING_FAMILY_TO_MALE = 11;
	int PROTOCOL_NODE__SON_OF_EXISTING_FAMILY_TO_MALE__CONTEX_T__SOURC_E__F = 44;
	int PROTOCOL_NODE__SON_OF_EXISTING_FAMILY_TO_MALE__CREAT_E__SOURC_E__FM = 45;
	int PROTOCOL_NODE__SON_OF_EXISTING_FAMILY_TO_MALE__CREAT_E__CORRESPONDENC_E__FAMILY_MEMBER2_PERSONS = 46;
	int PROTOCOL_NODE__SON_OF_EXISTING_FAMILY_TO_MALE__CONTEX_T__TARGE_T__PERSONS = 47;
	int PROTOCOL_NODE__SON_OF_EXISTING_FAMILY_TO_MALE__CREAT_E__TARGE_T__P = 48;
	int PROTOCOL_NODE__SON_OF_EXISTING_FAMILY_TO_MALE_FEATURE_COUNT = 6;
	int PROTOCOL_NODE__SON_OF_EXISTING_FAMILY_TO_MALE_OPERATION_COUNT = 0;
	
	int PROTOCOL_NODE__SON_TO_MALE = 12;
	int PROTOCOL_NODE__SON_TO_MALE__CONTEX_T__SOURC_E__FAMILIES = 49;
	int PROTOCOL_NODE__SON_TO_MALE__CREAT_E__SOURC_E__F = 50;
	int PROTOCOL_NODE__SON_TO_MALE__CREAT_E__SOURC_E__FM = 51;
	int PROTOCOL_NODE__SON_TO_MALE__CREAT_E__CORRESPONDENC_E__FAMILY_MEMBER2_PERSONS = 52;
	int PROTOCOL_NODE__SON_TO_MALE__CONTEX_T__TARGE_T__PERSONS = 53;
	int PROTOCOL_NODE__SON_TO_MALE__CREAT_E__TARGE_T__P = 54;
	int PROTOCOL_NODE__SON_TO_MALE_FEATURE_COUNT = 7;
