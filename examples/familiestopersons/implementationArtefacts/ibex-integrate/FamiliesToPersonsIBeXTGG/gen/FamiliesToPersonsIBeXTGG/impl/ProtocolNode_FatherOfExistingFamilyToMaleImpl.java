...
public class ProtocolNode_FatherOfExistingFamilyToMaleImpl extends SmartObject implements FamiliesToPersonsIBeXTGG.ProtocolNode_FatherOfExistingFamilyToMale {
	...
	protected ProtocolNode_FatherOfExistingFamilyToMaleImpl() {
		super(FamiliesToPersonsIBeXTGGPackage.Literals.PROTOCOL_NODE__FATHER_OF_EXISTING_FAMILY_TO_MALE);
	}
    ...
    public void setCONTEXT__SOURCE__f(FamiliesSmartEMF.Family value) {
    	...
    	if(value != null && value.equals(oldValue))
    		return;
    	        	...
    	        	sendNotification(SmartEMFNotification.createSetNotification(this, FamiliesToPersonsIBeXTGGPackage.Literals.PROTOCOL_NODE__FATHER_OF_EXISTING_FAMILY_TO_MALE__CONTEX_T__SOURC_E__F, oldValue, value, -1));
    	        	
    	        	if(FamiliesToPersonsIBeXTGGPackage.Literals.PROTOCOL_NODE__FATHER_OF_EXISTING_FAMILY_TO_MALE__CONTEX_T__SOURC_E__F.getEOpposite() != null) {
    	        		if(oldValue != null) {
    	        			((SmartObject) oldValue).eInverseRemove(this, FamiliesToPersonsIBeXTGGPackage.Literals.PROTOCOL_NODE__FATHER_OF_EXISTING_FAMILY_TO_MALE__CONTEX_T__SOURC_E__F.getEOpposite());
    	        		}
    	        		if(value != null) {
    	        		    ((SmartObject) value).eInverseAdd(this, FamiliesToPersonsIBeXTGGPackage.Literals.PROTOCOL_NODE__FATHER_OF_EXISTING_FAMILY_TO_MALE__CONTEX_T__SOURC_E__F.getEOpposite());
    	        		}
    	        	}
    }
    ...
    public void setCREATE__SOURCE__fm(FamiliesSmartEMF.FamilyMember value) {
    	...
    	if(value != null && value.equals(oldValue))
    		return;
    	        	...
    	        	sendNotification(SmartEMFNotification.createSetNotification(this, FamiliesToPersonsIBeXTGGPackage.Literals.PROTOCOL_NODE__FATHER_OF_EXISTING_FAMILY_TO_MALE__CREAT_E__SOURC_E__FM, oldValue, value, -1));
    	        	
    	        	if(FamiliesToPersonsIBeXTGGPackage.Literals.PROTOCOL_NODE__FATHER_OF_EXISTING_FAMILY_TO_MALE__CREAT_E__SOURC_E__FM.getEOpposite() != null) {
    	        		if(oldValue != null) {
    	        			((SmartObject) oldValue).eInverseRemove(this, FamiliesToPersonsIBeXTGGPackage.Literals.PROTOCOL_NODE__FATHER_OF_EXISTING_FAMILY_TO_MALE__CREAT_E__SOURC_E__FM.getEOpposite());
    	        		}
    	        		if(value != null) {
    ...
    public void setCREATE__CORRESPONDENCE__familyMember2Persons(FamiliesToPersonsIBeXTGG.FamilyMemberToPersonCorr value) {
    	...
    	if(value != null && value.equals(oldValue))
    		return;
    	        	...
    	        	sendNotification(SmartEMFNotification.createSetNotification(this, FamiliesToPersonsIBeXTGGPackage.Literals.PROTOCOL_NODE__FATHER_OF_EXISTING_FAMILY_TO_MALE__CREAT_E__CORRESPONDENC_E__FAMILY_MEMBER2_PERSONS, oldValue, value, -1));
    	        	
    	        	if(FamiliesToPersonsIBeXTGGPackage.Literals.PROTOCOL_NODE__FATHER_OF_EXISTING_FAMILY_TO_MALE__CREAT_E__CORRESPONDENC_E__FAMILY_MEMBER2_PERSONS.getEOpposite() != null) {
    	        		if(oldValue != null) {
    	        			((SmartObject) oldValue).eInverseRemove(this, FamiliesToPersonsIBeXTGGPackage.Literals.PROTOCOL_NODE__FATHER_OF_EXISTING_FAMILY_TO_MALE__CREAT_E__CORRESPONDENC_E__FAMILY_MEMBER2_PERSONS.getEOpposite());
    	        		}
    	        		if(value != null) {
    	        		    ((SmartObject) value).eInverseAdd(this, FamiliesToPersonsIBeXTGGPackage.Literals.PROTOCOL_NODE__FATHER_OF_EXISTING_FAMILY_TO_MALE__CREAT_E__CORRESPONDENC_E__FAMILY_MEMBER2_PERSONS.getEOpposite());
    	        		}
    	        	}
    }
    ...
    public void setCONTEXT__TARGET__persons(PersonsSmartEMF.PersonRegister value) {
    	...
    	if(value != null && value.equals(oldValue))
    		return;
    	        	...
    	        	sendNotification(SmartEMFNotification.createSetNotification(this, FamiliesToPersonsIBeXTGGPackage.Literals.PROTOCOL_NODE__FATHER_OF_EXISTING_FAMILY_TO_MALE__CONTEX_T__TARGE_T__PERSONS, oldValue, value, -1));
    	        	
    	        	if(FamiliesToPersonsIBeXTGGPackage.Literals.PROTOCOL_NODE__FATHER_OF_EXISTING_FAMILY_TO_MALE__CONTEX_T__TARGE_T__PERSONS.getEOpposite() != null) {
    	        		if(oldValue != null) {
    	        			((SmartObject) oldValue).eInverseRemove(this, FamiliesToPersonsIBeXTGGPackage.Literals.PROTOCOL_NODE__FATHER_OF_EXISTING_FAMILY_TO_MALE__CONTEX_T__TARGE_T__PERSONS.getEOpposite());
    	        		}
    	        		if(value != null) {
    	        		    ((SmartObject) value).eInverseAdd(this, FamiliesToPersonsIBeXTGGPackage.Literals.PROTOCOL_NODE__FATHER_OF_EXISTING_FAMILY_TO_MALE__CONTEX_T__TARGE_T__PERSONS.getEOpposite());
    	        		}
    	        	}
    }
    ...
    public void setCREATE__TARGET__p(PersonsSmartEMF.Male value) {
    	...
    	if(value != null && value.equals(oldValue))
    		return;
    	        	...
    	        	sendNotification(SmartEMFNotification.createSetNotification(this, FamiliesToPersonsIBeXTGGPackage.Literals.PROTOCOL_NODE__FATHER_OF_EXISTING_FAMILY_TO_MALE__CREAT_E__TARGE_T__P, oldValue, value, -1));
    	        	
    	        	if(FamiliesToPersonsIBeXTGGPackage.Literals.PROTOCOL_NODE__FATHER_OF_EXISTING_FAMILY_TO_MALE__CREAT_E__TARGE_T__P.getEOpposite() != null) {
    	        		if(oldValue != null) {
    	        			((SmartObject) oldValue).eInverseRemove(this, FamiliesToPersonsIBeXTGGPackage.Literals.PROTOCOL_NODE__FATHER_OF_EXISTING_FAMILY_TO_MALE__CREAT_E__TARGE_T__P.getEOpposite());
    	        		}
    	        		if(value != null) {
    	        		    ((SmartObject) value).eInverseAdd(this, FamiliesToPersonsIBeXTGGPackage.Literals.PROTOCOL_NODE__FATHER_OF_EXISTING_FAMILY_TO_MALE__CREAT_E__TARGE_T__P.getEOpposite());
    	        		}
    	        	}
    }
    ...
    public void eSet(EStructuralFeature eFeature, Object newValue){
    	...
    	if (FamiliesToPersonsIBeXTGGPackage.Literals.PROTOCOL_NODE__FATHER_OF_EXISTING_FAMILY_TO_MALE__CREAT_E__TARGE_T__P.equals(eFeature)) {
