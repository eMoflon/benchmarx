...
public class MotherToFemale__FWD_90 extends GenericStatelessSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		nac = new NACQueryChecker(this, 0, "MotherToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_81", name2actor.get("MotherToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_81"), 2);
		name2explorer.put("nac", nac);
		nac_0 = new NACQueryChecker(this, 1, "MotherToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_84", name2actor.get("MotherToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_84"), 2);
		name2explorer.put("nac_0", nac_0);
		nac_1 = new NACQueryChecker(this, 2, "MotherToFemale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_87", name2actor.get("MotherToFemale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_87"), 2);
			...
			case "FamilyRegister_object_SP1": 
				{
					if(!lazy_initialization) {
						{
							// families
							var match_0 = new StatelessDeltaMatch(msg, "MotherToFemale__FWD_90", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Family_object_SP3": 
				{
					{
						// f
						var match_1 = new StatelessDeltaMatch(msg, "MotherToFemale__FWD_90", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP4": 
				{
					if(!lazy_initialization) {
						{
							// fm
							var match_2 = new StatelessDeltaMatch(msg, "MotherToFemale__FWD_90", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "RegisterToRegisterCorr_object_SP1": 
				{
					if(!lazy_initialization) {
						{
							// families2persons
							var match_3 = new StatelessDeltaMatch(msg, "MotherToFemale__FWD_90", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP1": 
				{
					if(!lazy_initialization) {
						{
							// persons
							var match_4 = new StatelessDeltaMatch(msg, "MotherToFemale__FWD_90", numberOfNodes, 3, UsingDeltaMode.CREATE);
				...
				break;
			case "MotherToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_81": 
				{
					if(!lazy_initialization) {
						var inputMatch = (StatelessDeltaMatch) match;
						{
							var match_0 = new StatelessDeltaMatch(msg, "MotherToFemale__FWD_90", numberOfNodes, 3, UsingDeltaMode.DELETE);
				...
				break;
			case "MotherToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_84": 
				{
					if(!lazy_initialization) {
						var inputMatch = (StatelessDeltaMatch) match;
						{
							var match_1 = new StatelessDeltaMatch(msg, "MotherToFemale__FWD_90", numberOfNodes, 3, UsingDeltaMode.DELETE);
				...
				break;
			case "MotherToFemale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_87": 
				{
					if(!lazy_initialization) {
						var inputMatch = (StatelessDeltaMatch) match;
						{
							var match_2 = new StatelessDeltaMatch(msg, "MotherToFemale__FWD_90", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "RegisterToRegisterCorr_object_SP1": 
				{
					{
						// families2persons
						var match_3 = new StatelessDeltaMatch(msg, "MotherToFemale__FWD_90", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_3.getNodes()[3] = objs[0];
						match_3.registerSignatureIndex(3);
						if(options.trackMatchingProcess)
			...
			case "PersonRegister_object_SP1": 
				{
					{
						// persons
						var match_4 = new StatelessDeltaMatch(msg, "MotherToFemale__FWD_90", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_4.getNodes()[4] = objs[0];
						match_4.registerSignatureIndex(4);
						if(options.trackMatchingProcess)
			...
			{
				{
					...
					var match = new StatelessDeltaMatch(msg, "MotherToFemale__FWD_90", numberOfNodes, 3, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[2] = msg.target;
					if(options.trackMatchingProcess)
	...
	protected void removeReference(ReferenceDeleted msg) {
			...
			case "FamiliesSmartEMF.Family_mother_FamilyMember": 
		{
			...
			var match = new StatelessDeltaMatch(msg, "MotherToFemale__FWD_90", numberOfNodes, 3, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[1] = msg.source;
			objs[2] = msg.target;
			if(options.trackMatchingProcess)
