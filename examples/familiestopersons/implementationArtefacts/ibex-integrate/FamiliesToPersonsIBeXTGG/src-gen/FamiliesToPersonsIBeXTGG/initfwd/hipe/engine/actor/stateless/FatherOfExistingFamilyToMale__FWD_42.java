...
public class FatherOfExistingFamilyToMale__FWD_42 extends GenericStatelessSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		nac = new NACQueryChecker(this, 0, "FatherOfExistingFamilyToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_33", name2actor.get("FatherOfExistingFamilyToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_33"), 1);
		name2explorer.put("nac", nac);
		nac_0 = new NACQueryChecker(this, 1, "FatherOfExistingFamilyToMale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_36", name2actor.get("FatherOfExistingFamilyToMale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_36"), 1);
		name2explorer.put("nac_0", nac_0);
		nac_1 = new NACQueryChecker(this, 2, "FatherOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_39", name2actor.get("FatherOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_39"), 1);
			...
			case "Family_object_SP0": 
				{
					{
						// f
						var match_0 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__FWD_42", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP0": 
				{
					{
						// fm
						var match_1 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__FWD_42", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP0": 
				{
					{
						// persons
						var match_2 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__FWD_42", numberOfNodes, 3, UsingDeltaMode.CREATE);
				...
				break;
			case "FatherOfExistingFamilyToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_33": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_0 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__FWD_42", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "FatherOfExistingFamilyToMale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_36": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_1 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__FWD_42", numberOfNodes, 3, UsingDeltaMode.DELETE);
				...
				break;
			case "FatherOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_39": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_2 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__FWD_42", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			{
				{
					...
					var match = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__FWD_42", numberOfNodes, 3, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					if(options.trackMatchingProcess)
	...
	protected void removeReference(ReferenceDeleted msg) {
			...
			case "FamiliesSmartEMF.Family_father_FamilyMember": 
		{
			...
			var match = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__FWD_42", numberOfNodes, 3, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[0] = msg.source;
			objs[1] = msg.target;
			if(options.trackMatchingProcess)
