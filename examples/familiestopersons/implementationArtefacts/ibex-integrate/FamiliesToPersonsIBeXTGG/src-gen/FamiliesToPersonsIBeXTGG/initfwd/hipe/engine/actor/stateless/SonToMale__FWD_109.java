...
public class SonToMale__FWD_109 extends GenericStatelessSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		nac = new NACQueryChecker(this, 0, "SonToMale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_100", name2actor.get("SonToMale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_100"), 2);
		name2explorer.put("nac", nac);
		nac_0 = new NACQueryChecker(this, 1, "SonToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_103", name2actor.get("SonToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_103"), 2);
		name2explorer.put("nac_0", nac_0);
		nac_1 = new NACQueryChecker(this, 2, "SonToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_106", name2actor.get("SonToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_106"), 2);
			...
			case "FamilyRegister_object_SP1": 
				{
					{
						// families
						var match_0 = new StatelessDeltaMatch(msg, "SonToMale__FWD_109", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Family_object_SP2": 
				{
					{
						// f
						var match_1 = new StatelessDeltaMatch(msg, "SonToMale__FWD_109", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP4": 
				{
					{
						// fm
						var match_2 = new StatelessDeltaMatch(msg, "SonToMale__FWD_109", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP1": 
				{
					{
						// persons
						var match_3 = new StatelessDeltaMatch(msg, "SonToMale__FWD_109", numberOfNodes, 3, UsingDeltaMode.CREATE);
				...
				break;
			case "SonToMale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_100": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_0 = new StatelessDeltaMatch(msg, "SonToMale__FWD_109", numberOfNodes, 3, UsingDeltaMode.DELETE);
				...
				break;
			case "SonToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_103": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_1 = new StatelessDeltaMatch(msg, "SonToMale__FWD_109", numberOfNodes, 3, UsingDeltaMode.DELETE);
				...
				break;
			case "SonToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_106": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_2 = new StatelessDeltaMatch(msg, "SonToMale__FWD_109", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "PersonRegister_object_SP1": 
				{
					{
						// persons
						var match_3 = new StatelessDeltaMatch(msg, "SonToMale__FWD_109", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_3.getNodes()[3] = objs[0];
						match_3.registerSignatureIndex(3);
						if(options.trackMatchingProcess)
			...
			{
				{
					...
					var match = new StatelessDeltaMatch(msg, "SonToMale__FWD_109", numberOfNodes, 3, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[2] = msg.target;
					if(options.trackMatchingProcess)
	...
	protected void removeReference(ReferenceDeleted msg) {
			...
			case "FamiliesSmartEMF.Family_sons_FamilyMember": 
		{
			...
			var match = new StatelessDeltaMatch(msg, "SonToMale__FWD_109", numberOfNodes, 3, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[1] = msg.source;
			objs[2] = msg.target;
			if(options.trackMatchingProcess)
