...
import FamiliesToPersonsIBeXTGG.initfwd.hipe.engine.actor.stateless.DaughterOfExistingFamilyToFemale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_7;
import FamiliesToPersonsIBeXTGG.initfwd.hipe.engine.actor.stateless.DaughterOfExistingFamilyToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_10;
import FamiliesToPersonsIBeXTGG.initfwd.hipe.engine.actor.stateless.DaughterOfExistingFamilyToFemale__FWD_13;
import FamiliesToPersonsIBeXTGG.initfwd.hipe.engine.actor.stateless.DaughterToFemale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_17;
import FamiliesToPersonsIBeXTGG.initfwd.hipe.engine.actor.stateless.DaughterToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_20;
import FamiliesToPersonsIBeXTGG.initfwd.hipe.engine.actor.stateless.DaughterToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_23;
import FamiliesToPersonsIBeXTGG.initfwd.hipe.engine.actor.stateless.DaughterToFemale__FWD_26;
import FamiliesToPersonsIBeXTGG.initfwd.hipe.engine.actor.stateless.Families2Persons__FWD_31;
import FamiliesToPersonsIBeXTGG.initfwd.hipe.engine.actor.stateless.FatherOfExistingFamilyToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_33;
...
import FamiliesToPersonsIBeXTGG.initfwd.hipe.engine.actor.stateless.FatherOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_39;
import FamiliesToPersonsIBeXTGG.initfwd.hipe.engine.actor.stateless.FatherOfExistingFamilyToMale__FWD_42;
import FamiliesToPersonsIBeXTGG.initfwd.hipe.engine.actor.stateless.FatherToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_46;
import FamiliesToPersonsIBeXTGG.initfwd.hipe.engine.actor.stateless.FatherToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_49;
import FamiliesToPersonsIBeXTGG.initfwd.hipe.engine.actor.stateless.FatherToMale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_52;
import FamiliesToPersonsIBeXTGG.initfwd.hipe.engine.actor.stateless.FatherToMale__FWD_55;
import FamiliesToPersonsIBeXTGG.initfwd.hipe.engine.actor.stateless.MotherOfExistingFamilyToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_60;
import FamiliesToPersonsIBeXTGG.initfwd.hipe.engine.actor.stateless.MotherOfExistingFamilyToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_63;
import FamiliesToPersonsIBeXTGG.initfwd.hipe.engine.actor.stateless.MotherOfExistingFamilyToFemale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_66;
import FamiliesToPersonsIBeXTGG.initfwd.hipe.engine.actor.stateless.MotherOfExistingFamilyToFemale__FWD_69;
import FamiliesToPersonsIBeXTGG.initfwd.hipe.engine.actor.stateless.MotherToFemale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_73;
import FamiliesToPersonsIBeXTGG.initfwd.hipe.engine.actor.stateless.MotherToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_76;
import FamiliesToPersonsIBeXTGG.initfwd.hipe.engine.actor.stateless.MotherToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_79;
import FamiliesToPersonsIBeXTGG.initfwd.hipe.engine.actor.stateless.MotherToFemale__FWD_82;
import FamiliesToPersonsIBeXTGG.initfwd.hipe.engine.actor.stateless.SonOfExistingFamilyToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_87;
import FamiliesToPersonsIBeXTGG.initfwd.hipe.engine.actor.stateless.SonOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_90;
import FamiliesToPersonsIBeXTGG.initfwd.hipe.engine.actor.stateless.SonOfExistingFamilyToMale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_93;
import FamiliesToPersonsIBeXTGG.initfwd.hipe.engine.actor.stateless.SonOfExistingFamilyToMale__FWD_96;
import FamiliesToPersonsIBeXTGG.initfwd.hipe.engine.actor.stateless.SonToMale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_100;
import FamiliesToPersonsIBeXTGG.initfwd.hipe.engine.actor.stateless.SonToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_103;
import FamiliesToPersonsIBeXTGG.initfwd.hipe.engine.actor.stateless.SonToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_106;
import FamiliesToPersonsIBeXTGG.initfwd.hipe.engine.actor.stateless.SonToMale__FWD_109;
...
public class HiPEEngine extends IHiPEEngine{
	...
	public void createJunctionNodes() {
		...
		classes.put("DaughterOfExistingFamilyToFemale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_7", DaughterOfExistingFamilyToFemale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_7.class);
		classes.put("DaughterOfExistingFamilyToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_10", DaughterOfExistingFamilyToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_10.class);
		classes.put("DaughterOfExistingFamilyToFemale__FWD_13", DaughterOfExistingFamilyToFemale__FWD_13.class);
		classes.put("DaughterToFemale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_17", DaughterToFemale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_17.class);
		classes.put("DaughterToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_20", DaughterToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_20.class);
		classes.put("DaughterToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_23", DaughterToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_23.class);
		classes.put("DaughterToFemale__FWD_26", DaughterToFemale__FWD_26.class);
		classes.put("Families2Persons__FWD_31", Families2Persons__FWD_31.class);
		classes.put("FatherOfExistingFamilyToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_33", FatherOfExistingFamilyToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_33.class);
		...
		classes.put("FatherOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_39", FatherOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_39.class);
		classes.put("FatherOfExistingFamilyToMale__FWD_42", FatherOfExistingFamilyToMale__FWD_42.class);
		classes.put("FatherToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_46", FatherToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_46.class);
		classes.put("FatherToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_49", FatherToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_49.class);
		classes.put("FatherToMale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_52", FatherToMale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_52.class);
		classes.put("FatherToMale__FWD_55", FatherToMale__FWD_55.class);
		classes.put("MotherOfExistingFamilyToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_60", MotherOfExistingFamilyToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_60.class);
		classes.put("MotherOfExistingFamilyToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_63", MotherOfExistingFamilyToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_63.class);
		classes.put("MotherOfExistingFamilyToFemale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_66", MotherOfExistingFamilyToFemale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_66.class);
		classes.put("MotherOfExistingFamilyToFemale__FWD_69", MotherOfExistingFamilyToFemale__FWD_69.class);
		classes.put("MotherToFemale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_73", MotherToFemale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_73.class);
		classes.put("MotherToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_76", MotherToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_76.class);
		classes.put("MotherToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_79", MotherToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_79.class);
		classes.put("MotherToFemale__FWD_82", MotherToFemale__FWD_82.class);
		classes.put("SonOfExistingFamilyToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_87", SonOfExistingFamilyToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_87.class);
		classes.put("SonOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_90", SonOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_90.class);
		classes.put("SonOfExistingFamilyToMale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_93", SonOfExistingFamilyToMale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_93.class);
		classes.put("SonOfExistingFamilyToMale__FWD_96", SonOfExistingFamilyToMale__FWD_96.class);
		classes.put("SonToMale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_100", SonToMale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_100.class);
		classes.put("SonToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_103", SonToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_103.class);
		classes.put("SonToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_106", SonToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_106.class);
		classes.put("SonToMale__FWD_109", SonToMale__FWD_109.class);
	}
