...
public class FatherToMale__FWD_60 extends GenericStatelessSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		nac = new NACQueryChecker(this, 0, "FatherToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_51", name2actor.get("FatherToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_51"), 2);
		name2explorer.put("nac", nac);
		nac_0 = new NACQueryChecker(this, 1, "FatherToMale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_54", name2actor.get("FatherToMale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_54"), 2);
		name2explorer.put("nac_0", nac_0);
		nac_1 = new NACQueryChecker(this, 2, "FatherToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_57", name2actor.get("FatherToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_57"), 2);
			...
			case "FamilyRegister_object_SP2": 
				{
					if(!lazy_initialization) {
						{
							// families
							var match_0 = new StatelessDeltaMatch(msg, "FatherToMale__FWD_60", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Family_object_SP4": 
				{
					{
						// f
						var match_1 = new StatelessDeltaMatch(msg, "FatherToMale__FWD_60", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP4": 
				{
					if(!lazy_initialization) {
						{
							// fm
							var match_2 = new StatelessDeltaMatch(msg, "FatherToMale__FWD_60", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "RegisterToRegisterCorr_object_SP1": 
				{
					if(!lazy_initialization) {
						{
							// families2persons
							var match_3 = new StatelessDeltaMatch(msg, "FatherToMale__FWD_60", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP1": 
				{
					if(!lazy_initialization) {
						{
							// persons
							var match_4 = new StatelessDeltaMatch(msg, "FatherToMale__FWD_60", numberOfNodes, 3, UsingDeltaMode.CREATE);
				...
				break;
			case "FatherToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_51": 
				{
					if(!lazy_initialization) {
						var inputMatch = (StatelessDeltaMatch) match;
						{
							var match_0 = new StatelessDeltaMatch(msg, "FatherToMale__FWD_60", numberOfNodes, 3, UsingDeltaMode.DELETE);
				...
				break;
			case "FatherToMale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_54": 
				{
					if(!lazy_initialization) {
						var inputMatch = (StatelessDeltaMatch) match;
						{
							var match_1 = new StatelessDeltaMatch(msg, "FatherToMale__FWD_60", numberOfNodes, 3, UsingDeltaMode.DELETE);
				...
				break;
			case "FatherToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_57": 
				{
					if(!lazy_initialization) {
						var inputMatch = (StatelessDeltaMatch) match;
						{
							var match_2 = new StatelessDeltaMatch(msg, "FatherToMale__FWD_60", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "RegisterToRegisterCorr_object_SP1": 
				{
					{
						// families2persons
						var match_3 = new StatelessDeltaMatch(msg, "FatherToMale__FWD_60", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_3.getNodes()[3] = objs[0];
						match_3.registerSignatureIndex(3);
						if(options.trackMatchingProcess)
			...
			case "PersonRegister_object_SP1": 
				{
					{
						// persons
						var match_4 = new StatelessDeltaMatch(msg, "FatherToMale__FWD_60", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_4.getNodes()[4] = objs[0];
						match_4.registerSignatureIndex(4);
						if(options.trackMatchingProcess)
			...
			{
				{
					...
					var match = new StatelessDeltaMatch(msg, "FatherToMale__FWD_60", numberOfNodes, 3, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[2] = msg.target;
					if(options.trackMatchingProcess)
	...
	protected void removeReference(ReferenceDeleted msg) {
			...
			case "FamiliesSmartEMF.Family_father_FamilyMember": 
		{
			...
			var match = new StatelessDeltaMatch(msg, "FatherToMale__FWD_60", numberOfNodes, 3, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[1] = msg.source;
			objs[2] = msg.target;
			if(options.trackMatchingProcess)
