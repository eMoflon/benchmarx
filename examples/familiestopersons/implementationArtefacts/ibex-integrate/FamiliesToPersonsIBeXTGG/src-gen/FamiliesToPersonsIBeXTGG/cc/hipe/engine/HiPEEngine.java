...
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.DaughterOfExistingFamilyToFemale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_11;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.DaughterOfExistingFamilyToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_14;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.DaughterOfExistingFamilyToFemale__CC_17;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.DaughterOfExistingFamilyToFemale__CONSISTENCY_22;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.DaughterToFemale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_29;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.DaughterToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_32;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.DaughterToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_35;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.DaughterToFemale__CC_38;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.DaughterToFemale__CONSISTENCY_44;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.Families2Persons__CC_52;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.Families2Persons__CONSISTENCY_55;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.FatherOfExistingFamilyToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_60;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.FatherOfExistingFamilyToMale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_63;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.FatherOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_66;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.FatherOfExistingFamilyToMale__CC_69;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.FatherOfExistingFamilyToMale__CONSISTENCY_74;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.FatherToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_81;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.FatherToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_84;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.FatherToMale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_87;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.FatherToMale__CC_90;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.FatherToMale__CONSISTENCY_96;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.MotherOfExistingFamilyToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_104;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.MotherOfExistingFamilyToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_107;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.MotherOfExistingFamilyToFemale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_110;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.MotherOfExistingFamilyToFemale__CC_113;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.MotherOfExistingFamilyToFemale__CONSISTENCY_118;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.MotherToFemale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_125;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.MotherToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_128;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.MotherToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_131;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.MotherToFemale__CC_134;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.MotherToFemale__CONSISTENCY_140;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.SonOfExistingFamilyToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_148;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.SonOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_151;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.SonOfExistingFamilyToMale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_154;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.SonOfExistingFamilyToMale__CC_157;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.SonOfExistingFamilyToMale__CONSISTENCY_162;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.SonToMale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_169;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.SonToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_172;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.SonToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_175;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.SonToMale__CC_178;
import FamiliesToPersonsIBeXTGG.cc.hipe.engine.actor.stateless.SonToMale__CONSISTENCY_184;
...
public class HiPEEngine extends IHiPEEngine{
	...
	public void createJunctionNodes() {
		...
		classes.put("DaughterOfExistingFamilyToFemale__CONSISTENCY_22", DaughterOfExistingFamilyToFemale__CONSISTENCY_22.class);
		classes.put("DaughterToFemale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_29", DaughterToFemale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_29.class);
		classes.put("DaughterToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_32", DaughterToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_32.class);
		classes.put("DaughterToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_35", DaughterToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_35.class);
		classes.put("DaughterToFemale__CC_38", DaughterToFemale__CC_38.class);
		classes.put("DaughterToFemale__CONSISTENCY_44", DaughterToFemale__CONSISTENCY_44.class);
		classes.put("Families2Persons__CC_52", Families2Persons__CC_52.class);
		classes.put("Families2Persons__CONSISTENCY_55", Families2Persons__CONSISTENCY_55.class);
		classes.put("FatherOfExistingFamilyToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_60", FatherOfExistingFamilyToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_60.class);
		classes.put("FatherOfExistingFamilyToMale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_63", FatherOfExistingFamilyToMale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_63.class);
		classes.put("FatherOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_66", FatherOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_66.class);
		classes.put("FatherOfExistingFamilyToMale__CC_69", FatherOfExistingFamilyToMale__CC_69.class);
		classes.put("FatherOfExistingFamilyToMale__CONSISTENCY_74", FatherOfExistingFamilyToMale__CONSISTENCY_74.class);
		classes.put("FatherToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_81", FatherToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_81.class);
		classes.put("FatherToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_84", FatherToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_84.class);
		classes.put("FatherToMale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_87", FatherToMale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_87.class);
		classes.put("FatherToMale__CC_90", FatherToMale__CC_90.class);
		classes.put("FatherToMale__CONSISTENCY_96", FatherToMale__CONSISTENCY_96.class);
		classes.put("MotherOfExistingFamilyToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_104", MotherOfExistingFamilyToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_104.class);
		classes.put("MotherOfExistingFamilyToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_107", MotherOfExistingFamilyToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_107.class);
		classes.put("MotherOfExistingFamilyToFemale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_110", MotherOfExistingFamilyToFemale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_110.class);
		classes.put("MotherOfExistingFamilyToFemale__CC_113", MotherOfExistingFamilyToFemale__CC_113.class);
		classes.put("MotherOfExistingFamilyToFemale__CONSISTENCY_118", MotherOfExistingFamilyToFemale__CONSISTENCY_118.class);
		classes.put("MotherToFemale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_125", MotherToFemale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_125.class);
		classes.put("MotherToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_128", MotherToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_128.class);
		classes.put("MotherToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_131", MotherToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_131.class);
		classes.put("MotherToFemale__CC_134", MotherToFemale__CC_134.class);
		classes.put("MotherToFemale__CONSISTENCY_140", MotherToFemale__CONSISTENCY_140.class);
		classes.put("SonOfExistingFamilyToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_148", SonOfExistingFamilyToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_148.class);
		classes.put("SonOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_151", SonOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_151.class);
		classes.put("SonOfExistingFamilyToMale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_154", SonOfExistingFamilyToMale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_154.class);
		classes.put("SonOfExistingFamilyToMale__CC_157", SonOfExistingFamilyToMale__CC_157.class);
		classes.put("SonOfExistingFamilyToMale__CONSISTENCY_162", SonOfExistingFamilyToMale__CONSISTENCY_162.class);
		classes.put("SonToMale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_169", SonToMale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_169.class);
		classes.put("SonToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_172", SonToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_172.class);
		classes.put("SonToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_175", SonToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_175.class);
		classes.put("SonToMale__CC_178", SonToMale__CC_178.class);
		classes.put("SonToMale__CONSISTENCY_184", SonToMale__CONSISTENCY_184.class);
	}
