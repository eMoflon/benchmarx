...
public class SonOfExistingFamilyToMale__CC_157 extends GenericStatelessSearchActor{
			...
			case "Family_object_SP10": 
				{
					{
						// f
						var match_0 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CC_157", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP0": 
				{
					{
						// fm
						var match_1 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CC_157", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP4": 
				{
					{
						// persons
						var match_2 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CC_157", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Male_object_SP0": 
				{
					{
						// p
						var match_3 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CC_157", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "SonOfExistingFamilyToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_148": 
				{
					...
					{
						var match_0 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CC_157", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "SonOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_151": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_1 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CC_157", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "SonOfExistingFamilyToMale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_154": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_2 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CC_157", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "Male_object_SP0": 
				{
					{
						// p
						var match_3 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CC_157", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_3.getNodes()[3] = objs[0];
						match_3.registerSignatureIndex(3);
						if(options.trackMatchingProcess)
