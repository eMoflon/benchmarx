...
public class SonOfExistingFamilyToMale__CC_175 extends GenericStatelessSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						...
						edge_explorer_4 = new DeltaAwareEdgeExplorer(this, 3, 1, edge_explorer_4_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getRegisterToRegisterCorr_Source());
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						...
						edge_explorer_5_methods.multi_lookup = (o) -> ((FamiliesSmartEMF.Family) o).getSons();
						edge_explorer_5_methods.unique_opposite_lookup = (o) -> ((FamiliesSmartEMF.FamilyMember) o).getSonsInverse();
						edge_explorer_5 = new DeltaAwareEdgeExplorer(this, 0, 2, edge_explorer_5_methods, FamiliesSmartEMF.FamiliesSmartEMFPackage.eINSTANCE.getFamily_Sons());
			...
			case "Family_object_SP10": 
				{
					if(!lazy_initialization) {
						{
							// f
							var match_0 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CC_175", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyRegister_object_SP1": 
				{
					if(!lazy_initialization) {
						{
							// families
							var match_1 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CC_175", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP0": 
				{
					if(!lazy_initialization) {
						{
							// fm
							var match_2 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CC_175", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "RegisterToRegisterCorr_object_SP3": 
				{
					{
						// families2persons
						var match_3 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CC_175", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP4": 
				{
					if(!lazy_initialization) {
						{
							// persons
							var match_4 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CC_175", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Male_object_SP0": 
				{
					if(!lazy_initialization) {
						{
							// p
							var match_5 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CC_175", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "SonOfExistingFamilyToMale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_166": 
				{
					if(!lazy_initialization) {
						...
						{
							var match_0 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CC_175", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "SonOfExistingFamilyToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_169": 
				{
					if(!lazy_initialization) {
						var inputMatch = (StatelessDeltaMatch) match;
						{
							var match_1 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CC_175", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "SonOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_172": 
				{
					if(!lazy_initialization) {
						var inputMatch = (StatelessDeltaMatch) match;
						{
							var match_2 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CC_175", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "RegisterToRegisterCorr_object_SP3": 
				{
					{
						// families2persons
						var match_3 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CC_175", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_3.getNodes()[3] = objs[0];
						match_3.registerSignatureIndex(3);
						if(options.trackMatchingProcess)
			...
			case "PersonRegister_object_SP4": 
				{
					{
						// persons
						var match_4 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CC_175", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_4.getNodes()[4] = objs[0];
						match_4.registerSignatureIndex(4);
						if(options.trackMatchingProcess)
			...
			case "Male_object_SP0": 
				{
					{
						// p
						var match_5 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CC_175", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_5.getNodes()[5] = objs[0];
						match_5.registerSignatureIndex(5);
						if(options.trackMatchingProcess)
			...
			{
				{
					...
					var match = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CC_175", numberOfNodes, 3, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[4] = msg.target;
					if(options.trackMatchingProcess)
	...
	protected void removeReference(ReferenceDeleted msg) {
			...
			case "FamiliesToPersonsIBeXTGG.RegisterToRegisterCorr_target_PersonRegister": 
		{
			...
			var match = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CC_175", numberOfNodes, 3, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[3] = msg.source;
			objs[4] = msg.target;
			if(options.trackMatchingProcess)
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof FamiliesSmartEMF.Family) {
			var match_0 = new StatelessDeltaMatch(initialMessage, "SonOfExistingFamilyToMale__CC_175", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_0.registerSignatureIndex(0);
		...
		if(obj instanceof PersonsSmartEMF.Male) {
			var match_5 = new StatelessDeltaMatch(initialMessage, "SonOfExistingFamilyToMale__CC_175", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_5.registerSignatureIndex(5);
		...
		if(obj instanceof FamiliesSmartEMF.FamilyMember) {
			var match_2 = new StatelessDeltaMatch(initialMessage, "SonOfExistingFamilyToMale__CC_175", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_2.registerSignatureIndex(2);
	...
	private boolean constraint_checker_method(String f_name, String fm_name, String p_name) {
		org.emoflon.ibex.tgg.runtime.csp.constraints.Concat csp_12 = new org.emoflon.ibex.tgg.runtime.csp.constraints.Concat();
		csp_12.getVariables().add(new org.emoflon.ibex.tgg.runtime.csp.RuntimeTGGAttributeConstraintVariable(true, ", ", "java.lang.String"));
		csp_12.getVariables().add(new org.emoflon.ibex.tgg.runtime.csp.RuntimeTGGAttributeConstraintVariable(true, f_name, "java.lang.String"));
		csp_12.getVariables().add(new org.emoflon.ibex.tgg.runtime.csp.RuntimeTGGAttributeConstraintVariable(true, fm_name, "java.lang.String"));
		csp_12.getVariables().add(new org.emoflon.ibex.tgg.runtime.csp.RuntimeTGGAttributeConstraintVariable(true, p_name, "java.lang.String"));
		csp_12.solve();
