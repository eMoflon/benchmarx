...
public class Families2Persons__CONSISTENCY_55 extends GenericStatelessSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						...
						edge_explorer_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_Families2Persons) o).getCREATE__CORRESPONDENCE__families2persons();
						edge_explorer_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesToPersonsIBeXTGG.RegisterToRegisterCorr) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_Families2Persons_CREATE__CORRESPONDENCE__families2persons().getEOpposite());
						edge_explorer = new DeltaAwareEdgeExplorer(this, 3, 1, edge_explorer_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_Families2Persons_CREATE__CORRESPONDENCE__families2persons());
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						...
						edge_explorer_4 = new DeltaAwareEdgeExplorer(this, 1, 0, edge_explorer_4_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getRegisterToRegisterCorr_Source());
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						...
						edge_explorer_5_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_Families2Persons) o).getCREATE__TARGET__persons();
						edge_explorer_5_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((PersonsSmartEMF.PersonRegister) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_Families2Persons_CREATE__TARGET__persons().getEOpposite());
						edge_explorer_5 = new DeltaAwareEdgeExplorer(this, 3, 2, edge_explorer_5_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_Families2Persons_CREATE__TARGET__persons());
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						...
						edge_explorer_6_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_Families2Persons) o).getCREATE__SOURCE__families();
						edge_explorer_6_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesSmartEMF.FamilyRegister) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_Families2Persons_CREATE__SOURCE__families().getEOpposite());
						edge_explorer_6 = new DeltaAwareEdgeExplorer(this, 3, 0, edge_explorer_6_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_Families2Persons_CREATE__SOURCE__families());
			...
			case "FamilyRegister_object_SP2": 
				{
					{
						// families
						var match_0 = new StatelessDeltaMatch(msg, "Families2Persons__CONSISTENCY_55", numberOfNodes, 0, UsingDeltaMode.CREATE);
				...
				break;
			case "RegisterToRegisterCorr_object": 
				{
					{
						// families2persons
						var match_1 = new StatelessDeltaMatch(msg, "Families2Persons__CONSISTENCY_55", numberOfNodes, 0, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP0": 
				{
					{
						// persons
						var match_2 = new StatelessDeltaMatch(msg, "Families2Persons__CONSISTENCY_55", numberOfNodes, 0, UsingDeltaMode.CREATE);
				...
				break;
			case "ProtocolNode_Families2Persons_object": 
				{
					{
						// _eMoflon_ProtocolNode_
						var match_3 = new StatelessDeltaMatch(msg, "Families2Persons__CONSISTENCY_55", numberOfNodes, 0, UsingDeltaMode.CREATE);
			...
			case "FamilyRegister_object_SP2": 
				{
					{
						// families
						var match_0 = new StatelessDeltaMatch(msg, "Families2Persons__CONSISTENCY_55", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_0.getNodes()[0] = objs[0];
						match_0.registerSignatureIndex(0);
						if(options.trackMatchingProcess)
			...
			case "RegisterToRegisterCorr_object": 
				{
					{
						// families2persons
						var match_1 = new StatelessDeltaMatch(msg, "Families2Persons__CONSISTENCY_55", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_1.getNodes()[1] = objs[0];
						match_1.registerSignatureIndex(1);
						if(options.trackMatchingProcess)
			...
			case "PersonRegister_object_SP0": 
				{
					{
						// persons
						var match_2 = new StatelessDeltaMatch(msg, "Families2Persons__CONSISTENCY_55", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_2.getNodes()[2] = objs[0];
						match_2.registerSignatureIndex(2);
						if(options.trackMatchingProcess)
			...
			case "ProtocolNode_Families2Persons_object": 
				{
					{
						// _eMoflon_ProtocolNode_
						var match_3 = new StatelessDeltaMatch(msg, "Families2Persons__CONSISTENCY_55", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_3.getNodes()[3] = objs[0];
						match_3.registerSignatureIndex(3);
						if(options.trackMatchingProcess)
			...
			{
				{
					...
					var match = new StatelessDeltaMatch(msg, "Families2Persons__CONSISTENCY_55", numberOfNodes, 0, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[1] = msg.target;
					if(options.trackMatchingProcess)
	...
	protected void removeReference(ReferenceDeleted msg) {
			...
			case "FamiliesToPersonsIBeXTGG.ProtocolNode_Families2Persons_CREATE__CORRESPONDENCE__families2persons_RegisterToRegisterCorr": 
		{
			...
			var match = new StatelessDeltaMatch(msg, "Families2Persons__CONSISTENCY_55", numberOfNodes, 0, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[3] = msg.source;
			objs[1] = msg.target;
			if(options.trackMatchingProcess)
