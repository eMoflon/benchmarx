...
public class FatherOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_72 extends GenericStatelessSearchActor{
			...
			case "Family_object_SP4": 
				{
					if(!lazy_initialization) {
						{
							// FILTER_NAC_NODE
							var match_0 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_72", numberOfNodes, 0, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP3": 
				{
					{
						// fm
						var match_1 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_72", numberOfNodes, 0, UsingDeltaMode.CREATE);
			...
			case "Family_object_SP4": 
				{
					{
						// FILTER_NAC_NODE
						var match_0 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_72", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_0.getNodes()[0] = objs[0];
						if(options.trackMatchingProcess)
			...
			case "FamilyMember_object_SP3": 
				{
					{
						// fm
						var match_1 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_72", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_1.getNodes()[1] = objs[0];
						match_1.registerSignatureIndex(1);
						if(options.trackMatchingProcess)
			...
			{
				{
					...
					var match = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_72", numberOfNodes, 0, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					if(options.trackMatchingProcess)
	...
	protected void removeReference(ReferenceDeleted msg) {
			...
			case "FamiliesSmartEMF.Family_daughters_FamilyMember": 
		{
			...
			var match = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_72", numberOfNodes, 0, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[0] = msg.source;
			objs[1] = msg.target;
			if(options.trackMatchingProcess)
	...
	protected void processMatchRequest(MatchRequest message) {
		...
		switch(message.nodeName) {
			case "FatherOfExistingFamilyToMale__CONSISTENCY_82": {
				switch(message.queryComponentId) {
					case 2: {
						var deltaMatch = new StatelessDeltaMatch(message, "FatherOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_72", 2, 0, message.usedDelta);
			...
			case "FatherOfExistingFamilyToMale__CC_75": {
				switch(message.queryComponentId) {
					case 2: {
						var deltaMatch = new StatelessDeltaMatch(message, "FatherOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_72", 2, 0, message.usedDelta);
						var nodes = deltaMatch.getNodes();
