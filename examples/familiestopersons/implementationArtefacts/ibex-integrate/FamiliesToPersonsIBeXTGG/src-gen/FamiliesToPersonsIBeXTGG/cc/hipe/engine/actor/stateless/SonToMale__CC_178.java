...
public class SonToMale__CC_178 extends GenericStatelessSearchActor{
			...
			case "FamilyRegister_object_SP1": 
				{
					{
						// families
						var match_0 = new StatelessDeltaMatch(msg, "SonToMale__CC_178", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Family_object_SP4": 
				{
					{
						// f
						var match_1 = new StatelessDeltaMatch(msg, "SonToMale__CC_178", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP5": 
				{
					{
						// fm
						var match_2 = new StatelessDeltaMatch(msg, "SonToMale__CC_178", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP1": 
				{
					{
						// persons
						var match_3 = new StatelessDeltaMatch(msg, "SonToMale__CC_178", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Male_object_SP0": 
				{
					{
						// p
						var match_4 = new StatelessDeltaMatch(msg, "SonToMale__CC_178", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "SonToMale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_169": 
				{
					...
					{
						var match_0 = new StatelessDeltaMatch(msg, "SonToMale__CC_178", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "SonToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_172": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_1 = new StatelessDeltaMatch(msg, "SonToMale__CC_178", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "SonToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_175": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_2 = new StatelessDeltaMatch(msg, "SonToMale__CC_178", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "PersonRegister_object_SP1": 
				{
					{
						// persons
						var match_3 = new StatelessDeltaMatch(msg, "SonToMale__CC_178", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_3.getNodes()[3] = objs[0];
						match_3.registerSignatureIndex(3);
						if(options.trackMatchingProcess)
			...
			case "Male_object_SP0": 
				{
					{
						// p
						var match_4 = new StatelessDeltaMatch(msg, "SonToMale__CC_178", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_4.getNodes()[4] = objs[0];
						match_4.registerSignatureIndex(4);
						if(options.trackMatchingProcess)
		...
		case "PersonsSmartEMF.PersonRegister_persons_Person": 
			{
				if(msg.target instanceof PersonsSmartEMF.Male) 
				{
					...
					var match = new StatelessDeltaMatch(msg, "SonToMale__CC_178", numberOfNodes, 3, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[4] = msg.target;
					if(options.trackMatchingProcess)
	...
	protected void removeReference(ReferenceDeleted msg) {
		...
		if(msg.target instanceof PersonsSmartEMF.Male) 
		{
			...
			var match = new StatelessDeltaMatch(msg, "SonToMale__CC_178", numberOfNodes, 3, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[3] = msg.source;
			objs[4] = msg.target;
			if(options.trackMatchingProcess)
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof PersonsSmartEMF.Male) {
			var match_4 = new StatelessDeltaMatch(initialMessage, "SonToMale__CC_178", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_4.registerSignatureIndex(4);
		...
		if(obj instanceof FamiliesSmartEMF.Family) {
			var match_1 = new StatelessDeltaMatch(initialMessage, "SonToMale__CC_178", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_1.registerSignatureIndex(1);
		...
		if(obj instanceof FamiliesSmartEMF.FamilyMember) {
			var match_2 = new StatelessDeltaMatch(initialMessage, "SonToMale__CC_178", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_2.registerSignatureIndex(2);
