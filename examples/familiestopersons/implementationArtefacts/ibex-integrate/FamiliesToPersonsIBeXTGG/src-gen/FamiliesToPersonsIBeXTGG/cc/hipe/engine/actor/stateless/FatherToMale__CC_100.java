...
public class FatherToMale__CC_100 extends GenericStatelessSearchActor{
			...
			case "FamilyRegister_object_SP0": 
				{
					if(!lazy_initialization) {
						{
							// families
							var match_0 = new StatelessDeltaMatch(msg, "FatherToMale__CC_100", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Family_object_SP6": 
				{
					{
						// f
						var match_1 = new StatelessDeltaMatch(msg, "FatherToMale__CC_100", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP5": 
				{
					if(!lazy_initialization) {
						{
							// fm
							var match_2 = new StatelessDeltaMatch(msg, "FatherToMale__CC_100", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "RegisterToRegisterCorr_object_SP2": 
				{
					if(!lazy_initialization) {
						{
							// families2persons
							var match_3 = new StatelessDeltaMatch(msg, "FatherToMale__CC_100", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP3": 
				{
					if(!lazy_initialization) {
						{
							// persons
							var match_4 = new StatelessDeltaMatch(msg, "FatherToMale__CC_100", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Male_object_SP0": 
				{
					if(!lazy_initialization) {
						{
							// p
							var match_5 = new StatelessDeltaMatch(msg, "FatherToMale__CC_100", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FatherToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_91": 
				{
					if(!lazy_initialization) {
						...
						{
							var match_0 = new StatelessDeltaMatch(msg, "FatherToMale__CC_100", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "FatherToMale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_94": 
				{
					if(!lazy_initialization) {
						var inputMatch = (StatelessDeltaMatch) match;
						{
							var match_1 = new StatelessDeltaMatch(msg, "FatherToMale__CC_100", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "FatherToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_97": 
				{
					if(!lazy_initialization) {
						var inputMatch = (StatelessDeltaMatch) match;
						{
							var match_2 = new StatelessDeltaMatch(msg, "FatherToMale__CC_100", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "RegisterToRegisterCorr_object_SP2": 
				{
					{
						// families2persons
						var match_3 = new StatelessDeltaMatch(msg, "FatherToMale__CC_100", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_3.getNodes()[3] = objs[0];
						match_3.registerSignatureIndex(3);
						if(options.trackMatchingProcess)
			...
			case "PersonRegister_object_SP3": 
				{
					{
						// persons
						var match_4 = new StatelessDeltaMatch(msg, "FatherToMale__CC_100", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_4.getNodes()[4] = objs[0];
						match_4.registerSignatureIndex(4);
						if(options.trackMatchingProcess)
			...
			case "Male_object_SP0": 
				{
					{
						// p
						var match_5 = new StatelessDeltaMatch(msg, "FatherToMale__CC_100", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_5.getNodes()[5] = objs[0];
						match_5.registerSignatureIndex(5);
						if(options.trackMatchingProcess)
			...
			{
				{
					...
					var match = new StatelessDeltaMatch(msg, "FatherToMale__CC_100", numberOfNodes, 3, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[2] = msg.target;
					if(options.trackMatchingProcess)
	...
	protected void removeReference(ReferenceDeleted msg) {
			...
			case "FamiliesSmartEMF.Family_father_FamilyMember": 
		{
			...
			var match = new StatelessDeltaMatch(msg, "FatherToMale__CC_100", numberOfNodes, 3, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[1] = msg.source;
			objs[2] = msg.target;
			if(options.trackMatchingProcess)
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof FamiliesSmartEMF.Family) {
			var match_1 = new StatelessDeltaMatch(initialMessage, "FatherToMale__CC_100", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_1.registerSignatureIndex(1);
		...
		if(obj instanceof PersonsSmartEMF.Male) {
			var match_5 = new StatelessDeltaMatch(initialMessage, "FatherToMale__CC_100", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_5.registerSignatureIndex(5);
		...
		if(obj instanceof FamiliesSmartEMF.FamilyMember) {
			var match_2 = new StatelessDeltaMatch(initialMessage, "FatherToMale__CC_100", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_2.registerSignatureIndex(2);
