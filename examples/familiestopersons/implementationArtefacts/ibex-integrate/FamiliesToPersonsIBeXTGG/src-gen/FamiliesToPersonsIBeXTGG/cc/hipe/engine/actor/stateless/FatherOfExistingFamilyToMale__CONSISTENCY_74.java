...
public class FatherOfExistingFamilyToMale__CONSISTENCY_74 extends GenericStatelessSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						...
						edge_explorer_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_FatherOfExistingFamilyToMale) o).getCREATE__CORRESPONDENCE__familyMember2Persons();
						edge_explorer_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesToPersonsIBeXTGG.FamilyMemberToPersonCorr) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_FatherOfExistingFamilyToMale_CREATE__CORRESPONDENCE__familyMember2Persons().getEOpposite());
						edge_explorer = new DeltaAwareEdgeExplorer(this, 5, 2, edge_explorer_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_FatherOfExistingFamilyToMale_CREATE__CORRESPONDENCE__familyMember2Persons());
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						...
						edge_explorer_6_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_FatherOfExistingFamilyToMale) o).getCONTEXT__SOURCE__f();
						edge_explorer_6_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesSmartEMF.Family) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_FatherOfExistingFamilyToMale_CONTEXT__SOURCE__f().getEOpposite());
						edge_explorer_6 = new DeltaAwareEdgeExplorer(this, 5, 0, edge_explorer_6_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_FatherOfExistingFamilyToMale_CONTEXT__SOURCE__f());
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						...
						edge_explorer_8_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_FatherOfExistingFamilyToMale) o).getCREATE__SOURCE__fm();
						edge_explorer_8_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesSmartEMF.FamilyMember) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_FatherOfExistingFamilyToMale_CREATE__SOURCE__fm().getEOpposite());
						edge_explorer_8 = new DeltaAwareEdgeExplorer(this, 5, 1, edge_explorer_8_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_FatherOfExistingFamilyToMale_CREATE__SOURCE__fm());
			...
			case "Family_object_SP5": 
				{
					{
						// f
						var match_0 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_74", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP4": 
				{
					{
						// fm
						var match_1 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_74", numberOfNodes, 3, UsingDeltaMode.CREATE);
				...
				{
					{
						...
						var match_2 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_74", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP2": 
				{
					{
						// persons
						var match_3 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_74", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Male_object_SP1": 
				{
					{
						// p
						var match_4 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_74", numberOfNodes, 3, UsingDeltaMode.CREATE);
				...
				{
					{
						...
						var match_5 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_74", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FatherOfExistingFamilyToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_60": 
				{
					...
					{
						var match_0 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_74", numberOfNodes, 3, UsingDeltaMode.DELETE);
				...
				break;
			case "FatherOfExistingFamilyToMale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_63": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_1 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_74", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "FatherOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_66": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_2 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_74", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "PersonRegister_object_SP2": 
				{
					{
						// persons
						var match_3 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_74", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_3.getNodes()[3] = objs[0];
						match_3.registerSignatureIndex(3);
						if(options.trackMatchingProcess)
			...
			case "Male_object_SP1": 
				{
					{
						// p
						var match_4 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_74", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_4.getNodes()[4] = objs[0];
						match_4.registerSignatureIndex(4);
						if(options.trackMatchingProcess)
			...
			case "ProtocolNode_FatherOfExistingFamilyToMale_object": 
				{
					{
						// _eMoflon_ProtocolNode_
						var match_5 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_74", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_5.getNodes()[5] = objs[0];
						match_5.registerSignatureIndex(5);
						if(options.trackMatchingProcess)
			...
			{
				{
					...
					var match = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_74", numberOfNodes, 3, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[5] = msg.source;
					objs[2] = msg.target;
					if(options.trackMatchingProcess)
	...
	protected void removeReference(ReferenceDeleted msg) {
			...
			case "FamiliesToPersonsIBeXTGG.ProtocolNode_FatherOfExistingFamilyToMale_CREATE__CORRESPONDENCE__familyMember2Persons_FamilyMemberToPersonCorr": 
		{
			...
			var match = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_74", numberOfNodes, 3, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[5] = msg.source;
			objs[2] = msg.target;
			if(options.trackMatchingProcess)
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof PersonsSmartEMF.Male) {
			var match_4 = new StatelessDeltaMatch(initialMessage, "FatherOfExistingFamilyToMale__CONSISTENCY_74", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_4.registerSignatureIndex(4);
		...
		if(obj instanceof FamiliesSmartEMF.Family) {
			var match_0 = new StatelessDeltaMatch(initialMessage, "FatherOfExistingFamilyToMale__CONSISTENCY_74", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_0.registerSignatureIndex(0);
		...
		if(obj instanceof FamiliesSmartEMF.FamilyMember) {
			var match_1 = new StatelessDeltaMatch(initialMessage, "FatherOfExistingFamilyToMale__CONSISTENCY_74", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_1.registerSignatureIndex(1);
