...
public class DaughterToFemale__CONSISTENCY_44 extends GenericStatelessSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						...
						edge_explorer_4_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_DaughterToFemale) o).getCREATE__CORRESPONDENCE__familyMember2Persons();
						edge_explorer_4_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesToPersonsIBeXTGG.FamilyMemberToPersonCorr) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_DaughterToFemale_CREATE__CORRESPONDENCE__familyMember2Persons().getEOpposite());
						edge_explorer_4 = new DeltaAwareEdgeExplorer(this, 6, 3, edge_explorer_4_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_DaughterToFemale_CREATE__CORRESPONDENCE__familyMember2Persons());
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						...
						edge_explorer_5_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_DaughterToFemale) o).getCREATE__SOURCE__fm();
						edge_explorer_5_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesSmartEMF.FamilyMember) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_DaughterToFemale_CREATE__SOURCE__fm().getEOpposite());
						edge_explorer_5 = new DeltaAwareEdgeExplorer(this, 6, 2, edge_explorer_5_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_DaughterToFemale_CREATE__SOURCE__fm());
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						...
						edge_explorer_7_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_DaughterToFemale) o).getCONTEXT__TARGET__persons();
						edge_explorer_7_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((PersonsSmartEMF.PersonRegister) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_DaughterToFemale_CONTEXT__TARGET__persons().getEOpposite());
						edge_explorer_7 = new DeltaAwareEdgeExplorer(this, 6, 4, edge_explorer_7_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_DaughterToFemale_CONTEXT__TARGET__persons());
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						...
						edge_explorer_9_methods.multi_lookup = (o) -> ((PersonsSmartEMF.PersonRegister) o).getPersons().stream().filter(obj -> obj instanceof PersonsSmartEMF.Female).collect(Collectors.toList());
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						...
						edge_explorer_12_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_DaughterToFemale) o).getCREATE__TARGET__p();
						edge_explorer_12_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((PersonsSmartEMF.Female) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_DaughterToFemale_CREATE__TARGET__p().getEOpposite());
						edge_explorer_12 = new DeltaAwareEdgeExplorer(this, 6, 5, edge_explorer_12_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_DaughterToFemale_CREATE__TARGET__p());
			...
			case "FamilyRegister_object_SP0": 
				{
					{
						// families
						var match_0 = new StatelessDeltaMatch(msg, "DaughterToFemale__CONSISTENCY_44", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Family_object_SP0": 
				{
					{
						// f
						var match_1 = new StatelessDeltaMatch(msg, "DaughterToFemale__CONSISTENCY_44", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP9": 
				{
					{
						// fm
						var match_2 = new StatelessDeltaMatch(msg, "DaughterToFemale__CONSISTENCY_44", numberOfNodes, 3, UsingDeltaMode.CREATE);
				...
				{
					{
						...
						var match_3 = new StatelessDeltaMatch(msg, "DaughterToFemale__CONSISTENCY_44", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP3": 
				{
					{
						// persons
						var match_4 = new StatelessDeltaMatch(msg, "DaughterToFemale__CONSISTENCY_44", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Female_object_SP1": 
				{
					{
						// p
						var match_5 = new StatelessDeltaMatch(msg, "DaughterToFemale__CONSISTENCY_44", numberOfNodes, 3, UsingDeltaMode.CREATE);
				...
				{
					{
						...
						var match_6 = new StatelessDeltaMatch(msg, "DaughterToFemale__CONSISTENCY_44", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "DaughterToFemale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_29": 
				{
					...
					{
						var match_0 = new StatelessDeltaMatch(msg, "DaughterToFemale__CONSISTENCY_44", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "DaughterToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_32": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_1 = new StatelessDeltaMatch(msg, "DaughterToFemale__CONSISTENCY_44", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "DaughterToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_35": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_2 = new StatelessDeltaMatch(msg, "DaughterToFemale__CONSISTENCY_44", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "FamilyMemberToPersonCorr_object_SP1": 
				{
					{
						// familyMember2Persons
						var match_3 = new StatelessDeltaMatch(msg, "DaughterToFemale__CONSISTENCY_44", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_3.getNodes()[3] = objs[0];
						match_3.registerSignatureIndex(3);
						if(options.trackMatchingProcess)
			...
			case "PersonRegister_object_SP3": 
				{
					{
						// persons
						var match_4 = new StatelessDeltaMatch(msg, "DaughterToFemale__CONSISTENCY_44", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_4.getNodes()[4] = objs[0];
						match_4.registerSignatureIndex(4);
						if(options.trackMatchingProcess)
			...
			case "Female_object_SP1": 
				{
					{
						// p
						var match_5 = new StatelessDeltaMatch(msg, "DaughterToFemale__CONSISTENCY_44", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_5.getNodes()[5] = objs[0];
						match_5.registerSignatureIndex(5);
						if(options.trackMatchingProcess)
			...
			case "ProtocolNode_DaughterToFemale_object": 
				{
					{
						// _eMoflon_ProtocolNode_
						var match_6 = new StatelessDeltaMatch(msg, "DaughterToFemale__CONSISTENCY_44", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_6.getNodes()[6] = objs[0];
						match_6.registerSignatureIndex(6);
						if(options.trackMatchingProcess)
			...
			{
				{
					...
					var match = new StatelessDeltaMatch(msg, "DaughterToFemale__CONSISTENCY_44", numberOfNodes, 3, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[2] = msg.target;
					if(options.trackMatchingProcess)
	...
	protected void removeReference(ReferenceDeleted msg) {
			...
			case "FamiliesToPersonsIBeXTGG.FamilyMemberToPersonCorr_source_FamilyMember": 
		{
			...
			var match = new StatelessDeltaMatch(msg, "DaughterToFemale__CONSISTENCY_44", numberOfNodes, 3, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[3] = msg.source;
			objs[2] = msg.target;
			if(options.trackMatchingProcess)
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof PersonsSmartEMF.Female) {
			var match_5 = new StatelessDeltaMatch(initialMessage, "DaughterToFemale__CONSISTENCY_44", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_5.registerSignatureIndex(5);
			match_5.getNodes()[5] = obj;
			start(edge_explorer_9_1_orchestration, StatelessInputType.ATTRIBUTE, match_5);
		}
		if(obj instanceof FamiliesSmartEMF.Family) {
			var match_1 = new StatelessDeltaMatch(initialMessage, "DaughterToFemale__CONSISTENCY_44", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_1.registerSignatureIndex(1);
		...
		if(obj instanceof FamiliesSmartEMF.FamilyMember) {
			var match_2 = new StatelessDeltaMatch(initialMessage, "DaughterToFemale__CONSISTENCY_44", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_2.registerSignatureIndex(2);
