...
public class SonOfExistingFamilyToMale__CONSISTENCY_182 extends GenericStatelessSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						...
						edge_explorer_3 = new DeltaAwareEdgeExplorer(this, 3, 1, edge_explorer_3_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getRegisterToRegisterCorr_Source());
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						...
						edge_explorer_4 = new DeltaAwareEdgeExplorer(this, 0, 2, edge_explorer_4_methods, FamiliesSmartEMF.FamiliesSmartEMFPackage.eINSTANCE.getFamily_Sons());
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						...
						edge_explorer_5 = new DeltaAwareEdgeExplorer(this, 7, 0, edge_explorer_5_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonOfExistingFamilyToMale_CONTEXT__SOURCE__f());
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						...
						edge_explorer_6_methods.multi_lookup = (o) -> ((PersonsSmartEMF.PersonRegister) o).getPersons().stream().filter(obj -> obj instanceof PersonsSmartEMF.Male).collect(Collectors.toList());
						edge_explorer_6_methods.unique_opposite_lookup = (o) -> ((PersonsSmartEMF.Person) o).getPersonsInverse();
						edge_explorer_6 = new DeltaAwareEdgeExplorer(this, 5, 6, edge_explorer_6_methods, PersonsSmartEMF.PersonsSmartEMFPackage.eINSTANCE.getPersonRegister_Persons());
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						...
						edge_explorer_8_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_SonOfExistingFamilyToMale) o).getCONTEXT__TARGET__persons();
						edge_explorer_8_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((PersonsSmartEMF.PersonRegister) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonOfExistingFamilyToMale_CONTEXT__TARGET__persons().getEOpposite());
						edge_explorer_8 = new DeltaAwareEdgeExplorer(this, 7, 5, edge_explorer_8_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonOfExistingFamilyToMale_CONTEXT__TARGET__persons());
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						...
						edge_explorer_9_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_SonOfExistingFamilyToMale) o).getCREATE__TARGET__p();
						edge_explorer_9_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((PersonsSmartEMF.Male) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonOfExistingFamilyToMale_CREATE__TARGET__p().getEOpposite());
						edge_explorer_9 = new DeltaAwareEdgeExplorer(this, 7, 6, edge_explorer_9_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonOfExistingFamilyToMale_CREATE__TARGET__p());
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						...
						edge_explorer_10_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_SonOfExistingFamilyToMale) o).getCREATE__CORRESPONDENCE__familyMember2Persons();
						edge_explorer_10_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesToPersonsIBeXTGG.FamilyMemberToPersonCorr) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonOfExistingFamilyToMale_CREATE__CORRESPONDENCE__familyMember2Persons().getEOpposite());
						edge_explorer_10 = new DeltaAwareEdgeExplorer(this, 7, 4, edge_explorer_10_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonOfExistingFamilyToMale_CREATE__CORRESPONDENCE__familyMember2Persons());
		name2explorer.put("edge_explorer_10", edge_explorer_10);
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.checkSourceType = (o) -> o instanceof FamiliesToPersonsIBeXTGG.ProtocolNode_SonOfExistingFamilyToMale;
						edge_explorer_11_methods.checkTargetType = (o) -> o instanceof FamiliesToPersonsIBeXTGG.RegisterToRegisterCorr;
						edge_explorer_11_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_SonOfExistingFamilyToMale) o).getCONTEXT__CORRESPONDENCE__families2persons();
						edge_explorer_11_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesToPersonsIBeXTGG.RegisterToRegisterCorr) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonOfExistingFamilyToMale_CONTEXT__CORRESPONDENCE__families2persons().getEOpposite());
						edge_explorer_11 = new DeltaAwareEdgeExplorer(this, 7, 3, edge_explorer_11_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonOfExistingFamilyToMale_CONTEXT__CORRESPONDENCE__families2persons());
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.checkSourceType = (o) -> o instanceof FamiliesToPersonsIBeXTGG.ProtocolNode_SonOfExistingFamilyToMale;
						edge_explorer_13_methods.checkTargetType = (o) -> o instanceof FamiliesSmartEMF.FamilyRegister;
						edge_explorer_13_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_SonOfExistingFamilyToMale) o).getCONTEXT__SOURCE__families();
						edge_explorer_13_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesSmartEMF.FamilyRegister) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonOfExistingFamilyToMale_CONTEXT__SOURCE__families().getEOpposite());
						edge_explorer_13 = new DeltaAwareEdgeExplorer(this, 7, 1, edge_explorer_13_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonOfExistingFamilyToMale_CONTEXT__SOURCE__families());
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						...
						edge_explorer_14_methods.checkTargetType = (o) -> o instanceof PersonsSmartEMF.Male;
						edge_explorer_14_methods.unique_lookup = (o) -> {EObject result = ((FamiliesToPersonsIBeXTGG.FamilyMemberToPersonCorr) o).getTarget(); return (result instanceof PersonsSmartEMF.Male ? result : null);};
						edge_explorer_14_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((PersonsSmartEMF.Person) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getFamilyMemberToPersonCorr_Target().getEOpposite());
						edge_explorer_14 = new DeltaAwareEdgeExplorer(this, 4, 6, edge_explorer_14_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getFamilyMemberToPersonCorr_Target());
		name2explorer.put("edge_explorer_14", edge_explorer_14);
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.checkSourceType = (o) -> o instanceof FamiliesToPersonsIBeXTGG.ProtocolNode_SonOfExistingFamilyToMale;
						edge_explorer_15_methods.checkTargetType = (o) -> o instanceof FamiliesSmartEMF.FamilyMember;
						edge_explorer_15_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_SonOfExistingFamilyToMale) o).getCREATE__SOURCE__fm();
						edge_explorer_15_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesSmartEMF.FamilyMember) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonOfExistingFamilyToMale_CREATE__SOURCE__fm().getEOpposite());
						edge_explorer_15 = new DeltaAwareEdgeExplorer(this, 7, 2, edge_explorer_15_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonOfExistingFamilyToMale_CREATE__SOURCE__fm());
		name2explorer.put("edge_explorer_15", edge_explorer_15);
		nac = new NACQueryChecker(this, 0, "SonOfExistingFamilyToMale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_166", name2actor.get("SonOfExistingFamilyToMale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_166"), 2);
		name2explorer.put("nac", nac);
		nac_0 = new NACQueryChecker(this, 1, "SonOfExistingFamilyToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_169", name2actor.get("SonOfExistingFamilyToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_169"), 2);
		name2explorer.put("nac_0", nac_0);
		nac_1 = new NACQueryChecker(this, 2, "SonOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_172", name2actor.get("SonOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_172"), 2);
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		outer: switch(match.creator) {
			case "Family_object_SP3": 
				{
					if(!lazy_initialization) {
						{
							// f
							var match_0 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_182", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyRegister_object_SP2": 
				{
					if(!lazy_initialization) {
						{
							// families
							var match_1 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_182", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP4": 
				{
					if(!lazy_initialization) {
						{
							// fm
							var match_2 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_182", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "RegisterToRegisterCorr_object_SP4": 
				{
					if(!lazy_initialization) {
						{
							// families2persons
							var match_3 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_182", numberOfNodes, 3, UsingDeltaMode.CREATE);
					...
					if(!lazy_initialization) {
						{
							...
							var match_4 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_182", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP0": 
				{
					if(!lazy_initialization) {
						{
							// persons
							var match_5 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_182", numberOfNodes, 3, UsingDeltaMode.CREATE);
							match_5.getNodes()[5] = objs[0];
							match_5.registerSignatureIndex(5);
							if(options.trackMatchingProcess)
								match_5.registerDelta(UsingDeltaMode.CREATE, objs[0]);
							start(edge_explorer_6_1_orchestration, StatelessInputType.OBJECT, match_5);
						}
					}
				}
				break;
			case "Male_object_SP1": 
				{
					if(!lazy_initialization) {
						{
							// p
							var match_6 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_182", numberOfNodes, 3, UsingDeltaMode.CREATE);
							match_6.getNodes()[6] = objs[0];
							match_6.registerSignatureIndex(6);
							if(options.trackMatchingProcess)
								match_6.registerDelta(UsingDeltaMode.CREATE, objs[0]);
							start(edge_explorer_6_2_orchestration, StatelessInputType.OBJECT, match_6);
						}
					}
				}
				break;
			case "ProtocolNode_SonOfExistingFamilyToMale_object": 
				{
					{
						...
						var match_7 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_182", numberOfNodes, 3, UsingDeltaMode.CREATE);
				...
				break;
			case "SonOfExistingFamilyToMale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_166": 
				{
					if(!lazy_initialization) {
						var inputMatch = (StatelessDeltaMatch) match;
						{
							var match_0 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_182", numberOfNodes, 3, UsingDeltaMode.DELETE);
				...
				break;
			case "SonOfExistingFamilyToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_169": 
				{
					if(!lazy_initialization) {
						var inputMatch = (StatelessDeltaMatch) match;
						{
							var match_1 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_182", numberOfNodes, 3, UsingDeltaMode.DELETE);
				...
				break;
			case "SonOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_172": 
				{
					if(!lazy_initialization) {
						var inputMatch = (StatelessDeltaMatch) match;
						{
							var match_2 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_182", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "RegisterToRegisterCorr_object_SP4": 
				{
					{
						// families2persons
						var match_3 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_182", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_3.getNodes()[3] = objs[0];
						match_3.registerSignatureIndex(3);
						if(options.trackMatchingProcess)
			...
			case "FamilyMemberToPersonCorr_object_SP0": 
				{
					{
						// familyMember2Persons
						var match_4 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_182", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_4.getNodes()[4] = objs[0];
						match_4.registerSignatureIndex(4);
						if(options.trackMatchingProcess)
			...
			case "PersonRegister_object_SP0": 
				{
					{
						// persons
						var match_5 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_182", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_5.getNodes()[5] = objs[0];
						match_5.registerSignatureIndex(5);
						if(options.trackMatchingProcess)
			...
			case "Male_object_SP1": 
				{
					{
						// p
						var match_6 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_182", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_6.getNodes()[6] = objs[0];
						match_6.registerSignatureIndex(6);
						if(options.trackMatchingProcess)
			...
			case "ProtocolNode_SonOfExistingFamilyToMale_object": 
				{
					{
						// _eMoflon_ProtocolNode_
						var match_7 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_182", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_7.getNodes()[7] = objs[0];
						match_7.registerSignatureIndex(7);
						if(options.trackMatchingProcess)
			...
			{
				{
					...
					var match = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_182", numberOfNodes, 3, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[0] = msg.target;
					if(options.trackMatchingProcess)
	...
	protected void removeReference(ReferenceDeleted msg) {
			...
			case "FamiliesSmartEMF.FamilyRegister_families_Family": 
		{
			...
			var match = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_182", numberOfNodes, 3, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[1] = msg.source;
			objs[0] = msg.target;
			if(options.trackMatchingProcess)
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof FamiliesSmartEMF.Family) {
			var match_0 = new StatelessDeltaMatch(initialMessage, "SonOfExistingFamilyToMale__CONSISTENCY_182", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_0.registerSignatureIndex(0);
		...
		if(obj instanceof PersonsSmartEMF.Male) {
			var match_6 = new StatelessDeltaMatch(initialMessage, "SonOfExistingFamilyToMale__CONSISTENCY_182", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_6.registerSignatureIndex(6);
			match_6.getNodes()[6] = obj;
			start(edge_explorer_6_2_orchestration, StatelessInputType.ATTRIBUTE, match_6);
		}
		if(obj instanceof FamiliesSmartEMF.FamilyMember) {
			var match_2 = new StatelessDeltaMatch(initialMessage, "SonOfExistingFamilyToMale__CONSISTENCY_182", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_2.registerSignatureIndex(2);
	...
	private boolean constraint_checker_method(String f_name, String fm_name, String p_name) {
		org.emoflon.ibex.tgg.runtime.csp.constraints.Concat csp_13 = new org.emoflon.ibex.tgg.runtime.csp.constraints.Concat();
		csp_13.getVariables().add(new org.emoflon.ibex.tgg.runtime.csp.RuntimeTGGAttributeConstraintVariable(true, ", ", "java.lang.String"));
		csp_13.getVariables().add(new org.emoflon.ibex.tgg.runtime.csp.RuntimeTGGAttributeConstraintVariable(true, f_name, "java.lang.String"));
		csp_13.getVariables().add(new org.emoflon.ibex.tgg.runtime.csp.RuntimeTGGAttributeConstraintVariable(true, fm_name, "java.lang.String"));
		csp_13.getVariables().add(new org.emoflon.ibex.tgg.runtime.csp.RuntimeTGGAttributeConstraintVariable(true, p_name, "java.lang.String"));
		csp_13.solve();
