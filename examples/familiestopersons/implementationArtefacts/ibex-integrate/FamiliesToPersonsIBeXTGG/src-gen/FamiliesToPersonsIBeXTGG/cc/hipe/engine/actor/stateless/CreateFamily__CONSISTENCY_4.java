...
public class CreateFamily__CONSISTENCY_4 extends GenericStatelessSearchActor{
				...
				{
					{
						...
						var match_2 = new StatelessDeltaMatch(msg, "CreateFamily__CONSISTENCY_4", numberOfNodes, 0, UsingDeltaMode.CREATE);
			...
			case "FamilyRegister_object_SP1": 
				{
					{
						// families
						var match_0 = new StatelessDeltaMatch(msg, "CreateFamily__CONSISTENCY_4", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_0.getNodes()[0] = objs[0];
						match_0.registerSignatureIndex(0);
						if(options.trackMatchingProcess)
			...
			case "Family_object_SP1": 
				{
					{
						// family
						var match_1 = new StatelessDeltaMatch(msg, "CreateFamily__CONSISTENCY_4", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_1.getNodes()[1] = objs[0];
						match_1.registerSignatureIndex(1);
						if(options.trackMatchingProcess)
			...
			case "ProtocolNode_CreateFamily_object": 
				{
					{
						// _eMoflon_ProtocolNode_
						var match_2 = new StatelessDeltaMatch(msg, "CreateFamily__CONSISTENCY_4", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_2.getNodes()[2] = objs[0];
						match_2.registerSignatureIndex(2);
						if(options.trackMatchingProcess)
