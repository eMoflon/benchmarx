...
public class SonToMale__GEN_24 extends GenericStatelessSearchActor{
			...
			case "FamilyRegister_object_SP0": 
				{
					{
						// families
						var match_0 = new StatelessDeltaMatch(msg, "SonToMale__GEN_24", numberOfNodes, 0, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP1": 
				{
					{
						// persons
						var match_1 = new StatelessDeltaMatch(msg, "SonToMale__GEN_24", numberOfNodes, 0, UsingDeltaMode.CREATE);
			...
			case "FamilyRegister_object_SP0": 
				{
					{
						// families
						var match_0 = new StatelessDeltaMatch(msg, "SonToMale__GEN_24", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_0.getNodes()[0] = objs[0];
						match_0.registerSignatureIndex(0);
						if(options.trackMatchingProcess)
			...
			case "PersonRegister_object_SP1": 
				{
					{
						// persons
						var match_1 = new StatelessDeltaMatch(msg, "SonToMale__GEN_24", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_1.getNodes()[1] = objs[0];
						match_1.registerSignatureIndex(1);
						if(options.trackMatchingProcess)
