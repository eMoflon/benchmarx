...
public class SonOfExistingFamilyToMale__GEN_21 extends GenericStatelessSearchActor{
			...
			case "Family_object": 
				{
					{
						// f
						var match_0 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__GEN_21", numberOfNodes, 0, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP0": 
				{
					{
						// persons
						var match_1 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__GEN_21", numberOfNodes, 0, UsingDeltaMode.CREATE);
			...
			case "Family_object": 
				{
					{
						// f
						var match_0 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__GEN_21", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_0.getNodes()[0] = objs[0];
						match_0.registerSignatureIndex(0);
						if(options.trackMatchingProcess)
			...
			case "PersonRegister_object_SP0": 
				{
					{
						// persons
						var match_1 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__GEN_21", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_1.getNodes()[1] = objs[0];
						match_1.registerSignatureIndex(1);
						if(options.trackMatchingProcess)
