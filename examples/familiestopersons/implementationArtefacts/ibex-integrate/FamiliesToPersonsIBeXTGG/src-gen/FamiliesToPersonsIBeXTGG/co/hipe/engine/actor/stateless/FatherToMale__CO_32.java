...
public class FatherToMale__CO_32 extends GenericStatelessSearchActor{
			...
			case "FamilyRegister_object_SP2": 
				{
					if(!lazy_initialization) {
						{
							// families
							var match_0 = new StatelessDeltaMatch(msg, "FatherToMale__CO_32", numberOfNodes, 0, UsingDeltaMode.CREATE);
			...
			case "Family_object_SP1": 
				{
					{
						// f
						var match_1 = new StatelessDeltaMatch(msg, "FatherToMale__CO_32", numberOfNodes, 0, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP1": 
				{
					if(!lazy_initialization) {
						{
							// fm
							var match_2 = new StatelessDeltaMatch(msg, "FatherToMale__CO_32", numberOfNodes, 0, UsingDeltaMode.CREATE);
			...
			case "RegisterToRegisterCorr_object_SP1": 
				{
					if(!lazy_initialization) {
						{
							// families2persons
							var match_3 = new StatelessDeltaMatch(msg, "FatherToMale__CO_32", numberOfNodes, 0, UsingDeltaMode.CREATE);
					...
					if(!lazy_initialization) {
						{
							...
							var match_4 = new StatelessDeltaMatch(msg, "FatherToMale__CO_32", numberOfNodes, 0, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP1": 
				{
					if(!lazy_initialization) {
						{
							// persons
							var match_5 = new StatelessDeltaMatch(msg, "FatherToMale__CO_32", numberOfNodes, 0, UsingDeltaMode.CREATE);
			...
			case "Male_object": 
				{
					if(!lazy_initialization) {
						{
							// p
							var match_6 = new StatelessDeltaMatch(msg, "FatherToMale__CO_32", numberOfNodes, 0, UsingDeltaMode.CREATE);
			...
			case "FamilyRegister_object_SP2": 
				{
					{
						// families
						var match_0 = new StatelessDeltaMatch(msg, "FatherToMale__CO_32", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_0.getNodes()[0] = objs[0];
						match_0.registerSignatureIndex(0);
						if(options.trackMatchingProcess)
			...
			case "Family_object_SP1": 
				{
					{
						// f
						var match_1 = new StatelessDeltaMatch(msg, "FatherToMale__CO_32", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_1.getNodes()[1] = objs[0];
						match_1.registerSignatureIndex(1);
						if(options.trackMatchingProcess)
			...
			case "FamilyMember_object_SP1": 
				{
					{
						// fm
						var match_2 = new StatelessDeltaMatch(msg, "FatherToMale__CO_32", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_2.getNodes()[2] = objs[0];
						match_2.registerSignatureIndex(2);
						if(options.trackMatchingProcess)
			...
			case "RegisterToRegisterCorr_object_SP1": 
				{
					{
						// families2persons
						var match_3 = new StatelessDeltaMatch(msg, "FatherToMale__CO_32", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_3.getNodes()[3] = objs[0];
						match_3.registerSignatureIndex(3);
						if(options.trackMatchingProcess)
			...
			case "FamilyMemberToPersonCorr_object_SP1": 
				{
					{
						// familyMember2Persons
						var match_4 = new StatelessDeltaMatch(msg, "FatherToMale__CO_32", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_4.getNodes()[4] = objs[0];
						match_4.registerSignatureIndex(4);
						if(options.trackMatchingProcess)
			...
			case "PersonRegister_object_SP1": 
				{
					{
						// persons
						var match_5 = new StatelessDeltaMatch(msg, "FatherToMale__CO_32", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_5.getNodes()[5] = objs[0];
						match_5.registerSignatureIndex(5);
						if(options.trackMatchingProcess)
			...
			case "Male_object": 
				{
					{
						// p
						var match_6 = new StatelessDeltaMatch(msg, "FatherToMale__CO_32", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_6.getNodes()[6] = objs[0];
						match_6.registerSignatureIndex(6);
						if(options.trackMatchingProcess)
			...
			{
				{
					...
					var match = new StatelessDeltaMatch(msg, "FatherToMale__CO_32", numberOfNodes, 0, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[2] = msg.target;
					if(options.trackMatchingProcess)
	...
	protected void removeReference(ReferenceDeleted msg) {
			...
			case "FamiliesSmartEMF.Family_father_FamilyMember": 
		{
			...
			var match = new StatelessDeltaMatch(msg, "FatherToMale__CO_32", numberOfNodes, 0, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[1] = msg.source;
			objs[2] = msg.target;
			if(options.trackMatchingProcess)
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof FamiliesSmartEMF.Family) {
			var match_1 = new StatelessDeltaMatch(initialMessage, "FatherToMale__CO_32", numberOfNodes, 0, UsingDeltaMode.ATTRIBUTE);
			match_1.registerSignatureIndex(1);
		...
		if(obj instanceof PersonsSmartEMF.Male) {
			var match_6 = new StatelessDeltaMatch(initialMessage, "FatherToMale__CO_32", numberOfNodes, 0, UsingDeltaMode.ATTRIBUTE);
			match_6.registerSignatureIndex(6);
		...
		if(obj instanceof FamiliesSmartEMF.FamilyMember) {
			var match_2 = new StatelessDeltaMatch(initialMessage, "FatherToMale__CO_32", numberOfNodes, 0, UsingDeltaMode.ATTRIBUTE);
			match_2.registerSignatureIndex(2);
