...
public class FatherToMale__CO_27 extends GenericStatelessSearchActor{
			...
			case "FamilyRegister_object_SP1": 
				{
					{
						// families
						var match_0 = new StatelessDeltaMatch(msg, "FatherToMale__CO_27", numberOfNodes, 0, UsingDeltaMode.CREATE);
			...
			case "Family_object_SP1": 
				{
					{
						// f
						var match_1 = new StatelessDeltaMatch(msg, "FatherToMale__CO_27", numberOfNodes, 0, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP1": 
				{
					{
						// fm
						var match_2 = new StatelessDeltaMatch(msg, "FatherToMale__CO_27", numberOfNodes, 0, UsingDeltaMode.CREATE);
				...
				{
					{
						...
						var match_3 = new StatelessDeltaMatch(msg, "FatherToMale__CO_27", numberOfNodes, 0, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP1": 
				{
					{
						// persons
						var match_4 = new StatelessDeltaMatch(msg, "FatherToMale__CO_27", numberOfNodes, 0, UsingDeltaMode.CREATE);
			...
			case "Male_object": 
				{
					{
						// p
						var match_5 = new StatelessDeltaMatch(msg, "FatherToMale__CO_27", numberOfNodes, 0, UsingDeltaMode.CREATE);
			...
			case "FamilyRegister_object_SP1": 
				{
					{
						// families
						var match_0 = new StatelessDeltaMatch(msg, "FatherToMale__CO_27", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_0.getNodes()[0] = objs[0];
						match_0.registerSignatureIndex(0);
						if(options.trackMatchingProcess)
			...
			case "Family_object_SP1": 
				{
					{
						// f
						var match_1 = new StatelessDeltaMatch(msg, "FatherToMale__CO_27", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_1.getNodes()[1] = objs[0];
						match_1.registerSignatureIndex(1);
						if(options.trackMatchingProcess)
			...
			case "FamilyMember_object_SP1": 
				{
					{
						// fm
						var match_2 = new StatelessDeltaMatch(msg, "FatherToMale__CO_27", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_2.getNodes()[2] = objs[0];
						match_2.registerSignatureIndex(2);
						if(options.trackMatchingProcess)
			...
			case "FamilyMemberToPersonCorr_object_SP1": 
				{
					{
						// familyMember2Persons
						var match_3 = new StatelessDeltaMatch(msg, "FatherToMale__CO_27", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_3.getNodes()[3] = objs[0];
						match_3.registerSignatureIndex(3);
						if(options.trackMatchingProcess)
			...
			case "PersonRegister_object_SP1": 
				{
					{
						// persons
						var match_4 = new StatelessDeltaMatch(msg, "FatherToMale__CO_27", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_4.getNodes()[4] = objs[0];
						match_4.registerSignatureIndex(4);
						if(options.trackMatchingProcess)
			...
			case "Male_object": 
				{
					{
						// p
						var match_5 = new StatelessDeltaMatch(msg, "FatherToMale__CO_27", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_5.getNodes()[5] = objs[0];
						match_5.registerSignatureIndex(5);
						if(options.trackMatchingProcess)
