...
public class DaughterToFemale__FWD_41 extends GenericStatelessSearchActor{
			...
			case "FamilyRegister_object_SP2": 
				{
					{
						// families
						var match_0 = new StatelessDeltaMatch(msg, "DaughterToFemale__FWD_41", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Family_object_SP8": 
				{
					{
						// f
						var match_1 = new StatelessDeltaMatch(msg, "DaughterToFemale__FWD_41", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP5": 
				{
					{
						// fm
						var match_2 = new StatelessDeltaMatch(msg, "DaughterToFemale__FWD_41", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP3": 
				{
					{
						// persons
						var match_3 = new StatelessDeltaMatch(msg, "DaughterToFemale__FWD_41", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "DaughterToFemale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_32": 
				{
					...
					{
						var match_0 = new StatelessDeltaMatch(msg, "DaughterToFemale__FWD_41", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "DaughterToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_35": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_1 = new StatelessDeltaMatch(msg, "DaughterToFemale__FWD_41", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "DaughterToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_38": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_2 = new StatelessDeltaMatch(msg, "DaughterToFemale__FWD_41", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "PersonRegister_object_SP3": 
				{
					{
						// persons
						var match_3 = new StatelessDeltaMatch(msg, "DaughterToFemale__FWD_41", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_3.getNodes()[3] = objs[0];
						match_3.registerSignatureIndex(3);
						if(options.trackMatchingProcess)
			...
			{
				{
					...
					var match = new StatelessDeltaMatch(msg, "DaughterToFemale__FWD_41", numberOfNodes, 3, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					if(options.trackMatchingProcess)
	...
	protected void removeReference(ReferenceDeleted msg) {
			...
			case "FamiliesSmartEMF.FamilyRegister_families_Family": 
		{
			...
			var match = new StatelessDeltaMatch(msg, "DaughterToFemale__FWD_41", numberOfNodes, 3, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[0] = msg.source;
			objs[1] = msg.target;
			if(options.trackMatchingProcess)
