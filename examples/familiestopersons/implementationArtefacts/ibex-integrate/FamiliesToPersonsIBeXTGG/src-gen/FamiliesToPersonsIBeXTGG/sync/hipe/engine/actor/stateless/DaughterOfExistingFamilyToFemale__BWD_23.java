...
public class DaughterOfExistingFamilyToFemale__BWD_23 extends GenericStatelessSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						...
						edge_explorer_3 = new DeltaAwareEdgeExplorer(this, 2, 3, edge_explorer_3_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getRegisterToRegisterCorr_Target());
			...
			case "Family_object_SP6": 
				{
					if(!lazy_initialization) {
						{
							// f
							var match_0 = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__BWD_23", numberOfNodes, 0, UsingDeltaMode.CREATE);
			...
			case "FamilyRegister_object_SP3": 
				{
					if(!lazy_initialization) {
						{
							// families
							var match_1 = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__BWD_23", numberOfNodes, 0, UsingDeltaMode.CREATE);
			...
			case "RegisterToRegisterCorr_object_SP1": 
				{
					{
						// families2persons
						var match_2 = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__BWD_23", numberOfNodes, 0, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP1": 
				{
					if(!lazy_initialization) {
						{
							// persons
							var match_3 = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__BWD_23", numberOfNodes, 0, UsingDeltaMode.CREATE);
			...
			case "Female_object_SP0": 
				{
					if(!lazy_initialization) {
						{
							// p
							var match_4 = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__BWD_23", numberOfNodes, 0, UsingDeltaMode.CREATE);
			...
			case "Family_object_SP6": 
				{
					{
						// f
						var match_0 = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__BWD_23", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_0.getNodes()[0] = objs[0];
						match_0.registerSignatureIndex(0);
						if(options.trackMatchingProcess)
			...
			case "FamilyRegister_object_SP3": 
				{
					{
						// families
						var match_1 = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__BWD_23", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_1.getNodes()[1] = objs[0];
						match_1.registerSignatureIndex(1);
						if(options.trackMatchingProcess)
			...
			case "RegisterToRegisterCorr_object_SP1": 
				{
					{
						// families2persons
						var match_2 = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__BWD_23", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_2.getNodes()[2] = objs[0];
						match_2.registerSignatureIndex(2);
						if(options.trackMatchingProcess)
			...
			case "PersonRegister_object_SP1": 
				{
					{
						// persons
						var match_3 = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__BWD_23", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_3.getNodes()[3] = objs[0];
						match_3.registerSignatureIndex(3);
						if(options.trackMatchingProcess)
			...
			case "Female_object_SP0": 
				{
					{
						// p
						var match_4 = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__BWD_23", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_4.getNodes()[4] = objs[0];
						match_4.registerSignatureIndex(4);
						if(options.trackMatchingProcess)
			...
			{
				{
					...
					var match = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__BWD_23", numberOfNodes, 0, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[0] = msg.target;
					if(options.trackMatchingProcess)
	...
	protected void removeReference(ReferenceDeleted msg) {
			...
			case "FamiliesSmartEMF.FamilyRegister_families_Family": 
		{
			...
			var match = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__BWD_23", numberOfNodes, 0, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[1] = msg.source;
			objs[0] = msg.target;
			if(options.trackMatchingProcess)
