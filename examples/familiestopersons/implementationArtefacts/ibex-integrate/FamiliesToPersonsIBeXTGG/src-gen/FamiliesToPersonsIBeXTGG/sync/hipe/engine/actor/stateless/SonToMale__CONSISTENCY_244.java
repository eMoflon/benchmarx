...
public class SonToMale__CONSISTENCY_244 extends GenericStatelessSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						...
						edge_explorer_3_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_SonToMale) o).getCONTEXT__SOURCE__families();
						edge_explorer_3_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesSmartEMF.FamilyRegister) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonToMale_CONTEXT__SOURCE__families().getEOpposite());
						edge_explorer_3 = new DeltaAwareEdgeExplorer(this, 7, 0, edge_explorer_3_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonToMale_CONTEXT__SOURCE__families());
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						...
						edge_explorer_4 = new DeltaAwareEdgeExplorer(this, 7, 6, edge_explorer_4_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonToMale_CREATE__TARGET__p());
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						...
						edge_explorer_5_methods.checkTargetType = (o) -> o instanceof FamiliesToPersonsIBeXTGG.FamilyMemberToPersonCorr;
						edge_explorer_5_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_SonToMale) o).getCREATE__CORRESPONDENCE__familyMember2Persons();
						edge_explorer_5_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesToPersonsIBeXTGG.FamilyMemberToPersonCorr) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonToMale_CREATE__CORRESPONDENCE__familyMember2Persons().getEOpposite());
						edge_explorer_5 = new DeltaAwareEdgeExplorer(this, 7, 4, edge_explorer_5_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonToMale_CREATE__CORRESPONDENCE__familyMember2Persons());
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						...
						edge_explorer_6 = new DeltaAwareEdgeExplorer(this, 4, 2, edge_explorer_6_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getFamilyMemberToPersonCorr_Source());
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						...
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((FamiliesToPersonsIBeXTGG.FamilyMemberToPersonCorr) o).getTarget(); return (result instanceof PersonsSmartEMF.Male ? result : null);};
						...
						edge_explorer_8 = new DeltaAwareEdgeExplorer(this, 4, 6, edge_explorer_8_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getFamilyMemberToPersonCorr_Target());
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						...
						edge_explorer_11_methods.checkTargetType = (o) -> o instanceof PersonsSmartEMF.Male;
						edge_explorer_11_methods.multi_lookup = (o) -> ((PersonsSmartEMF.PersonRegister) o).getPersons().stream().filter(obj -> obj instanceof PersonsSmartEMF.Male).collect(Collectors.toList());
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						...
						edge_explorer_12_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_SonToMale) o).getCREATE__SOURCE__f();
						edge_explorer_12_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesSmartEMF.Family) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonToMale_CREATE__SOURCE__f().getEOpposite());
						edge_explorer_12 = new DeltaAwareEdgeExplorer(this, 7, 1, edge_explorer_12_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonToMale_CREATE__SOURCE__f());
		name2explorer.put("edge_explorer_12", edge_explorer_12);
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.checkSourceType = (o) -> o instanceof FamiliesToPersonsIBeXTGG.ProtocolNode_SonToMale;
						edge_explorer_13_methods.checkTargetType = (o) -> o instanceof FamiliesSmartEMF.FamilyMember;
						edge_explorer_13_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_SonToMale) o).getCREATE__SOURCE__fm();
						edge_explorer_13_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesSmartEMF.FamilyMember) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonToMale_CREATE__SOURCE__fm().getEOpposite());
						edge_explorer_13 = new DeltaAwareEdgeExplorer(this, 7, 2, edge_explorer_13_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonToMale_CREATE__SOURCE__fm());
		name2explorer.put("edge_explorer_13", edge_explorer_13);
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.checkSourceType = (o) -> o instanceof FamiliesToPersonsIBeXTGG.ProtocolNode_SonToMale;
						edge_explorer_14_methods.checkTargetType = (o) -> o instanceof FamiliesToPersonsIBeXTGG.RegisterToRegisterCorr;
						edge_explorer_14_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_SonToMale) o).getCONTEXT__CORRESPONDENCE__families2persons();
						edge_explorer_14_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesToPersonsIBeXTGG.RegisterToRegisterCorr) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonToMale_CONTEXT__CORRESPONDENCE__families2persons().getEOpposite());
						edge_explorer_14 = new DeltaAwareEdgeExplorer(this, 7, 3, edge_explorer_14_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonToMale_CONTEXT__CORRESPONDENCE__families2persons());
		name2explorer.put("edge_explorer_14", edge_explorer_14);
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.checkSourceType = (o) -> o instanceof FamiliesToPersonsIBeXTGG.ProtocolNode_SonToMale;
						edge_explorer_15_methods.checkTargetType = (o) -> o instanceof PersonsSmartEMF.PersonRegister;
						edge_explorer_15_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_SonToMale) o).getCONTEXT__TARGET__persons();
						edge_explorer_15_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((PersonsSmartEMF.PersonRegister) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonToMale_CONTEXT__TARGET__persons().getEOpposite());
						edge_explorer_15 = new DeltaAwareEdgeExplorer(this, 7, 5, edge_explorer_15_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonToMale_CONTEXT__TARGET__persons());
		name2explorer.put("edge_explorer_15", edge_explorer_15);
		nac = new NACQueryChecker(this, 0, "SonToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_224", name2actor.get("SonToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_224"), 2);
		name2explorer.put("nac", nac);
		nac_0 = new NACQueryChecker(this, 1, "SonToMale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_227", name2actor.get("SonToMale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_227"), 2);
		name2explorer.put("nac_0", nac_0);
		nac_1 = new NACQueryChecker(this, 2, "SonToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_230", name2actor.get("SonToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_230"), 2);
		name2explorer.put("nac_1", nac_1);
		disjoint_explorer_6 = new DisjointExplorer(this, observedResources, 7, (o) -> o instanceof FamiliesToPersonsIBeXTGG.ProtocolNode_SonToMale, true);
			...
			case "FamilyRegister_object_SP6": 
				{
					if(!lazy_initialization) {
						{
							// families
							var match_0 = new StatelessDeltaMatch(msg, "SonToMale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Family_object_SP9": 
				{
					if(!lazy_initialization) {
						{
							// f
							var match_1 = new StatelessDeltaMatch(msg, "SonToMale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP9": 
				{
					if(!lazy_initialization) {
						{
							// fm
							var match_2 = new StatelessDeltaMatch(msg, "SonToMale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "RegisterToRegisterCorr_object_SP3": 
				{
					if(!lazy_initialization) {
						{
							// families2persons
							var match_3 = new StatelessDeltaMatch(msg, "SonToMale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.CREATE);
							match_3.getNodes()[3] = objs[0];
							match_3.registerSignatureIndex(3);
							if(options.trackMatchingProcess)
								match_3.registerDelta(UsingDeltaMode.CREATE, objs[0]);
							start(edge_explorer_9_1_orchestration, StatelessInputType.OBJECT, match_3);
						}
					}
				}
				break;
					...
					if(!lazy_initialization) {
						{
							...
							var match_4 = new StatelessDeltaMatch(msg, "SonToMale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP4": 
				{
					if(!lazy_initialization) {
						{
							// persons
							var match_5 = new StatelessDeltaMatch(msg, "SonToMale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.CREATE);
							match_5.getNodes()[5] = objs[0];
							match_5.registerSignatureIndex(5);
							if(options.trackMatchingProcess)
								match_5.registerDelta(UsingDeltaMode.CREATE, objs[0]);
							start(edge_explorer_10_1_orchestration, StatelessInputType.OBJECT, match_5);
						}
					}
				}
				break;
			case "Male_object_SP1": 
				{
					if(!lazy_initialization) {
						{
							// p
							var match_6 = new StatelessDeltaMatch(msg, "SonToMale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.CREATE);
				...
				break;
			case "ProtocolNode_SonToMale_object": 
				{
					{
						// _eMoflon_ProtocolNode_
						var match_7 = new StatelessDeltaMatch(msg, "SonToMale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.CREATE);
				...
				break;
			case "SonToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_224": 
				{
					if(!lazy_initialization) {
						var inputMatch = (StatelessDeltaMatch) match;
						{
							var match_0 = new StatelessDeltaMatch(msg, "SonToMale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.DELETE);
				...
				break;
			case "SonToMale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_227": 
				{
					if(!lazy_initialization) {
						var inputMatch = (StatelessDeltaMatch) match;
						{
							var match_1 = new StatelessDeltaMatch(msg, "SonToMale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.DELETE);
				...
				break;
			case "SonToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_230": 
				{
					if(!lazy_initialization) {
						var inputMatch = (StatelessDeltaMatch) match;
						{
							var match_2 = new StatelessDeltaMatch(msg, "SonToMale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "RegisterToRegisterCorr_object_SP3": 
				{
					{
						// families2persons
						var match_3 = new StatelessDeltaMatch(msg, "SonToMale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_3.getNodes()[3] = objs[0];
						match_3.registerSignatureIndex(3);
						if(options.trackMatchingProcess)
			...
			case "FamilyMemberToPersonCorr_object_SP1": 
				{
					{
						// familyMember2Persons
						var match_4 = new StatelessDeltaMatch(msg, "SonToMale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_4.getNodes()[4] = objs[0];
						match_4.registerSignatureIndex(4);
						if(options.trackMatchingProcess)
			...
			case "PersonRegister_object_SP4": 
				{
					{
						// persons
						var match_5 = new StatelessDeltaMatch(msg, "SonToMale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_5.getNodes()[5] = objs[0];
						match_5.registerSignatureIndex(5);
						if(options.trackMatchingProcess)
			...
			case "Male_object_SP1": 
				{
					{
						// p
						var match_6 = new StatelessDeltaMatch(msg, "SonToMale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_6.getNodes()[6] = objs[0];
						match_6.registerSignatureIndex(6);
						if(options.trackMatchingProcess)
			...
			case "ProtocolNode_SonToMale_object": 
				{
					{
						// _eMoflon_ProtocolNode_
						var match_7 = new StatelessDeltaMatch(msg, "SonToMale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_7.getNodes()[7] = objs[0];
						match_7.registerSignatureIndex(7);
						if(options.trackMatchingProcess)
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "FamiliesSmartEMF.FamilyRegister_families_Family": 
			{
				{
					...
					var match = new StatelessDeltaMatch(msg, "SonToMale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					if(options.trackMatchingProcess)
			...
			break;
		case "FamiliesToPersonsIBeXTGG.ProtocolNode_SonToMale_CONTEXT__SOURCE__families_FamilyRegister": 
			{
				{
					if(notificationIndex.isNew(msg.source) || notificationIndex.isNew(msg.target))
						break;
		...
		case "FamiliesToPersonsIBeXTGG.ProtocolNode_SonToMale_CREATE__SOURCE__fm_FamilyMember": 
			...
			break;
		case "FamiliesToPersonsIBeXTGG.ProtocolNode_SonToMale_CONTEXT__CORRESPONDENCE__families2persons_RegisterToRegisterCorr": 
			{
				{
					if(notificationIndex.isNew(msg.source) || notificationIndex.isNew(msg.target))
						break;
	...
	protected void removeReference(ReferenceDeleted msg) {
			...
			case "FamiliesSmartEMF.FamilyRegister_families_Family": 
		{
			...
			var match = new StatelessDeltaMatch(msg, "SonToMale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[0] = msg.source;
			objs[1] = msg.target;
			if(options.trackMatchingProcess)
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof FamiliesSmartEMF.Family) {
			var match_1 = new StatelessDeltaMatch(initialMessage, "SonToMale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_1.registerSignatureIndex(1);
		...
		if(obj instanceof PersonsSmartEMF.Male) {
			var match_6 = new StatelessDeltaMatch(initialMessage, "SonToMale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_6.registerSignatureIndex(6);
		...
		if(obj instanceof FamiliesSmartEMF.FamilyMember) {
			var match_2 = new StatelessDeltaMatch(initialMessage, "SonToMale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_2.registerSignatureIndex(2);
