...
public class FatherOfExistingFamilyToMale__CONSISTENCY_97 extends GenericStatelessSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						...
						edge_explorer_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_FatherOfExistingFamilyToMale) o).getCREATE__TARGET__p();
						edge_explorer_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((PersonsSmartEMF.Male) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_FatherOfExistingFamilyToMale_CREATE__TARGET__p().getEOpposite());
						edge_explorer = new DeltaAwareEdgeExplorer(this, 7, 6, edge_explorer_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_FatherOfExistingFamilyToMale_CREATE__TARGET__p());
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						...
						edge_explorer_3 = new DeltaAwareEdgeExplorer(this, 5, 6, edge_explorer_3_methods, PersonsSmartEMF.PersonsSmartEMFPackage.eINSTANCE.getPersonRegister_Persons());
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						...
						edge_explorer_4 = new DeltaAwareEdgeExplorer(this, 4, 6, edge_explorer_4_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getFamilyMemberToPersonCorr_Target());
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						...
						edge_explorer_5_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_FatherOfExistingFamilyToMale) o).getCONTEXT__SOURCE__f();
						edge_explorer_5_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesSmartEMF.Family) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_FatherOfExistingFamilyToMale_CONTEXT__SOURCE__f().getEOpposite());
						edge_explorer_5 = new DeltaAwareEdgeExplorer(this, 7, 0, edge_explorer_5_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_FatherOfExistingFamilyToMale_CONTEXT__SOURCE__f());
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						...
						edge_explorer_6 = new DeltaAwareEdgeExplorer(this, 1, 0, edge_explorer_6_methods, FamiliesSmartEMF.FamiliesSmartEMFPackage.eINSTANCE.getFamilyRegister_Families());
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						...
						edge_explorer_7 = new DeltaAwareEdgeExplorer(this, 7, 5, edge_explorer_7_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_FatherOfExistingFamilyToMale_CONTEXT__TARGET__persons());
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						...
						edge_explorer_8_methods.unique_lookup = (o) -> ((FamiliesSmartEMF.Family) o).getFather();
						edge_explorer_8_methods.unique_opposite_lookup = (o) -> ((FamiliesSmartEMF.FamilyMember) o).getFatherInverse();
						edge_explorer_8 = new DeltaAwareEdgeExplorer(this, 0, 2, edge_explorer_8_methods, FamiliesSmartEMF.FamiliesSmartEMFPackage.eINSTANCE.getFamily_Father());
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						...
						edge_explorer_9_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_FatherOfExistingFamilyToMale) o).getCREATE__SOURCE__fm();
						edge_explorer_9_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesSmartEMF.FamilyMember) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_FatherOfExistingFamilyToMale_CREATE__SOURCE__fm().getEOpposite());
						edge_explorer_9 = new DeltaAwareEdgeExplorer(this, 7, 2, edge_explorer_9_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_FatherOfExistingFamilyToMale_CREATE__SOURCE__fm());
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						...
						edge_explorer_10_methods.checkTargetType = (o) -> o instanceof FamiliesToPersonsIBeXTGG.RegisterToRegisterCorr;
						edge_explorer_10_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_FatherOfExistingFamilyToMale) o).getCONTEXT__CORRESPONDENCE__families2persons();
						edge_explorer_10_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesToPersonsIBeXTGG.RegisterToRegisterCorr) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_FatherOfExistingFamilyToMale_CONTEXT__CORRESPONDENCE__families2persons().getEOpposite());
						edge_explorer_10 = new DeltaAwareEdgeExplorer(this, 7, 3, edge_explorer_10_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_FatherOfExistingFamilyToMale_CONTEXT__CORRESPONDENCE__families2persons());
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						...
						edge_explorer_12_methods.checkTargetType = (o) -> o instanceof FamiliesSmartEMF.FamilyRegister;
						edge_explorer_12_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.RegisterToRegisterCorr) o).getSource();
						edge_explorer_12_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesSmartEMF.FamilyRegister) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getRegisterToRegisterCorr_Source().getEOpposite());
						edge_explorer_12 = new DeltaAwareEdgeExplorer(this, 3, 1, edge_explorer_12_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getRegisterToRegisterCorr_Source());
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						...
						edge_explorer_14_methods.checkTargetType = (o) -> o instanceof PersonsSmartEMF.PersonRegister;
						edge_explorer_14_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.RegisterToRegisterCorr) o).getTarget();
						edge_explorer_14_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((PersonsSmartEMF.PersonRegister) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getRegisterToRegisterCorr_Target().getEOpposite());
						edge_explorer_14 = new DeltaAwareEdgeExplorer(this, 3, 5, edge_explorer_14_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getRegisterToRegisterCorr_Target());
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						...
						edge_explorer_15_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_FatherOfExistingFamilyToMale) o).getCREATE__CORRESPONDENCE__familyMember2Persons();
						edge_explorer_15_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesToPersonsIBeXTGG.FamilyMemberToPersonCorr) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_FatherOfExistingFamilyToMale_CREATE__CORRESPONDENCE__familyMember2Persons().getEOpposite());
						edge_explorer_15 = new DeltaAwareEdgeExplorer(this, 7, 4, edge_explorer_15_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_FatherOfExistingFamilyToMale_CREATE__CORRESPONDENCE__familyMember2Persons());
		name2explorer.put("edge_explorer_15", edge_explorer_15);
		nac = new NACQueryChecker(this, 0, "FatherOfExistingFamilyToMale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_76", name2actor.get("FatherOfExistingFamilyToMale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_76"), 2);
		name2explorer.put("nac", nac);
		nac_0 = new NACQueryChecker(this, 1, "FatherOfExistingFamilyToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_79", name2actor.get("FatherOfExistingFamilyToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_79"), 2);
		name2explorer.put("nac_0", nac_0);
		nac_1 = new NACQueryChecker(this, 2, "FatherOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_82", name2actor.get("FatherOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_82"), 2);
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		outer: switch(match.creator) {
			case "Family_object_SP6": 
				{
					if(!lazy_initialization) {
						{
							// f
							var match_0 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_97", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyRegister_object_SP5": 
				{
					if(!lazy_initialization) {
						{
							// families
							var match_1 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_97", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP4": 
				{
					if(!lazy_initialization) {
						{
							// fm
							var match_2 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_97", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "RegisterToRegisterCorr_object_SP2": 
				{
					if(!lazy_initialization) {
						{
							// families2persons
							var match_3 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_97", numberOfNodes, 3, UsingDeltaMode.CREATE);
							match_3.getNodes()[3] = objs[0];
							match_3.registerSignatureIndex(3);
							if(options.trackMatchingProcess)
								match_3.registerDelta(UsingDeltaMode.CREATE, objs[0]);
							start(edge_explorer_10_1_orchestration, StatelessInputType.OBJECT, match_3);
						}
					}
				}
				break;
					...
					if(!lazy_initialization) {
						{
							...
							var match_4 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_97", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP3": 
				{
					if(!lazy_initialization) {
						{
							// persons
							var match_5 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_97", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Male_object_SP1": 
				{
					if(!lazy_initialization) {
						{
							// p
							var match_6 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_97", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "ProtocolNode_FatherOfExistingFamilyToMale_object": 
				{
					{
						...
						var match_7 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_97", numberOfNodes, 3, UsingDeltaMode.CREATE);
				...
				break;
			case "FatherOfExistingFamilyToMale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_76": 
				{
					if(!lazy_initialization) {
						var inputMatch = (StatelessDeltaMatch) match;
						{
							var match_0 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_97", numberOfNodes, 3, UsingDeltaMode.DELETE);
				...
				break;
			case "FatherOfExistingFamilyToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_79": 
				{
					if(!lazy_initialization) {
						var inputMatch = (StatelessDeltaMatch) match;
						{
							var match_1 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_97", numberOfNodes, 3, UsingDeltaMode.DELETE);
				...
				break;
			case "FatherOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_82": 
				{
					if(!lazy_initialization) {
						var inputMatch = (StatelessDeltaMatch) match;
						{
							var match_2 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_97", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "RegisterToRegisterCorr_object_SP2": 
				{
					{
						// families2persons
						var match_3 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_97", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_3.getNodes()[3] = objs[0];
						match_3.registerSignatureIndex(3);
						if(options.trackMatchingProcess)
			...
			case "FamilyMemberToPersonCorr_object_SP0": 
				{
					{
						// familyMember2Persons
						var match_4 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_97", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_4.getNodes()[4] = objs[0];
						match_4.registerSignatureIndex(4);
						if(options.trackMatchingProcess)
			...
			case "PersonRegister_object_SP3": 
				{
					{
						// persons
						var match_5 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_97", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_5.getNodes()[5] = objs[0];
						match_5.registerSignatureIndex(5);
						if(options.trackMatchingProcess)
			...
			case "Male_object_SP1": 
				{
					{
						// p
						var match_6 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_97", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_6.getNodes()[6] = objs[0];
						match_6.registerSignatureIndex(6);
						if(options.trackMatchingProcess)
			...
			case "ProtocolNode_FatherOfExistingFamilyToMale_object": 
				{
					{
						// _eMoflon_ProtocolNode_
						var match_7 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_97", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_7.getNodes()[7] = objs[0];
						match_7.registerSignatureIndex(7);
						if(options.trackMatchingProcess)
			...
			{
				{
					...
					var match = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_97", numberOfNodes, 3, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[7] = msg.source;
					objs[6] = msg.target;
					if(options.trackMatchingProcess)
	...
	protected void removeReference(ReferenceDeleted msg) {
			...
			case "FamiliesToPersonsIBeXTGG.ProtocolNode_FatherOfExistingFamilyToMale_CREATE__TARGET__p_Male": 
		{
			...
			var match = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_97", numberOfNodes, 3, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[7] = msg.source;
			objs[6] = msg.target;
			if(options.trackMatchingProcess)
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof FamiliesSmartEMF.Family) {
			var match_0 = new StatelessDeltaMatch(initialMessage, "FatherOfExistingFamilyToMale__CONSISTENCY_97", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_0.registerSignatureIndex(0);
		...
		if(obj instanceof PersonsSmartEMF.Male) {
			var match_6 = new StatelessDeltaMatch(initialMessage, "FatherOfExistingFamilyToMale__CONSISTENCY_97", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_6.registerSignatureIndex(6);
		...
		if(obj instanceof FamiliesSmartEMF.FamilyMember) {
			var match_2 = new StatelessDeltaMatch(initialMessage, "FatherOfExistingFamilyToMale__CONSISTENCY_97", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_2.registerSignatureIndex(2);
	...
	private boolean constraint_checker_method(String f_name, String fm_name, String p_name) {
		org.emoflon.ibex.tgg.runtime.csp.constraints.Concat csp_2 = new org.emoflon.ibex.tgg.runtime.csp.constraints.Concat();
		csp_2.getVariables().add(new org.emoflon.ibex.tgg.runtime.csp.RuntimeTGGAttributeConstraintVariable(true, ", ", "java.lang.String"));
		csp_2.getVariables().add(new org.emoflon.ibex.tgg.runtime.csp.RuntimeTGGAttributeConstraintVariable(true, f_name, "java.lang.String"));
		csp_2.getVariables().add(new org.emoflon.ibex.tgg.runtime.csp.RuntimeTGGAttributeConstraintVariable(true, fm_name, "java.lang.String"));
		csp_2.getVariables().add(new org.emoflon.ibex.tgg.runtime.csp.RuntimeTGGAttributeConstraintVariable(true, p_name, "java.lang.String"));
		csp_2.solve();
