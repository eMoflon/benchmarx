...
public class SonToMale__FWD_200 extends GenericStatelessSearchActor{
			...
			case "FamilyRegister_object_SP1": 
				{
					{
						// families
						var match_0 = new StatelessDeltaMatch(msg, "SonToMale__FWD_200", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Family_object_SP5": 
				{
					{
						// f
						var match_1 = new StatelessDeltaMatch(msg, "SonToMale__FWD_200", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP5": 
				{
					{
						// fm
						var match_2 = new StatelessDeltaMatch(msg, "SonToMale__FWD_200", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP2": 
				{
					{
						// persons
						var match_3 = new StatelessDeltaMatch(msg, "SonToMale__FWD_200", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "SonToMale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_191": 
				{
					...
					{
						var match_0 = new StatelessDeltaMatch(msg, "SonToMale__FWD_200", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "SonToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_194": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_1 = new StatelessDeltaMatch(msg, "SonToMale__FWD_200", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "SonToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_197": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_2 = new StatelessDeltaMatch(msg, "SonToMale__FWD_200", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "PersonRegister_object_SP2": 
				{
					{
						// persons
						var match_3 = new StatelessDeltaMatch(msg, "SonToMale__FWD_200", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_3.getNodes()[3] = objs[0];
						match_3.registerSignatureIndex(3);
						if(options.trackMatchingProcess)
			...
			{
				{
					...
					var match = new StatelessDeltaMatch(msg, "SonToMale__FWD_200", numberOfNodes, 3, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[2] = msg.target;
					if(options.trackMatchingProcess)
	...
	protected void removeReference(ReferenceDeleted msg) {
			...
			case "FamiliesSmartEMF.Family_sons_FamilyMember": 
		{
			...
			var match = new StatelessDeltaMatch(msg, "SonToMale__FWD_200", numberOfNodes, 3, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[1] = msg.source;
			objs[2] = msg.target;
			if(options.trackMatchingProcess)
