...
public class FatherOfExistingFamilyToMale__CONSISTENCY_84 extends GenericStatelessSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						...
						edge_explorer_4_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_FatherOfExistingFamilyToMale) o).getCREATE__TARGET__p();
						edge_explorer_4_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((PersonsSmartEMF.Male) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_FatherOfExistingFamilyToMale_CREATE__TARGET__p().getEOpposite());
						edge_explorer_4 = new DeltaAwareEdgeExplorer(this, 5, 4, edge_explorer_4_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_FatherOfExistingFamilyToMale_CREATE__TARGET__p());
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						...
						edge_explorer_8_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_FatherOfExistingFamilyToMale) o).getCONTEXT__SOURCE__f();
						edge_explorer_8_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesSmartEMF.Family) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_FatherOfExistingFamilyToMale_CONTEXT__SOURCE__f().getEOpposite());
						edge_explorer_8 = new DeltaAwareEdgeExplorer(this, 5, 0, edge_explorer_8_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_FatherOfExistingFamilyToMale_CONTEXT__SOURCE__f());
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						...
						edge_explorer_10 = new DeltaAwareEdgeExplorer(this, 0, 1, edge_explorer_10_methods, FamiliesSmartEMF.FamiliesSmartEMFPackage.eINSTANCE.getFamily_Father());
			...
			case "Family_object_SP6": 
				{
					{
						// f
						var match_0 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_84", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP4": 
				{
					{
						// fm
						var match_1 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_84", numberOfNodes, 3, UsingDeltaMode.CREATE);
				...
				{
					{
						...
						var match_2 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_84", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP3": 
				{
					{
						// persons
						var match_3 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_84", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Male_object_SP1": 
				{
					{
						// p
						var match_4 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_84", numberOfNodes, 3, UsingDeltaMode.CREATE);
				...
				{
					{
						...
						var match_5 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_84", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FatherOfExistingFamilyToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_67": 
				{
					...
					{
						var match_0 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_84", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "FatherOfExistingFamilyToMale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_70": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_1 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_84", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "FatherOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_73": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_2 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_84", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "PersonRegister_object_SP3": 
				{
					{
						// persons
						var match_3 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_84", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_3.getNodes()[3] = objs[0];
						match_3.registerSignatureIndex(3);
						if(options.trackMatchingProcess)
			...
			case "Male_object_SP1": 
				{
					{
						// p
						var match_4 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_84", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_4.getNodes()[4] = objs[0];
						match_4.registerSignatureIndex(4);
						if(options.trackMatchingProcess)
			...
			case "ProtocolNode_FatherOfExistingFamilyToMale_object": 
				{
					{
						// _eMoflon_ProtocolNode_
						var match_5 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__CONSISTENCY_84", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_5.getNodes()[5] = objs[0];
						match_5.registerSignatureIndex(5);
						if(options.trackMatchingProcess)
