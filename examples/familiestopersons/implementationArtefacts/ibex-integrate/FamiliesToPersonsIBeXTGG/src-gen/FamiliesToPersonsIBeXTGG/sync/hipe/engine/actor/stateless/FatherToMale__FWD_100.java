...
public class FatherToMale__FWD_100 extends GenericStatelessSearchActor{
			...
			case "FamilyRegister_object_SP3": 
				{
					{
						// families
						var match_0 = new StatelessDeltaMatch(msg, "FatherToMale__FWD_100", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Family_object_SP7": 
				{
					{
						// f
						var match_1 = new StatelessDeltaMatch(msg, "FatherToMale__FWD_100", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP5": 
				{
					{
						// fm
						var match_2 = new StatelessDeltaMatch(msg, "FatherToMale__FWD_100", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP4": 
				{
					{
						// persons
						var match_3 = new StatelessDeltaMatch(msg, "FatherToMale__FWD_100", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FatherToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_91": 
				{
					...
					{
						var match_0 = new StatelessDeltaMatch(msg, "FatherToMale__FWD_100", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "FatherToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_94": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_1 = new StatelessDeltaMatch(msg, "FatherToMale__FWD_100", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "FatherToMale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_97": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_2 = new StatelessDeltaMatch(msg, "FatherToMale__FWD_100", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "PersonRegister_object_SP4": 
				{
					{
						// persons
						var match_3 = new StatelessDeltaMatch(msg, "FatherToMale__FWD_100", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_3.getNodes()[3] = objs[0];
						match_3.registerSignatureIndex(3);
						if(options.trackMatchingProcess)
			...
			{
				{
					...
					var match = new StatelessDeltaMatch(msg, "FatherToMale__FWD_100", numberOfNodes, 3, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					if(options.trackMatchingProcess)
	...
	protected void removeReference(ReferenceDeleted msg) {
			...
			case "FamiliesSmartEMF.FamilyRegister_families_Family": 
		{
			...
			var match = new StatelessDeltaMatch(msg, "FatherToMale__FWD_100", numberOfNodes, 3, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[0] = msg.source;
			objs[1] = msg.target;
			if(options.trackMatchingProcess)
