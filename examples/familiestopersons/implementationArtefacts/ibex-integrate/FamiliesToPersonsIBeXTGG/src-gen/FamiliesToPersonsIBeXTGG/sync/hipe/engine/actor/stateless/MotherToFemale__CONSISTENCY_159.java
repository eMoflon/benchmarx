...
public class MotherToFemale__CONSISTENCY_159 extends GenericStatelessSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						...
						edge_explorer_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_MotherToFemale) o).getCREATE__CORRESPONDENCE__familyMember2Persons();
						edge_explorer_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesToPersonsIBeXTGG.FamilyMemberToPersonCorr) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_MotherToFemale_CREATE__CORRESPONDENCE__familyMember2Persons().getEOpposite());
						edge_explorer = new DeltaAwareEdgeExplorer(this, 6, 3, edge_explorer_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_MotherToFemale_CREATE__CORRESPONDENCE__familyMember2Persons());
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						...
						edge_explorer_5_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_MotherToFemale) o).getCREATE__TARGET__p();
						edge_explorer_5_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((PersonsSmartEMF.Female) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_MotherToFemale_CREATE__TARGET__p().getEOpposite());
						edge_explorer_5 = new DeltaAwareEdgeExplorer(this, 6, 5, edge_explorer_5_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_MotherToFemale_CREATE__TARGET__p());
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						...
						edge_explorer_8_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_MotherToFemale) o).getCONTEXT__TARGET__persons();
						edge_explorer_8_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((PersonsSmartEMF.PersonRegister) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_MotherToFemale_CONTEXT__TARGET__persons().getEOpposite());
						edge_explorer_8 = new DeltaAwareEdgeExplorer(this, 6, 4, edge_explorer_8_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_MotherToFemale_CONTEXT__TARGET__persons());
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						...
						edge_explorer_9_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_MotherToFemale) o).getCREATE__SOURCE__f();
						edge_explorer_9_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesSmartEMF.Family) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_MotherToFemale_CREATE__SOURCE__f().getEOpposite());
						edge_explorer_9 = new DeltaAwareEdgeExplorer(this, 6, 1, edge_explorer_9_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_MotherToFemale_CREATE__SOURCE__f());
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						...
						edge_explorer_12 = new DeltaAwareEdgeExplorer(this, 3, 5, edge_explorer_12_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getFamilyMemberToPersonCorr_Target());
		name2explorer.put("edge_explorer_12", edge_explorer_12);
		nac = new NACQueryChecker(this, 0, "MotherToFemale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_141", name2actor.get("MotherToFemale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_141"), 2);
		...
		nac_1 = new NACQueryChecker(this, 2, "MotherToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_147", name2actor.get("MotherToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_147"), 2);
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		outer: switch(match.creator) {
			case "FamilyRegister_object_SP0": 
				{
					{
						// families
						var match_0 = new StatelessDeltaMatch(msg, "MotherToFemale__CONSISTENCY_159", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Family_object_SP10": 
				{
					{
						// f
						var match_1 = new StatelessDeltaMatch(msg, "MotherToFemale__CONSISTENCY_159", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP9": 
				{
					{
						// fm
						var match_2 = new StatelessDeltaMatch(msg, "MotherToFemale__CONSISTENCY_159", numberOfNodes, 3, UsingDeltaMode.CREATE);
				...
				{
					{
						...
						var match_3 = new StatelessDeltaMatch(msg, "MotherToFemale__CONSISTENCY_159", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP5": 
				{
					{
						// persons
						var match_4 = new StatelessDeltaMatch(msg, "MotherToFemale__CONSISTENCY_159", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Female_object_SP1": 
				{
					{
						// p
						var match_5 = new StatelessDeltaMatch(msg, "MotherToFemale__CONSISTENCY_159", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "ProtocolNode_MotherToFemale_object": 
				{
					{
						...
						var match_6 = new StatelessDeltaMatch(msg, "MotherToFemale__CONSISTENCY_159", numberOfNodes, 3, UsingDeltaMode.CREATE);
				...
				break;
			case "MotherToFemale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_141": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_0 = new StatelessDeltaMatch(msg, "MotherToFemale__CONSISTENCY_159", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "MotherToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_144": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_1 = new StatelessDeltaMatch(msg, "MotherToFemale__CONSISTENCY_159", numberOfNodes, 3, UsingDeltaMode.DELETE);
				...
				break;
			case "MotherToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_147": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_2 = new StatelessDeltaMatch(msg, "MotherToFemale__CONSISTENCY_159", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "FamilyMemberToPersonCorr_object_SP1": 
				{
					{
						// familyMember2Persons
						var match_3 = new StatelessDeltaMatch(msg, "MotherToFemale__CONSISTENCY_159", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_3.getNodes()[3] = objs[0];
						match_3.registerSignatureIndex(3);
						if(options.trackMatchingProcess)
			...
			case "PersonRegister_object_SP5": 
				{
					{
						// persons
						var match_4 = new StatelessDeltaMatch(msg, "MotherToFemale__CONSISTENCY_159", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_4.getNodes()[4] = objs[0];
						match_4.registerSignatureIndex(4);
						if(options.trackMatchingProcess)
			...
			case "Female_object_SP1": 
				{
					{
						// p
						var match_5 = new StatelessDeltaMatch(msg, "MotherToFemale__CONSISTENCY_159", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_5.getNodes()[5] = objs[0];
						match_5.registerSignatureIndex(5);
						if(options.trackMatchingProcess)
			...
			case "ProtocolNode_MotherToFemale_object": 
				{
					{
						// _eMoflon_ProtocolNode_
						var match_6 = new StatelessDeltaMatch(msg, "MotherToFemale__CONSISTENCY_159", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_6.getNodes()[6] = objs[0];
						match_6.registerSignatureIndex(6);
						if(options.trackMatchingProcess)
			...
			{
				{
					...
					var match = new StatelessDeltaMatch(msg, "MotherToFemale__CONSISTENCY_159", numberOfNodes, 3, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[6] = msg.source;
					objs[3] = msg.target;
					if(options.trackMatchingProcess)
	...
	protected void removeReference(ReferenceDeleted msg) {
			...
			case "FamiliesToPersonsIBeXTGG.ProtocolNode_MotherToFemale_CREATE__CORRESPONDENCE__familyMember2Persons_FamilyMemberToPersonCorr": 
		{
			...
			var match = new StatelessDeltaMatch(msg, "MotherToFemale__CONSISTENCY_159", numberOfNodes, 3, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[6] = msg.source;
			objs[3] = msg.target;
			if(options.trackMatchingProcess)
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof PersonsSmartEMF.Female) {
			var match_5 = new StatelessDeltaMatch(initialMessage, "MotherToFemale__CONSISTENCY_159", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_5.registerSignatureIndex(5);
		...
		if(obj instanceof FamiliesSmartEMF.Family) {
			var match_1 = new StatelessDeltaMatch(initialMessage, "MotherToFemale__CONSISTENCY_159", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_1.registerSignatureIndex(1);
			match_1.getNodes()[1] = obj;
			start(edge_explorer_6_2_orchestration, StatelessInputType.ATTRIBUTE, match_1);
		}
		if(obj instanceof FamiliesSmartEMF.FamilyMember) {
			var match_2 = new StatelessDeltaMatch(initialMessage, "MotherToFemale__CONSISTENCY_159", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_2.registerSignatureIndex(2);
