...
public class SonOfExistingFamilyToMale__CONSISTENCY_184 extends GenericStatelessSearchActor{
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		outer: switch(match.creator) {
			case "Family_object_SP4": 
				{
					{
						// f
						var match_0 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_184", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP4": 
				{
					{
						// fm
						var match_1 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_184", numberOfNodes, 3, UsingDeltaMode.CREATE);
				...
				{
					{
						...
						var match_2 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_184", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP1": 
				{
					{
						// persons
						var match_3 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_184", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Male_object_SP1": 
				{
					{
						// p
						var match_4 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_184", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "ProtocolNode_SonOfExistingFamilyToMale_object": 
				{
					{
						...
						var match_5 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_184", numberOfNodes, 3, UsingDeltaMode.CREATE);
				...
				break;
			case "SonOfExistingFamilyToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_167": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_0 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_184", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "SonOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_170": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_1 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_184", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "SonOfExistingFamilyToMale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_173": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_2 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_184", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "PersonRegister_object_SP1": 
				{
					{
						// persons
						var match_3 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_184", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_3.getNodes()[3] = objs[0];
						match_3.registerSignatureIndex(3);
						if(options.trackMatchingProcess)
			...
			case "Male_object_SP1": 
				{
					{
						// p
						var match_4 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_184", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_4.getNodes()[4] = objs[0];
						match_4.registerSignatureIndex(4);
						if(options.trackMatchingProcess)
			...
			case "ProtocolNode_SonOfExistingFamilyToMale_object": 
				{
					{
						// _eMoflon_ProtocolNode_
						var match_5 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_184", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_5.getNodes()[5] = objs[0];
						match_5.registerSignatureIndex(5);
						if(options.trackMatchingProcess)
