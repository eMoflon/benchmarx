...
public class DaughterOfExistingFamilyToFemale__CONSISTENCY_29 extends GenericStatelessSearchActor{
	...
	SearchOrchestration<StatelessExplorer> edge_explorer_11_1_orchestration;
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						...
						edge_explorer_4 = new DeltaAwareEdgeExplorer(this, 7, 0, edge_explorer_4_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_DaughterOfExistingFamilyToFemale_CONTEXT__SOURCE__f());
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						...
						edge_explorer_5_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_DaughterOfExistingFamilyToFemale) o).getCREATE__TARGET__p();
						edge_explorer_5_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((PersonsSmartEMF.Female) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_DaughterOfExistingFamilyToFemale_CREATE__TARGET__p().getEOpposite());
						edge_explorer_5 = new DeltaAwareEdgeExplorer(this, 7, 6, edge_explorer_5_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_DaughterOfExistingFamilyToFemale_CREATE__TARGET__p());
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						...
						edge_explorer_6 = new DeltaAwareEdgeExplorer(this, 0, 2, edge_explorer_6_methods, FamiliesSmartEMF.FamiliesSmartEMFPackage.eINSTANCE.getFamily_Daughters());
		name2explorer.put("edge_explorer_6", edge_explorer_6);
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.checkSourceType = (o) -> o instanceof FamiliesToPersonsIBeXTGG.ProtocolNode_DaughterOfExistingFamilyToFemale;
						edge_explorer_7_methods.checkTargetType = (o) -> o instanceof FamiliesSmartEMF.FamilyRegister;
						edge_explorer_7_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_DaughterOfExistingFamilyToFemale) o).getCONTEXT__SOURCE__families();
						edge_explorer_7_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesSmartEMF.FamilyRegister) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_DaughterOfExistingFamilyToFemale_CONTEXT__SOURCE__families().getEOpposite());
						edge_explorer_7 = new DeltaAwareEdgeExplorer(this, 7, 1, edge_explorer_7_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_DaughterOfExistingFamilyToFemale_CONTEXT__SOURCE__families());
		name2explorer.put("edge_explorer_7", edge_explorer_7);
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.checkSourceType = (o) -> o instanceof FamiliesToPersonsIBeXTGG.ProtocolNode_DaughterOfExistingFamilyToFemale;
						edge_explorer_8_methods.checkTargetType = (o) -> o instanceof FamiliesToPersonsIBeXTGG.RegisterToRegisterCorr;
						edge_explorer_8_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_DaughterOfExistingFamilyToFemale) o).getCONTEXT__CORRESPONDENCE__families2persons();
						edge_explorer_8_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesToPersonsIBeXTGG.RegisterToRegisterCorr) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_DaughterOfExistingFamilyToFemale_CONTEXT__CORRESPONDENCE__families2persons().getEOpposite());
						edge_explorer_8 = new DeltaAwareEdgeExplorer(this, 7, 3, edge_explorer_8_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_DaughterOfExistingFamilyToFemale_CONTEXT__CORRESPONDENCE__families2persons());
		name2explorer.put("edge_explorer_8", edge_explorer_8);
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.checkSourceType = (o) -> o instanceof FamiliesSmartEMF.FamilyRegister;
						edge_explorer_9_methods.checkTargetType = (o) -> o instanceof FamiliesSmartEMF.Family;
						edge_explorer_9_methods.multi_lookup = (o) -> ((FamiliesSmartEMF.FamilyRegister) o).getFamilies();
						edge_explorer_9_methods.unique_opposite_lookup = (o) -> ((FamiliesSmartEMF.Family) o).getFamiliesInverse();
						edge_explorer_9 = new DeltaAwareEdgeExplorer(this, 1, 0, edge_explorer_9_methods, FamiliesSmartEMF.FamiliesSmartEMFPackage.eINSTANCE.getFamilyRegister_Families());
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						...
						edge_explorer_10_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_DaughterOfExistingFamilyToFemale) o).getCREATE__SOURCE__fm();
						edge_explorer_10_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesSmartEMF.FamilyMember) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_DaughterOfExistingFamilyToFemale_CREATE__SOURCE__fm().getEOpposite());
						edge_explorer_10 = new DeltaAwareEdgeExplorer(this, 7, 2, edge_explorer_10_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_DaughterOfExistingFamilyToFemale_CREATE__SOURCE__fm());
		name2explorer.put("edge_explorer_10", edge_explorer_10);
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.checkSourceType = (o) -> o instanceof PersonsSmartEMF.PersonRegister;
						edge_explorer_11_methods.checkTargetType = (o) -> o instanceof PersonsSmartEMF.Female;
						edge_explorer_11_methods.multi_lookup = (o) -> ((PersonsSmartEMF.PersonRegister) o).getPersons().stream().filter(obj -> obj instanceof PersonsSmartEMF.Female).collect(Collectors.toList());
						edge_explorer_11_methods.unique_opposite_lookup = (o) -> ((PersonsSmartEMF.Person) o).getPersonsInverse();
						edge_explorer_11 = new DeltaAwareEdgeExplorer(this, 5, 6, edge_explorer_11_methods, PersonsSmartEMF.PersonsSmartEMFPackage.eINSTANCE.getPersonRegister_Persons());
		name2explorer.put("edge_explorer_11", edge_explorer_11);
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.checkSourceType = (o) -> o instanceof FamiliesToPersonsIBeXTGG.ProtocolNode_DaughterOfExistingFamilyToFemale;
						edge_explorer_12_methods.checkTargetType = (o) -> o instanceof PersonsSmartEMF.PersonRegister;
						edge_explorer_12_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_DaughterOfExistingFamilyToFemale) o).getCONTEXT__TARGET__persons();
						edge_explorer_12_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((PersonsSmartEMF.PersonRegister) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_DaughterOfExistingFamilyToFemale_CONTEXT__TARGET__persons().getEOpposite());
						edge_explorer_12 = new DeltaAwareEdgeExplorer(this, 7, 5, edge_explorer_12_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_DaughterOfExistingFamilyToFemale_CONTEXT__TARGET__persons());
		name2explorer.put("edge_explorer_12", edge_explorer_12);
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.checkSourceType = (o) -> o instanceof FamiliesToPersonsIBeXTGG.RegisterToRegisterCorr;
						edge_explorer_13_methods.checkTargetType = (o) -> o instanceof PersonsSmartEMF.PersonRegister;
						edge_explorer_13_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.RegisterToRegisterCorr) o).getTarget();
						edge_explorer_13_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((PersonsSmartEMF.PersonRegister) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getRegisterToRegisterCorr_Target().getEOpposite());
						edge_explorer_13 = new DeltaAwareEdgeExplorer(this, 3, 5, edge_explorer_13_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getRegisterToRegisterCorr_Target());
		name2explorer.put("edge_explorer_13", edge_explorer_13);
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.checkSourceType = (o) -> o instanceof FamiliesToPersonsIBeXTGG.FamilyMemberToPersonCorr;
						edge_explorer_14_methods.checkTargetType = (o) -> o instanceof FamiliesSmartEMF.FamilyMember;
						edge_explorer_14_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.FamilyMemberToPersonCorr) o).getSource();
						edge_explorer_14_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesSmartEMF.FamilyMember) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getFamilyMemberToPersonCorr_Source().getEOpposite());
						edge_explorer_14 = new DeltaAwareEdgeExplorer(this, 4, 2, edge_explorer_14_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getFamilyMemberToPersonCorr_Source());
		name2explorer.put("edge_explorer_14", edge_explorer_14);
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.checkSourceType = (o) -> o instanceof FamiliesToPersonsIBeXTGG.ProtocolNode_DaughterOfExistingFamilyToFemale;
						edge_explorer_15_methods.checkTargetType = (o) -> o instanceof FamiliesToPersonsIBeXTGG.FamilyMemberToPersonCorr;
						edge_explorer_15_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_DaughterOfExistingFamilyToFemale) o).getCREATE__CORRESPONDENCE__familyMember2Persons();
						edge_explorer_15_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesToPersonsIBeXTGG.FamilyMemberToPersonCorr) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_DaughterOfExistingFamilyToFemale_CREATE__CORRESPONDENCE__familyMember2Persons().getEOpposite());
						edge_explorer_15 = new DeltaAwareEdgeExplorer(this, 7, 4, edge_explorer_15_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_DaughterOfExistingFamilyToFemale_CREATE__CORRESPONDENCE__familyMember2Persons());
		name2explorer.put("edge_explorer_15", edge_explorer_15);
		nac = new NACQueryChecker(this, 0, "DaughterOfExistingFamilyToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_8", name2actor.get("DaughterOfExistingFamilyToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_8"), 2);
		name2explorer.put("nac", nac);
		nac_0 = new NACQueryChecker(this, 1, "DaughterOfExistingFamilyToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_11", name2actor.get("DaughterOfExistingFamilyToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_11"), 2);
		name2explorer.put("nac_0", nac_0);
		nac_1 = new NACQueryChecker(this, 2, "DaughterOfExistingFamilyToFemale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_14", name2actor.get("DaughterOfExistingFamilyToFemale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_14"), 2);
		name2explorer.put("nac_1", nac_1);
		disjoint_explorer_6 = new DisjointExplorer(this, observedResources, 7, (o) -> o instanceof FamiliesToPersonsIBeXTGG.ProtocolNode_DaughterOfExistingFamilyToFemale, true);
	...
	protected void initializeOrchestration() {
		...
		edge_explorer_11_1_orchestration.setFieldSetter(x -> edge_explorer_11_1_orchestration = (SearchOrchestration) x);
		edge_explorer_11_1_orchestration.setFieldGetter(() -> edge_explorer_11_1_orchestration);
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		outer: switch(match.creator) {
			case "Family_object_SP7": 
				{
					if(!lazy_initialization) {
						{
							// f
							var match_0 = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__CONSISTENCY_29", numberOfNodes, 3, UsingDeltaMode.CREATE);
							match_0.getNodes()[0] = objs[0];
							match_0.registerSignatureIndex(0);
							if(options.trackMatchingProcess)
								match_0.registerDelta(UsingDeltaMode.CREATE, objs[0]);
							start(edge_explorer_4_2_orchestration, StatelessInputType.OBJECT, match_0);
						}
					}
				}
				break;
			case "FamilyRegister_object_SP4": 
				{
					if(!lazy_initialization) {
						{
							// families
							var match_1 = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__CONSISTENCY_29", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP4": 
				{
					if(!lazy_initialization) {
						{
							// fm
							var match_2 = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__CONSISTENCY_29", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "RegisterToRegisterCorr_object_SP2": 
				{
					if(!lazy_initialization) {
						{
							// families2persons
							var match_3 = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__CONSISTENCY_29", numberOfNodes, 3, UsingDeltaMode.CREATE);
					...
					if(!lazy_initialization) {
						{
							...
							var match_4 = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__CONSISTENCY_29", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP2": 
				{
					if(!lazy_initialization) {
						{
							// persons
							var match_5 = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__CONSISTENCY_29", numberOfNodes, 3, UsingDeltaMode.CREATE);
							match_5.getNodes()[5] = objs[0];
							match_5.registerSignatureIndex(5);
							if(options.trackMatchingProcess)
								match_5.registerDelta(UsingDeltaMode.CREATE, objs[0]);
							start(edge_explorer_11_1_orchestration, StatelessInputType.OBJECT, match_5);
						}
					}
				}
				break;
			case "Female_object_SP1": 
				{
					if(!lazy_initialization) {
						{
							// p
							var match_6 = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__CONSISTENCY_29", numberOfNodes, 3, UsingDeltaMode.CREATE);
							match_6.getNodes()[6] = objs[0];
							match_6.registerSignatureIndex(6);
							if(options.trackMatchingProcess)
								match_6.registerDelta(UsingDeltaMode.CREATE, objs[0]);
							start(edge_explorer_3_2_orchestration, StatelessInputType.OBJECT, match_6);
						}
					}
				}
				break;
				...
				{
					{
						...
						var match_7 = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__CONSISTENCY_29", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "DaughterOfExistingFamilyToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_8": 
				{
					if(!lazy_initialization) {
						...
						{
							var match_0 = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__CONSISTENCY_29", numberOfNodes, 3, UsingDeltaMode.DELETE);
				...
				break;
			case "DaughterOfExistingFamilyToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_11": 
				{
					if(!lazy_initialization) {
						var inputMatch = (StatelessDeltaMatch) match;
						{
							var match_1 = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__CONSISTENCY_29", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "DaughterOfExistingFamilyToFemale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_14": 
				{
					if(!lazy_initialization) {
						var inputMatch = (StatelessDeltaMatch) match;
						{
							var match_2 = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__CONSISTENCY_29", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "RegisterToRegisterCorr_object_SP2": 
				{
					{
						// families2persons
						var match_3 = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__CONSISTENCY_29", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_3.getNodes()[3] = objs[0];
						match_3.registerSignatureIndex(3);
						if(options.trackMatchingProcess)
			...
			case "FamilyMemberToPersonCorr_object_SP0": 
				{
					{
						// familyMember2Persons
						var match_4 = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__CONSISTENCY_29", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_4.getNodes()[4] = objs[0];
						match_4.registerSignatureIndex(4);
						if(options.trackMatchingProcess)
			...
			case "PersonRegister_object_SP2": 
				{
					{
						// persons
						var match_5 = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__CONSISTENCY_29", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_5.getNodes()[5] = objs[0];
						match_5.registerSignatureIndex(5);
						if(options.trackMatchingProcess)
			...
			case "Female_object_SP1": 
				{
					{
						// p
						var match_6 = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__CONSISTENCY_29", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_6.getNodes()[6] = objs[0];
						match_6.registerSignatureIndex(6);
						if(options.trackMatchingProcess)
			...
			case "ProtocolNode_DaughterOfExistingFamilyToFemale_object": 
				{
					{
						// _eMoflon_ProtocolNode_
						var match_7 = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__CONSISTENCY_29", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_7.getNodes()[7] = objs[0];
						match_7.registerSignatureIndex(7);
						if(options.trackMatchingProcess)
	...
	protected void addReference(ReferenceAdded msg) {
			...
			{
				{
					...
					var match = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__CONSISTENCY_29", numberOfNodes, 3, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[1] = msg.target;
					if(options.trackMatchingProcess)
		...
		case "FamiliesSmartEMF.Family_daughters_FamilyMember": 
			...
			break;
		case "FamiliesToPersonsIBeXTGG.ProtocolNode_DaughterOfExistingFamilyToFemale_CONTEXT__SOURCE__families_FamilyRegister": 
			{
				{
					if(notificationIndex.isNew(msg.source) || notificationIndex.isNew(msg.target))
						break;
			...
			break;
		case "FamiliesToPersonsIBeXTGG.ProtocolNode_DaughterOfExistingFamilyToFemale_CONTEXT__CORRESPONDENCE__families2persons_RegisterToRegisterCorr": 
			{
				{
					if(notificationIndex.isNew(msg.source) || notificationIndex.isNew(msg.target))
						break;
	...
	protected void removeReference(ReferenceDeleted msg) {
			...
			case "FamiliesToPersonsIBeXTGG.RegisterToRegisterCorr_source_FamilyRegister": 
		{
			...
			var match = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__CONSISTENCY_29", numberOfNodes, 3, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[3] = msg.source;
			objs[1] = msg.target;
			if(options.trackMatchingProcess)
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof PersonsSmartEMF.Female) {
			var match_6 = new StatelessDeltaMatch(initialMessage, "DaughterOfExistingFamilyToFemale__CONSISTENCY_29", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_6.registerSignatureIndex(6);
			match_6.getNodes()[6] = obj;
			start(edge_explorer_3_2_orchestration, StatelessInputType.ATTRIBUTE, match_6);
		}
		if(obj instanceof FamiliesSmartEMF.Family) {
			var match_0 = new StatelessDeltaMatch(initialMessage, "DaughterOfExistingFamilyToFemale__CONSISTENCY_29", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_0.registerSignatureIndex(0);
			match_0.getNodes()[0] = obj;
			start(edge_explorer_4_2_orchestration, StatelessInputType.ATTRIBUTE, match_0);
		}
		if(obj instanceof FamiliesSmartEMF.FamilyMember) {
			var match_2 = new StatelessDeltaMatch(initialMessage, "DaughterOfExistingFamilyToFemale__CONSISTENCY_29", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_2.registerSignatureIndex(2);
	...
	private boolean constraint_checker_method(String f_name, String fm_name, String p_name) {
		org.emoflon.ibex.tgg.runtime.csp.constraints.Concat csp_0 = new org.emoflon.ibex.tgg.runtime.csp.constraints.Concat();
		csp_0.getVariables().add(new org.emoflon.ibex.tgg.runtime.csp.RuntimeTGGAttributeConstraintVariable(true, ", ", "java.lang.String"));
		csp_0.getVariables().add(new org.emoflon.ibex.tgg.runtime.csp.RuntimeTGGAttributeConstraintVariable(true, f_name, "java.lang.String"));
		csp_0.getVariables().add(new org.emoflon.ibex.tgg.runtime.csp.RuntimeTGGAttributeConstraintVariable(true, fm_name, "java.lang.String"));
		csp_0.getVariables().add(new org.emoflon.ibex.tgg.runtime.csp.RuntimeTGGAttributeConstraintVariable(true, p_name, "java.lang.String"));
		csp_0.solve();
