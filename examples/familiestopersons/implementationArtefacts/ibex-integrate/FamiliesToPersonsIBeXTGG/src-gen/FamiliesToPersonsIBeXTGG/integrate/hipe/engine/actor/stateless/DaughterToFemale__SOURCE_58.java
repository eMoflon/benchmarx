...
public class DaughterToFemale__SOURCE_58 extends GenericStatelessSearchActor{
			...
			case "FamilyRegister_object_SP4": 
				{
					{
						// families
						var match_0 = new StatelessDeltaMatch(msg, "DaughterToFemale__SOURCE_58", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Family_object_SP12": 
				{
					{
						// f
						var match_1 = new StatelessDeltaMatch(msg, "DaughterToFemale__SOURCE_58", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP7": 
				{
					{
						// fm
						var match_2 = new StatelessDeltaMatch(msg, "DaughterToFemale__SOURCE_58", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "DaughterToFemale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_49": 
				{
					...
					{
						var match_0 = new StatelessDeltaMatch(msg, "DaughterToFemale__SOURCE_58", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "DaughterToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_52": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_1 = new StatelessDeltaMatch(msg, "DaughterToFemale__SOURCE_58", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "DaughterToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_55": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_2 = new StatelessDeltaMatch(msg, "DaughterToFemale__SOURCE_58", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			{
				{
					...
					var match = new StatelessDeltaMatch(msg, "DaughterToFemale__SOURCE_58", numberOfNodes, 3, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[2] = msg.target;
					if(options.trackMatchingProcess)
	...
	protected void removeReference(ReferenceDeleted msg) {
			...
			case "FamiliesSmartEMF.Family_daughters_FamilyMember": 
		{
			...
			var match = new StatelessDeltaMatch(msg, "DaughterToFemale__SOURCE_58", numberOfNodes, 3, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[1] = msg.source;
			objs[2] = msg.target;
			if(options.trackMatchingProcess)
