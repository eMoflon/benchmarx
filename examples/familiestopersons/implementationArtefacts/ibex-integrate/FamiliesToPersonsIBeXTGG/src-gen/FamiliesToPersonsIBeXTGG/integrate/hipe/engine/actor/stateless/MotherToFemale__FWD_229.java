...
public class MotherToFemale__FWD_229 extends GenericStatelessSearchActor{
			...
			case "FamilyRegister_object_SP5": 
				{
					{
						// families
						var match_0 = new StatelessDeltaMatch(msg, "MotherToFemale__FWD_229", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Family_object_SP14": 
				{
					{
						// f
						var match_1 = new StatelessDeltaMatch(msg, "MotherToFemale__FWD_229", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP11": 
				{
					{
						// fm
						var match_2 = new StatelessDeltaMatch(msg, "MotherToFemale__FWD_229", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP8": 
				{
					{
						// persons
						var match_3 = new StatelessDeltaMatch(msg, "MotherToFemale__FWD_229", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "MotherToFemale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_213": 
				{
					...
					{
						var match_0 = new StatelessDeltaMatch(msg, "MotherToFemale__FWD_229", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "MotherToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_216": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_1 = new StatelessDeltaMatch(msg, "MotherToFemale__FWD_229", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "MotherToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_219": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_2 = new StatelessDeltaMatch(msg, "MotherToFemale__FWD_229", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "PersonRegister_object_SP8": 
				{
					{
						// persons
						var match_3 = new StatelessDeltaMatch(msg, "MotherToFemale__FWD_229", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_3.getNodes()[3] = objs[0];
						match_3.registerSignatureIndex(3);
						if(options.trackMatchingProcess)
			...
			{
				{
					...
					var match = new StatelessDeltaMatch(msg, "MotherToFemale__FWD_229", numberOfNodes, 3, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[2] = msg.target;
					if(options.trackMatchingProcess)
	...
	protected void removeReference(ReferenceDeleted msg) {
			...
			case "FamiliesSmartEMF.Family_mother_FamilyMember": 
		{
			...
			var match = new StatelessDeltaMatch(msg, "MotherToFemale__FWD_229", numberOfNodes, 3, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[1] = msg.source;
			objs[2] = msg.target;
			if(options.trackMatchingProcess)
