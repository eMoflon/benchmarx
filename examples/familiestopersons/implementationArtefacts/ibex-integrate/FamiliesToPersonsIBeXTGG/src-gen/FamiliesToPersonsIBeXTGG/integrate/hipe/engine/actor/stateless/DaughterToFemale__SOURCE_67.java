...
public class DaughterToFemale__SOURCE_67 extends GenericStatelessSearchActor{
			...
			case "FamilyRegister_object_SP9": 
				{
					if(!lazy_initialization) {
						{
							// families
							var match_0 = new StatelessDeltaMatch(msg, "DaughterToFemale__SOURCE_67", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Family_object_SP12": 
				{
					{
						// f
						var match_1 = new StatelessDeltaMatch(msg, "DaughterToFemale__SOURCE_67", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP7": 
				{
					if(!lazy_initialization) {
						{
							// fm
							var match_2 = new StatelessDeltaMatch(msg, "DaughterToFemale__SOURCE_67", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "DaughterToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_58": 
				{
					if(!lazy_initialization) {
						...
						{
							var match_0 = new StatelessDeltaMatch(msg, "DaughterToFemale__SOURCE_67", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "DaughterToFemale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_61": 
				{
					if(!lazy_initialization) {
						var inputMatch = (StatelessDeltaMatch) match;
						{
							var match_1 = new StatelessDeltaMatch(msg, "DaughterToFemale__SOURCE_67", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "DaughterToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_64": 
				{
					if(!lazy_initialization) {
						var inputMatch = (StatelessDeltaMatch) match;
						{
							var match_2 = new StatelessDeltaMatch(msg, "DaughterToFemale__SOURCE_67", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			{
				{
					...
					var match = new StatelessDeltaMatch(msg, "DaughterToFemale__SOURCE_67", numberOfNodes, 3, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					if(options.trackMatchingProcess)
	...
	protected void removeReference(ReferenceDeleted msg) {
			...
			case "FamiliesSmartEMF.FamilyRegister_families_Family": 
		{
			...
			var match = new StatelessDeltaMatch(msg, "DaughterToFemale__SOURCE_67", numberOfNodes, 3, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[0] = msg.source;
			objs[1] = msg.target;
			if(options.trackMatchingProcess)
