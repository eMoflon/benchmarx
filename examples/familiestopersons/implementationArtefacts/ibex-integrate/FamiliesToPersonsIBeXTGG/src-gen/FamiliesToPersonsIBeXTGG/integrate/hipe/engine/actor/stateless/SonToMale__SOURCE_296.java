...
public class SonToMale__SOURCE_296 extends GenericStatelessSearchActor{
			...
			case "FamilyRegister_object_SP2": 
				{
					{
						// families
						var match_0 = new StatelessDeltaMatch(msg, "SonToMale__SOURCE_296", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Family_object_SP9": 
				{
					{
						// f
						var match_1 = new StatelessDeltaMatch(msg, "SonToMale__SOURCE_296", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP7": 
				{
					{
						// fm
						var match_2 = new StatelessDeltaMatch(msg, "SonToMale__SOURCE_296", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "SonToMale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_287": 
				{
					...
					{
						var match_0 = new StatelessDeltaMatch(msg, "SonToMale__SOURCE_296", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "SonToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_290": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_1 = new StatelessDeltaMatch(msg, "SonToMale__SOURCE_296", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "SonToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_293": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_2 = new StatelessDeltaMatch(msg, "SonToMale__SOURCE_296", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			{
				{
					...
					var match = new StatelessDeltaMatch(msg, "SonToMale__SOURCE_296", numberOfNodes, 3, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					if(options.trackMatchingProcess)
	...
	protected void removeReference(ReferenceDeleted msg) {
			...
			case "FamiliesSmartEMF.FamilyRegister_families_Family": 
		{
			...
			var match = new StatelessDeltaMatch(msg, "SonToMale__SOURCE_296", numberOfNodes, 3, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[0] = msg.source;
			objs[1] = msg.target;
			if(options.trackMatchingProcess)
