...
public class SonToMale__SOURCE_344 extends GenericStatelessSearchActor{
			...
			case "FamilyRegister_object_SP7": 
				{
					if(!lazy_initialization) {
						{
							// families
							var match_0 = new StatelessDeltaMatch(msg, "SonToMale__SOURCE_344", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Family_object_SP9": 
				{
					{
						// f
						var match_1 = new StatelessDeltaMatch(msg, "SonToMale__SOURCE_344", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP7": 
				{
					if(!lazy_initialization) {
						{
							// fm
							var match_2 = new StatelessDeltaMatch(msg, "SonToMale__SOURCE_344", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "SonToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_335": 
				{
					if(!lazy_initialization) {
						...
						{
							var match_0 = new StatelessDeltaMatch(msg, "SonToMale__SOURCE_344", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "SonToMale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_338": 
				{
					if(!lazy_initialization) {
						var inputMatch = (StatelessDeltaMatch) match;
						{
							var match_1 = new StatelessDeltaMatch(msg, "SonToMale__SOURCE_344", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "SonToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_341": 
				{
					if(!lazy_initialization) {
						var inputMatch = (StatelessDeltaMatch) match;
						{
							var match_2 = new StatelessDeltaMatch(msg, "SonToMale__SOURCE_344", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			{
				{
					...
					var match = new StatelessDeltaMatch(msg, "SonToMale__SOURCE_344", numberOfNodes, 3, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[2] = msg.target;
					if(options.trackMatchingProcess)
	...
	protected void removeReference(ReferenceDeleted msg) {
			...
			case "FamiliesSmartEMF.Family_sons_FamilyMember": 
		{
			...
			var match = new StatelessDeltaMatch(msg, "SonToMale__SOURCE_344", numberOfNodes, 3, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[1] = msg.source;
			objs[2] = msg.target;
			if(options.trackMatchingProcess)
