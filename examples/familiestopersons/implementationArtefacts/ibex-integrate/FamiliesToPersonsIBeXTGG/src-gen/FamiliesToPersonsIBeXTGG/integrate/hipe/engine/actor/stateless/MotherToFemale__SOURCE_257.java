...
public class MotherToFemale__SOURCE_257 extends GenericStatelessSearchActor{
			...
			case "FamilyRegister_object_SP9": 
				{
					if(!lazy_initialization) {
						{
							// families
							var match_0 = new StatelessDeltaMatch(msg, "MotherToFemale__SOURCE_257", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Family_object_SP10": 
				{
					{
						// f
						var match_1 = new StatelessDeltaMatch(msg, "MotherToFemale__SOURCE_257", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP7": 
				{
					if(!lazy_initialization) {
						{
							// fm
							var match_2 = new StatelessDeltaMatch(msg, "MotherToFemale__SOURCE_257", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "MotherToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_248": 
				{
					if(!lazy_initialization) {
						...
						{
							var match_0 = new StatelessDeltaMatch(msg, "MotherToFemale__SOURCE_257", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "MotherToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_251": 
				{
					if(!lazy_initialization) {
						var inputMatch = (StatelessDeltaMatch) match;
						{
							var match_1 = new StatelessDeltaMatch(msg, "MotherToFemale__SOURCE_257", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "MotherToFemale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_254": 
				{
					if(!lazy_initialization) {
						var inputMatch = (StatelessDeltaMatch) match;
						{
							var match_2 = new StatelessDeltaMatch(msg, "MotherToFemale__SOURCE_257", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			{
				{
					...
					var match = new StatelessDeltaMatch(msg, "MotherToFemale__SOURCE_257", numberOfNodes, 3, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					if(options.trackMatchingProcess)
	...
	protected void removeReference(ReferenceDeleted msg) {
			...
			case "FamiliesSmartEMF.FamilyRegister_families_Family": 
		{
			...
			var match = new StatelessDeltaMatch(msg, "MotherToFemale__SOURCE_257", numberOfNodes, 3, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[0] = msg.source;
			objs[1] = msg.target;
			if(options.trackMatchingProcess)
