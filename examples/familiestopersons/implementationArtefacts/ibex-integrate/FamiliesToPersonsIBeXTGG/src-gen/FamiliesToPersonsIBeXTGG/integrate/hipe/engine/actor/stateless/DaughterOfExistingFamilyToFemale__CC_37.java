...
public class DaughterOfExistingFamilyToFemale__CC_37 extends GenericStatelessSearchActor{
			...
			case "Family_object_SP10": 
				{
					{
						// f
						var match_0 = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__CC_37", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP5": 
				{
					{
						// fm
						var match_1 = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__CC_37", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP3": 
				{
					{
						// persons
						var match_2 = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__CC_37", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Female_object_SP2": 
				{
					{
						// p
						var match_3 = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__CC_37", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "DaughterOfExistingFamilyToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_14": 
				{
					...
					{
						var match_0 = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__CC_37", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "DaughterOfExistingFamilyToFemale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_17": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_1 = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__CC_37", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "DaughterOfExistingFamilyToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_20": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_2 = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__CC_37", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "Female_object_SP2": 
				{
					{
						// p
						var match_3 = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__CC_37", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_3.getNodes()[3] = objs[0];
						match_3.registerSignatureIndex(3);
						if(options.trackMatchingProcess)
		...
		case "PersonsSmartEMF.PersonRegister_persons_Person": 
			{
				if(msg.target instanceof PersonsSmartEMF.Female) 
				{
					...
					var match = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__CC_37", numberOfNodes, 3, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[3] = msg.target;
					if(options.trackMatchingProcess)
	...
	protected void removeReference(ReferenceDeleted msg) {
		...
		if(msg.target instanceof PersonsSmartEMF.Female) 
		{
			...
			var match = new StatelessDeltaMatch(msg, "DaughterOfExistingFamilyToFemale__CC_37", numberOfNodes, 3, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[2] = msg.source;
			objs[3] = msg.target;
			if(options.trackMatchingProcess)
