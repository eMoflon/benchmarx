...
public class Families2Persons__FWD_105 extends GenericStatelessSearchActor{
			...
			case "FamilyRegister_object_SP3": 
				{
					{
						// families
						var match_0 = new StatelessDeltaMatch(msg, "Families2Persons__FWD_105", numberOfNodes, 0, UsingDeltaMode.CREATE);
			...
			case "FamilyRegister_object_SP3": 
				{
					{
						// families
						var match_0 = new StatelessDeltaMatch(msg, "Families2Persons__FWD_105", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_0.getNodes()[0] = objs[0];
						match_0.registerSignatureIndex(0);
						if(options.trackMatchingProcess)
