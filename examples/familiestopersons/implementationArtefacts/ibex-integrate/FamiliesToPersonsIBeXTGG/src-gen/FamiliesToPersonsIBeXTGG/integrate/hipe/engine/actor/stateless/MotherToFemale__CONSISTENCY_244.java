...
public class MotherToFemale__CONSISTENCY_244 extends GenericStatelessSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						...
						edge_explorer_6 = new DeltaAwareEdgeExplorer(this, 6, 3, edge_explorer_6_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_MotherToFemale_CREATE__CORRESPONDENCE__familyMember2Persons());
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						...
						edge_explorer_9_methods.unique_lookup = (o) -> ((FamiliesSmartEMF.Family) o).getMother();
						edge_explorer_9_methods.unique_opposite_lookup = (o) -> ((FamiliesSmartEMF.FamilyMember) o).getMotherInverse();
						edge_explorer_9 = new DeltaAwareEdgeExplorer(this, 1, 2, edge_explorer_9_methods, FamiliesSmartEMF.FamiliesSmartEMFPackage.eINSTANCE.getFamily_Mother());
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						...
						edge_explorer_11_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_MotherToFemale) o).getCONTEXT__SOURCE__families();
						edge_explorer_11_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesSmartEMF.FamilyRegister) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_MotherToFemale_CONTEXT__SOURCE__families().getEOpposite());
						edge_explorer_11 = new DeltaAwareEdgeExplorer(this, 6, 0, edge_explorer_11_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_MotherToFemale_CONTEXT__SOURCE__families());
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						...
						edge_explorer_12 = new DeltaAwareEdgeExplorer(this, 6, 2, edge_explorer_12_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_MotherToFemale_CREATE__SOURCE__fm());
			...
			case "FamilyRegister_object_SP1": 
				{
					{
						// families
						var match_0 = new StatelessDeltaMatch(msg, "MotherToFemale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Family_object_SP0": 
				{
					{
						// f
						var match_1 = new StatelessDeltaMatch(msg, "MotherToFemale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP13": 
				{
					{
						// fm
						var match_2 = new StatelessDeltaMatch(msg, "MotherToFemale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.CREATE);
				...
				{
					{
						...
						var match_3 = new StatelessDeltaMatch(msg, "MotherToFemale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP0": 
				{
					{
						// persons
						var match_4 = new StatelessDeltaMatch(msg, "MotherToFemale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Female_object_SP3": 
				{
					{
						// p
						var match_5 = new StatelessDeltaMatch(msg, "MotherToFemale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.CREATE);
				...
				{
					{
						...
						var match_6 = new StatelessDeltaMatch(msg, "MotherToFemale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "MotherToFemale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_213": 
				{
					...
					{
						var match_0 = new StatelessDeltaMatch(msg, "MotherToFemale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "MotherToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_216": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_1 = new StatelessDeltaMatch(msg, "MotherToFemale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "MotherToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_219": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_2 = new StatelessDeltaMatch(msg, "MotherToFemale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "FamilyMemberToPersonCorr_object_SP1": 
				{
					{
						// familyMember2Persons
						var match_3 = new StatelessDeltaMatch(msg, "MotherToFemale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_3.getNodes()[3] = objs[0];
						match_3.registerSignatureIndex(3);
						if(options.trackMatchingProcess)
			...
			case "PersonRegister_object_SP0": 
				{
					{
						// persons
						var match_4 = new StatelessDeltaMatch(msg, "MotherToFemale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_4.getNodes()[4] = objs[0];
						match_4.registerSignatureIndex(4);
						if(options.trackMatchingProcess)
			...
			case "Female_object_SP3": 
				{
					{
						// p
						var match_5 = new StatelessDeltaMatch(msg, "MotherToFemale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_5.getNodes()[5] = objs[0];
						match_5.registerSignatureIndex(5);
						if(options.trackMatchingProcess)
			...
			case "ProtocolNode_MotherToFemale_object": 
				{
					{
						// _eMoflon_ProtocolNode_
						var match_6 = new StatelessDeltaMatch(msg, "MotherToFemale__CONSISTENCY_244", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_6.getNodes()[6] = objs[0];
						match_6.registerSignatureIndex(6);
						if(options.trackMatchingProcess)
