...
public class CreateFamily__FWD_4 extends GenericStatelessSearchActor{
			...
			case "Family_object_SP1": 
				{
					{
						// family
						var match_1 = new StatelessDeltaMatch(msg, "CreateFamily__FWD_4", numberOfNodes, 0, UsingDeltaMode.CREATE);
			...
			case "FamilyRegister_object_SP1": 
				{
					{
						// families
						var match_0 = new StatelessDeltaMatch(msg, "CreateFamily__FWD_4", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_0.getNodes()[0] = objs[0];
						match_0.registerSignatureIndex(0);
						if(options.trackMatchingProcess)
			...
			case "Family_object_SP1": 
				{
					{
						// family
						var match_1 = new StatelessDeltaMatch(msg, "CreateFamily__FWD_4", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_1.getNodes()[1] = objs[0];
						match_1.registerSignatureIndex(1);
						if(options.trackMatchingProcess)
			...
			{
				{
					...
					var match = new StatelessDeltaMatch(msg, "CreateFamily__FWD_4", numberOfNodes, 0, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					if(options.trackMatchingProcess)
	...
	protected void removeReference(ReferenceDeleted msg) {
			...
			case "FamiliesSmartEMF.FamilyRegister_families_Family": 
		{
			...
			var match = new StatelessDeltaMatch(msg, "CreateFamily__FWD_4", numberOfNodes, 0, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[0] = msg.source;
			objs[1] = msg.target;
			if(options.trackMatchingProcess)
