...
public class FatherToMale__FWD_177 extends GenericStatelessSearchActor{
			...
			case "FamilyRegister_object_SP0": 
				{
					if(!lazy_initialization) {
						{
							// families
							var match_0 = new StatelessDeltaMatch(msg, "FatherToMale__FWD_177", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Family_object_SP15": 
				{
					{
						// f
						var match_1 = new StatelessDeltaMatch(msg, "FatherToMale__FWD_177", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP11": 
				{
					if(!lazy_initialization) {
						{
							// fm
							var match_2 = new StatelessDeltaMatch(msg, "FatherToMale__FWD_177", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "RegisterToRegisterCorr_object_SP4": 
				{
					if(!lazy_initialization) {
						{
							// families2persons
							var match_3 = new StatelessDeltaMatch(msg, "FatherToMale__FWD_177", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP9": 
				{
					if(!lazy_initialization) {
						{
							// persons
							var match_4 = new StatelessDeltaMatch(msg, "FatherToMale__FWD_177", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FatherToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_161": 
				{
					if(!lazy_initialization) {
						...
						{
							var match_0 = new StatelessDeltaMatch(msg, "FatherToMale__FWD_177", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "FatherToMale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_164": 
				{
					if(!lazy_initialization) {
						var inputMatch = (StatelessDeltaMatch) match;
						{
							var match_1 = new StatelessDeltaMatch(msg, "FatherToMale__FWD_177", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "FatherToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_167": 
				{
					if(!lazy_initialization) {
						var inputMatch = (StatelessDeltaMatch) match;
						{
							var match_2 = new StatelessDeltaMatch(msg, "FatherToMale__FWD_177", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "RegisterToRegisterCorr_object_SP4": 
				{
					{
						// families2persons
						var match_3 = new StatelessDeltaMatch(msg, "FatherToMale__FWD_177", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_3.getNodes()[3] = objs[0];
						match_3.registerSignatureIndex(3);
						if(options.trackMatchingProcess)
			...
			case "PersonRegister_object_SP9": 
				{
					{
						// persons
						var match_4 = new StatelessDeltaMatch(msg, "FatherToMale__FWD_177", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_4.getNodes()[4] = objs[0];
						match_4.registerSignatureIndex(4);
						if(options.trackMatchingProcess)
			...
			{
				{
					...
					var match = new StatelessDeltaMatch(msg, "FatherToMale__FWD_177", numberOfNodes, 3, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					if(options.trackMatchingProcess)
	...
	protected void removeReference(ReferenceDeleted msg) {
			...
			case "FamiliesSmartEMF.FamilyRegister_families_Family": 
		{
			...
			var match = new StatelessDeltaMatch(msg, "FatherToMale__FWD_177", numberOfNodes, 3, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[0] = msg.source;
			objs[1] = msg.target;
			if(options.trackMatchingProcess)
