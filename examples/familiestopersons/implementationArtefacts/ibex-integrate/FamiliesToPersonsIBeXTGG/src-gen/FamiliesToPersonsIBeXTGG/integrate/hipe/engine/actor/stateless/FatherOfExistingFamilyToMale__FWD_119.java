...
public class FatherOfExistingFamilyToMale__FWD_119 extends GenericStatelessSearchActor{
			...
			case "Family_object_SP7": 
				{
					{
						// f
						var match_0 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__FWD_119", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP4": 
				{
					{
						// fm
						var match_1 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__FWD_119", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP4": 
				{
					{
						// persons
						var match_2 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__FWD_119", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FatherOfExistingFamilyToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_104": 
				{
					...
					{
						var match_0 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__FWD_119", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "FatherOfExistingFamilyToMale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_107": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_1 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__FWD_119", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "FatherOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_110": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_2 = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__FWD_119", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			{
				{
					...
					var match = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__FWD_119", numberOfNodes, 3, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					if(options.trackMatchingProcess)
	...
	protected void removeReference(ReferenceDeleted msg) {
			...
			case "FamiliesSmartEMF.Family_father_FamilyMember": 
		{
			...
			var match = new StatelessDeltaMatch(msg, "FatherOfExistingFamilyToMale__FWD_119", numberOfNodes, 3, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[0] = msg.source;
			objs[1] = msg.target;
			if(options.trackMatchingProcess)
