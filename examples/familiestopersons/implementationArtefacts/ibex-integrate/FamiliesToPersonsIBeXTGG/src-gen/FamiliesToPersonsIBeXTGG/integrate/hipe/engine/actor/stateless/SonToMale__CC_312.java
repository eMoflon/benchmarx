			...
			case "FamilyRegister_object_SP5": 
				{
					{
						// families
						var match_0 = new StatelessDeltaMatch(msg, "SonToMale__CC_312", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Family_object_SP14": 
				{
					{
						// f
						var match_1 = new StatelessDeltaMatch(msg, "SonToMale__CC_312", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP12": 
				{
					{
						// fm
						var match_2 = new StatelessDeltaMatch(msg, "SonToMale__CC_312", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP9": 
				{
					{
						// persons
						var match_3 = new StatelessDeltaMatch(msg, "SonToMale__CC_312", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Male_object_SP2": 
				{
					{
						// p
						var match_4 = new StatelessDeltaMatch(msg, "SonToMale__CC_312", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "SonToMale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_287": 
				{
					...
					{
						var match_0 = new StatelessDeltaMatch(msg, "SonToMale__CC_312", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "SonToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_290": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_1 = new StatelessDeltaMatch(msg, "SonToMale__CC_312", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "SonToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_293": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_2 = new StatelessDeltaMatch(msg, "SonToMale__CC_312", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "PersonRegister_object_SP9": 
				{
					{
						// persons
						var match_3 = new StatelessDeltaMatch(msg, "SonToMale__CC_312", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_3.getNodes()[3] = objs[0];
						match_3.registerSignatureIndex(3);
						if(options.trackMatchingProcess)
			...
			case "Male_object_SP2": 
				{
					{
						// p
						var match_4 = new StatelessDeltaMatch(msg, "SonToMale__CC_312", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_4.getNodes()[4] = objs[0];
						match_4.registerSignatureIndex(4);
						if(options.trackMatchingProcess)
