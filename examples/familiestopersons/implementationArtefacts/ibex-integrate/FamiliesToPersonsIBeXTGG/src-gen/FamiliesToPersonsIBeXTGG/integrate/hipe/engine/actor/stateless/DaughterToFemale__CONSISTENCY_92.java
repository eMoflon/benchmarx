...
public class DaughterToFemale__CONSISTENCY_92 extends GenericStatelessSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						...
						edge_explorer_6_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_DaughterToFemale) o).getCREATE__SOURCE__fm();
						edge_explorer_6_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesSmartEMF.FamilyMember) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_DaughterToFemale_CREATE__SOURCE__fm().getEOpposite());
						edge_explorer_6 = new DeltaAwareEdgeExplorer(this, 7, 2, edge_explorer_6_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_DaughterToFemale_CREATE__SOURCE__fm());
		name2explorer.put("edge_explorer_6", edge_explorer_6);
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.checkSourceType = (o) -> o instanceof FamiliesToPersonsIBeXTGG.ProtocolNode_DaughterToFemale;
						edge_explorer_7_methods.checkTargetType = (o) -> o instanceof FamiliesSmartEMF.FamilyRegister;
						edge_explorer_7_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_DaughterToFemale) o).getCONTEXT__SOURCE__families();
						edge_explorer_7_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesSmartEMF.FamilyRegister) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_DaughterToFemale_CONTEXT__SOURCE__families().getEOpposite());
						edge_explorer_7 = new DeltaAwareEdgeExplorer(this, 7, 0, edge_explorer_7_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_DaughterToFemale_CONTEXT__SOURCE__families());
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						...
						edge_explorer_11_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_DaughterToFemale) o).getCONTEXT__TARGET__persons();
						edge_explorer_11_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((PersonsSmartEMF.PersonRegister) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_DaughterToFemale_CONTEXT__TARGET__persons().getEOpposite());
						edge_explorer_11 = new DeltaAwareEdgeExplorer(this, 7, 5, edge_explorer_11_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_DaughterToFemale_CONTEXT__TARGET__persons());
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						...
						edge_explorer_12_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_DaughterToFemale) o).getCREATE__SOURCE__f();
						edge_explorer_12_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesSmartEMF.Family) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_DaughterToFemale_CREATE__SOURCE__f().getEOpposite());
						edge_explorer_12 = new DeltaAwareEdgeExplorer(this, 7, 1, edge_explorer_12_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_DaughterToFemale_CREATE__SOURCE__f());
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						...
						edge_explorer_13_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_DaughterToFemale) o).getCREATE__TARGET__p();
						edge_explorer_13_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((PersonsSmartEMF.Female) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_DaughterToFemale_CREATE__TARGET__p().getEOpposite());
						edge_explorer_13 = new DeltaAwareEdgeExplorer(this, 7, 6, edge_explorer_13_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_DaughterToFemale_CREATE__TARGET__p());
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.checkSourceType = (o) -> o instanceof FamiliesSmartEMF.Family;
						edge_explorer_15_methods.checkTargetType = (o) -> o instanceof FamiliesSmartEMF.FamilyMember;
						edge_explorer_15_methods.multi_lookup = (o) -> ((FamiliesSmartEMF.Family) o).getDaughters();
						edge_explorer_15_methods.unique_opposite_lookup = (o) -> ((FamiliesSmartEMF.FamilyMember) o).getDaughtersInverse();
						edge_explorer_15 = new DeltaAwareEdgeExplorer(this, 1, 2, edge_explorer_15_methods, FamiliesSmartEMF.FamiliesSmartEMFPackage.eINSTANCE.getFamily_Daughters());
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		outer: switch(match.creator) {
			case "FamilyRegister_object_SP1": 
				{
					if(!lazy_initialization) {
						{
							// families
							var match_0 = new StatelessDeltaMatch(msg, "DaughterToFemale__CONSISTENCY_92", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Family_object_SP2": 
				{
					if(!lazy_initialization) {
						{
							// f
							var match_1 = new StatelessDeltaMatch(msg, "DaughterToFemale__CONSISTENCY_92", numberOfNodes, 3, UsingDeltaMode.CREATE);
							match_1.getNodes()[1] = objs[0];
							match_1.registerSignatureIndex(1);
							if(options.trackMatchingProcess)
								match_1.registerDelta(UsingDeltaMode.CREATE, objs[0]);
							start(edge_explorer_10_1_orchestration, StatelessInputType.OBJECT, match_1);
						}
					}
				}
				break;
			case "FamilyMember_object_SP13": 
				{
					if(!lazy_initialization) {
						{
							// fm
							var match_2 = new StatelessDeltaMatch(msg, "DaughterToFemale__CONSISTENCY_92", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "RegisterToRegisterCorr_object_SP7": 
				{
					if(!lazy_initialization) {
						{
							// families2persons
							var match_3 = new StatelessDeltaMatch(msg, "DaughterToFemale__CONSISTENCY_92", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMemberToPersonCorr_object_SP1": 
					...
					if(!lazy_initialization) {
						{
							...
							var match_4 = new StatelessDeltaMatch(msg, "DaughterToFemale__CONSISTENCY_92", numberOfNodes, 3, UsingDeltaMode.CREATE);
				...
				break;
			case "PersonRegister_object_SP9": 
				{
					if(!lazy_initialization) {
						{
							// persons
							var match_5 = new StatelessDeltaMatch(msg, "DaughterToFemale__CONSISTENCY_92", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Female_object_SP3": 
				{
					if(!lazy_initialization) {
						{
							// p
							var match_6 = new StatelessDeltaMatch(msg, "DaughterToFemale__CONSISTENCY_92", numberOfNodes, 3, UsingDeltaMode.CREATE);
				...
				{
					{
						...
						var match_7 = new StatelessDeltaMatch(msg, "DaughterToFemale__CONSISTENCY_92", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "DaughterToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_58": 
				{
					if(!lazy_initialization) {
						...
						{
							var match_0 = new StatelessDeltaMatch(msg, "DaughterToFemale__CONSISTENCY_92", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "DaughterToFemale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_61": 
				{
					if(!lazy_initialization) {
						var inputMatch = (StatelessDeltaMatch) match;
						{
							var match_1 = new StatelessDeltaMatch(msg, "DaughterToFemale__CONSISTENCY_92", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "DaughterToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_64": 
				{
					if(!lazy_initialization) {
						var inputMatch = (StatelessDeltaMatch) match;
						{
							var match_2 = new StatelessDeltaMatch(msg, "DaughterToFemale__CONSISTENCY_92", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "RegisterToRegisterCorr_object_SP7": 
				{
					{
						// families2persons
						var match_3 = new StatelessDeltaMatch(msg, "DaughterToFemale__CONSISTENCY_92", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_3.getNodes()[3] = objs[0];
						match_3.registerSignatureIndex(3);
						if(options.trackMatchingProcess)
			...
			case "FamilyMemberToPersonCorr_object_SP1": 
				{
					{
						// familyMember2Persons
						var match_4 = new StatelessDeltaMatch(msg, "DaughterToFemale__CONSISTENCY_92", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_4.getNodes()[4] = objs[0];
						match_4.registerSignatureIndex(4);
						if(options.trackMatchingProcess)
			...
			case "PersonRegister_object_SP9": 
				{
					{
						// persons
						var match_5 = new StatelessDeltaMatch(msg, "DaughterToFemale__CONSISTENCY_92", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_5.getNodes()[5] = objs[0];
						match_5.registerSignatureIndex(5);
						if(options.trackMatchingProcess)
			...
			case "Female_object_SP3": 
				{
					{
						// p
						var match_6 = new StatelessDeltaMatch(msg, "DaughterToFemale__CONSISTENCY_92", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_6.getNodes()[6] = objs[0];
						match_6.registerSignatureIndex(6);
						if(options.trackMatchingProcess)
			...
			case "ProtocolNode_DaughterToFemale_object": 
				{
					{
						// _eMoflon_ProtocolNode_
						var match_7 = new StatelessDeltaMatch(msg, "DaughterToFemale__CONSISTENCY_92", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_7.getNodes()[7] = objs[0];
						match_7.registerSignatureIndex(7);
						if(options.trackMatchingProcess)
			...
			{
				{
					...
					var match = new StatelessDeltaMatch(msg, "DaughterToFemale__CONSISTENCY_92", numberOfNodes, 3, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[5] = msg.target;
					if(options.trackMatchingProcess)
	...
	protected void removeReference(ReferenceDeleted msg) {
			...
			case "FamiliesToPersonsIBeXTGG.RegisterToRegisterCorr_target_PersonRegister": 
		{
			...
			var match = new StatelessDeltaMatch(msg, "DaughterToFemale__CONSISTENCY_92", numberOfNodes, 3, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[3] = msg.source;
			objs[5] = msg.target;
			if(options.trackMatchingProcess)
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof PersonsSmartEMF.Female) {
			var match_6 = new StatelessDeltaMatch(initialMessage, "DaughterToFemale__CONSISTENCY_92", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_6.registerSignatureIndex(6);
		...
		if(obj instanceof FamiliesSmartEMF.Family) {
			var match_1 = new StatelessDeltaMatch(initialMessage, "DaughterToFemale__CONSISTENCY_92", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_1.registerSignatureIndex(1);
			match_1.getNodes()[1] = obj;
			start(edge_explorer_10_1_orchestration, StatelessInputType.ATTRIBUTE, match_1);
		}
		if(obj instanceof FamiliesSmartEMF.FamilyMember) {
			var match_2 = new StatelessDeltaMatch(initialMessage, "DaughterToFemale__CONSISTENCY_92", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_2.registerSignatureIndex(2);
