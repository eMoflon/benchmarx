...
public class MotherOfExistingFamilyToFemale__CONSISTENCY_206 extends GenericStatelessSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						...
						edge_explorer_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_MotherOfExistingFamilyToFemale) o).getCREATE__SOURCE__fm();
						edge_explorer_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesSmartEMF.FamilyMember) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_MotherOfExistingFamilyToFemale_CREATE__SOURCE__fm().getEOpposite());
						edge_explorer = new DeltaAwareEdgeExplorer(this, 5, 1, edge_explorer_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_MotherOfExistingFamilyToFemale_CREATE__SOURCE__fm());
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						...
						edge_explorer_3_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_MotherOfExistingFamilyToFemale) o).getCREATE__CORRESPONDENCE__familyMember2Persons();
						edge_explorer_3_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesToPersonsIBeXTGG.FamilyMemberToPersonCorr) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_MotherOfExistingFamilyToFemale_CREATE__CORRESPONDENCE__familyMember2Persons().getEOpposite());
						edge_explorer_3 = new DeltaAwareEdgeExplorer(this, 5, 2, edge_explorer_3_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_MotherOfExistingFamilyToFemale_CREATE__CORRESPONDENCE__familyMember2Persons());
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						...
						edge_explorer_6_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_MotherOfExistingFamilyToFemale) o).getCONTEXT__SOURCE__f();
						edge_explorer_6_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesSmartEMF.Family) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_MotherOfExistingFamilyToFemale_CONTEXT__SOURCE__f().getEOpposite());
						edge_explorer_6 = new DeltaAwareEdgeExplorer(this, 5, 0, edge_explorer_6_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_MotherOfExistingFamilyToFemale_CONTEXT__SOURCE__f());
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						...
						edge_explorer_7_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_MotherOfExistingFamilyToFemale) o).getCREATE__TARGET__p();
						edge_explorer_7_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((PersonsSmartEMF.Female) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_MotherOfExistingFamilyToFemale_CREATE__TARGET__p().getEOpposite());
						edge_explorer_7 = new DeltaAwareEdgeExplorer(this, 5, 4, edge_explorer_7_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_MotherOfExistingFamilyToFemale_CREATE__TARGET__p());
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						...
						edge_explorer_9 = new DeltaAwareEdgeExplorer(this, 0, 1, edge_explorer_9_methods, FamiliesSmartEMF.FamiliesSmartEMFPackage.eINSTANCE.getFamily_Mother());
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						...
						edge_explorer_10_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_MotherOfExistingFamilyToFemale) o).getCONTEXT__TARGET__persons();
						edge_explorer_10_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((PersonsSmartEMF.PersonRegister) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_MotherOfExistingFamilyToFemale_CONTEXT__TARGET__persons().getEOpposite());
						edge_explorer_10 = new DeltaAwareEdgeExplorer(this, 5, 3, edge_explorer_10_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_MotherOfExistingFamilyToFemale_CONTEXT__TARGET__persons());
			...
			case "Family_object_SP9": 
				{
					{
						// f
						var match_0 = new StatelessDeltaMatch(msg, "MotherOfExistingFamilyToFemale__CONSISTENCY_206", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP6": 
				{
					{
						// fm
						var match_1 = new StatelessDeltaMatch(msg, "MotherOfExistingFamilyToFemale__CONSISTENCY_206", numberOfNodes, 3, UsingDeltaMode.CREATE);
				...
				{
					{
						...
						var match_2 = new StatelessDeltaMatch(msg, "MotherOfExistingFamilyToFemale__CONSISTENCY_206", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP6": 
				{
					{
						// persons
						var match_3 = new StatelessDeltaMatch(msg, "MotherOfExistingFamilyToFemale__CONSISTENCY_206", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Female_object_SP3": 
				{
					{
						// p
						var match_4 = new StatelessDeltaMatch(msg, "MotherOfExistingFamilyToFemale__CONSISTENCY_206", numberOfNodes, 3, UsingDeltaMode.CREATE);
				...
				{
					{
						...
						var match_5 = new StatelessDeltaMatch(msg, "MotherOfExistingFamilyToFemale__CONSISTENCY_206", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "MotherOfExistingFamilyToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_178": 
				{
					...
					{
						var match_0 = new StatelessDeltaMatch(msg, "MotherOfExistingFamilyToFemale__CONSISTENCY_206", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "MotherOfExistingFamilyToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_181": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_1 = new StatelessDeltaMatch(msg, "MotherOfExistingFamilyToFemale__CONSISTENCY_206", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "MotherOfExistingFamilyToFemale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_184": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_2 = new StatelessDeltaMatch(msg, "MotherOfExistingFamilyToFemale__CONSISTENCY_206", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "PersonRegister_object_SP6": 
				{
					{
						// persons
						var match_3 = new StatelessDeltaMatch(msg, "MotherOfExistingFamilyToFemale__CONSISTENCY_206", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_3.getNodes()[3] = objs[0];
						match_3.registerSignatureIndex(3);
						if(options.trackMatchingProcess)
			...
			case "Female_object_SP3": 
				{
					{
						// p
						var match_4 = new StatelessDeltaMatch(msg, "MotherOfExistingFamilyToFemale__CONSISTENCY_206", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_4.getNodes()[4] = objs[0];
						match_4.registerSignatureIndex(4);
						if(options.trackMatchingProcess)
			...
			case "ProtocolNode_MotherOfExistingFamilyToFemale_object": 
				{
					{
						// _eMoflon_ProtocolNode_
						var match_5 = new StatelessDeltaMatch(msg, "MotherOfExistingFamilyToFemale__CONSISTENCY_206", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_5.getNodes()[5] = objs[0];
						match_5.registerSignatureIndex(5);
						if(options.trackMatchingProcess)
			...
			{
				{
					...
					var match = new StatelessDeltaMatch(msg, "MotherOfExistingFamilyToFemale__CONSISTENCY_206", numberOfNodes, 3, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[5] = msg.source;
					objs[1] = msg.target;
					if(options.trackMatchingProcess)
	...
	protected void removeReference(ReferenceDeleted msg) {
			...
			case "FamiliesToPersonsIBeXTGG.ProtocolNode_MotherOfExistingFamilyToFemale_CREATE__SOURCE__fm_FamilyMember": 
		{
			...
			var match = new StatelessDeltaMatch(msg, "MotherOfExistingFamilyToFemale__CONSISTENCY_206", numberOfNodes, 3, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[5] = msg.source;
			objs[1] = msg.target;
			if(options.trackMatchingProcess)
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof PersonsSmartEMF.Female) {
			var match_4 = new StatelessDeltaMatch(initialMessage, "MotherOfExistingFamilyToFemale__CONSISTENCY_206", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_4.registerSignatureIndex(4);
		...
		if(obj instanceof FamiliesSmartEMF.Family) {
			var match_0 = new StatelessDeltaMatch(initialMessage, "MotherOfExistingFamilyToFemale__CONSISTENCY_206", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_0.registerSignatureIndex(0);
		...
		if(obj instanceof FamiliesSmartEMF.FamilyMember) {
			var match_1 = new StatelessDeltaMatch(initialMessage, "MotherOfExistingFamilyToFemale__CONSISTENCY_206", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_1.registerSignatureIndex(1);
