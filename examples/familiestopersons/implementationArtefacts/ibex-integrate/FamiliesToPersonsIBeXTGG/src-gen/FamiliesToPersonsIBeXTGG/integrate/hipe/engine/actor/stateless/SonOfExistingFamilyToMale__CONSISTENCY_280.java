...
public class SonOfExistingFamilyToMale__CONSISTENCY_280 extends GenericStatelessSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						...
						edge_explorer_3_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_SonOfExistingFamilyToMale) o).getCREATE__CORRESPONDENCE__familyMember2Persons();
						edge_explorer_3_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesToPersonsIBeXTGG.FamilyMemberToPersonCorr) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonOfExistingFamilyToMale_CREATE__CORRESPONDENCE__familyMember2Persons().getEOpposite());
						edge_explorer_3 = new DeltaAwareEdgeExplorer(this, 5, 2, edge_explorer_3_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonOfExistingFamilyToMale_CREATE__CORRESPONDENCE__familyMember2Persons());
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						...
						edge_explorer_6_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_SonOfExistingFamilyToMale) o).getCREATE__SOURCE__fm();
						edge_explorer_6_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesSmartEMF.FamilyMember) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonOfExistingFamilyToMale_CREATE__SOURCE__fm().getEOpposite());
						edge_explorer_6 = new DeltaAwareEdgeExplorer(this, 5, 1, edge_explorer_6_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonOfExistingFamilyToMale_CREATE__SOURCE__fm());
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						...
						edge_explorer_7_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_SonOfExistingFamilyToMale) o).getCONTEXT__TARGET__persons();
						edge_explorer_7_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((PersonsSmartEMF.PersonRegister) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonOfExistingFamilyToMale_CONTEXT__TARGET__persons().getEOpposite());
						edge_explorer_7 = new DeltaAwareEdgeExplorer(this, 5, 3, edge_explorer_7_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonOfExistingFamilyToMale_CONTEXT__TARGET__persons());
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						...
						edge_explorer_8_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_SonOfExistingFamilyToMale) o).getCONTEXT__SOURCE__f();
						edge_explorer_8_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesSmartEMF.Family) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonOfExistingFamilyToMale_CONTEXT__SOURCE__f().getEOpposite());
						edge_explorer_8 = new DeltaAwareEdgeExplorer(this, 5, 0, edge_explorer_8_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonOfExistingFamilyToMale_CONTEXT__SOURCE__f());
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		outer: switch(match.creator) {
			case "Family_object_SP8": 
				{
					{
						// f
						var match_0 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_280", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP6": 
				{
					{
						// fm
						var match_1 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_280", numberOfNodes, 3, UsingDeltaMode.CREATE);
				...
				{
					{
						...
						var match_2 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_280", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP5": 
				{
					{
						// persons
						var match_3 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_280", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Male_object_SP3": 
				{
					{
						// p
						var match_4 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_280", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "ProtocolNode_SonOfExistingFamilyToMale_object": 
				{
					{
						...
						var match_5 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_280", numberOfNodes, 3, UsingDeltaMode.CREATE);
				...
				break;
			case "SonOfExistingFamilyToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_252": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_0 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_280", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "SonOfExistingFamilyToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_255": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_1 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_280", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "SonOfExistingFamilyToMale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_258": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_2 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_280", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "PersonRegister_object_SP5": 
				{
					{
						// persons
						var match_3 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_280", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_3.getNodes()[3] = objs[0];
						match_3.registerSignatureIndex(3);
						if(options.trackMatchingProcess)
			...
			case "Male_object_SP3": 
				{
					{
						// p
						var match_4 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_280", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_4.getNodes()[4] = objs[0];
						match_4.registerSignatureIndex(4);
						if(options.trackMatchingProcess)
			...
			case "ProtocolNode_SonOfExistingFamilyToMale_object": 
				{
					{
						// _eMoflon_ProtocolNode_
						var match_5 = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_280", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_5.getNodes()[5] = objs[0];
						match_5.registerSignatureIndex(5);
						if(options.trackMatchingProcess)
			...
			{
				{
					...
					var match = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_280", numberOfNodes, 3, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					if(options.trackMatchingProcess)
	...
	protected void removeReference(ReferenceDeleted msg) {
			...
			case "FamiliesSmartEMF.Family_sons_FamilyMember": 
		{
			...
			var match = new StatelessDeltaMatch(msg, "SonOfExistingFamilyToMale__CONSISTENCY_280", numberOfNodes, 3, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[0] = msg.source;
			objs[1] = msg.target;
			if(options.trackMatchingProcess)
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof PersonsSmartEMF.Male) {
			var match_4 = new StatelessDeltaMatch(initialMessage, "SonOfExistingFamilyToMale__CONSISTENCY_280", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_4.registerSignatureIndex(4);
		...
		if(obj instanceof FamiliesSmartEMF.Family) {
			var match_0 = new StatelessDeltaMatch(initialMessage, "SonOfExistingFamilyToMale__CONSISTENCY_280", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_0.registerSignatureIndex(0);
		...
		if(obj instanceof FamiliesSmartEMF.FamilyMember) {
			var match_1 = new StatelessDeltaMatch(initialMessage, "SonOfExistingFamilyToMale__CONSISTENCY_280", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_1.registerSignatureIndex(1);
	...
	private boolean constraint_checker_method(ConstraintCheck constraintCheck) {
		...
		var p = (PersonsSmartEMF.Male) constraintCheck.match().getNodes()[4];
