...
public class Families2Persons__TARGET_103 extends GenericStatelessSearchActor{
			...
			case "PersonRegister_object_SP10": 
				{
					{
						// persons
						var match_0 = new StatelessDeltaMatch(msg, "Families2Persons__TARGET_103", numberOfNodes, 0, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP10": 
				{
					{
						// persons
						var match_0 = new StatelessDeltaMatch(msg, "Families2Persons__TARGET_103", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_0.getNodes()[0] = objs[0];
						match_0.registerSignatureIndex(0);
						if(options.trackMatchingProcess)
