...
public class MotherOfExistingFamilyToFemale__CC_232 extends GenericStatelessSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						...
						edge_explorer = new DeltaAwareEdgeExplorer(this, 0, 2, edge_explorer_methods, FamiliesSmartEMF.FamiliesSmartEMFPackage.eINSTANCE.getFamily_Mother());
			...
			case "Family_object_SP8": 
				{
					{
						// f
						var match_0 = new StatelessDeltaMatch(msg, "MotherOfExistingFamilyToFemale__CC_232", numberOfNodes, 3, UsingDeltaMode.CREATE);
				...
				break;
			case "FamilyRegister_object_SP7": 
				{
					if(!lazy_initialization) {
						{
							// families
							var match_1 = new StatelessDeltaMatch(msg, "MotherOfExistingFamilyToFemale__CC_232", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP5": 
				{
					if(!lazy_initialization) {
						{
							// fm
							var match_2 = new StatelessDeltaMatch(msg, "MotherOfExistingFamilyToFemale__CC_232", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "RegisterToRegisterCorr_object_SP1": 
				{
					if(!lazy_initialization) {
						{
							// families2persons
							var match_3 = new StatelessDeltaMatch(msg, "MotherOfExistingFamilyToFemale__CC_232", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP5": 
				{
					if(!lazy_initialization) {
						{
							// persons
							var match_4 = new StatelessDeltaMatch(msg, "MotherOfExistingFamilyToFemale__CC_232", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Female_object_SP2": 
				{
					if(!lazy_initialization) {
						{
							// p
							var match_5 = new StatelessDeltaMatch(msg, "MotherOfExistingFamilyToFemale__CC_232", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "MotherOfExistingFamilyToFemale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_204": 
				{
					if(!lazy_initialization) {
						...
						{
							var match_0 = new StatelessDeltaMatch(msg, "MotherOfExistingFamilyToFemale__CC_232", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "MotherOfExistingFamilyToFemale_fm_sons_2_incoming_SOURCE__FILTER_NAC_SRC_207": 
				{
					if(!lazy_initialization) {
						var inputMatch = (StatelessDeltaMatch) match;
						{
							var match_1 = new StatelessDeltaMatch(msg, "MotherOfExistingFamilyToFemale__CC_232", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "MotherOfExistingFamilyToFemale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_210": 
				{
					if(!lazy_initialization) {
						var inputMatch = (StatelessDeltaMatch) match;
						{
							var match_2 = new StatelessDeltaMatch(msg, "MotherOfExistingFamilyToFemale__CC_232", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "RegisterToRegisterCorr_object_SP1": 
				{
					{
						// families2persons
						var match_3 = new StatelessDeltaMatch(msg, "MotherOfExistingFamilyToFemale__CC_232", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_3.getNodes()[3] = objs[0];
						match_3.registerSignatureIndex(3);
						if(options.trackMatchingProcess)
			...
			case "PersonRegister_object_SP5": 
				{
					{
						// persons
						var match_4 = new StatelessDeltaMatch(msg, "MotherOfExistingFamilyToFemale__CC_232", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_4.getNodes()[4] = objs[0];
						match_4.registerSignatureIndex(4);
						if(options.trackMatchingProcess)
			...
			case "Female_object_SP2": 
				{
					{
						// p
						var match_5 = new StatelessDeltaMatch(msg, "MotherOfExistingFamilyToFemale__CC_232", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_5.getNodes()[5] = objs[0];
						match_5.registerSignatureIndex(5);
						if(options.trackMatchingProcess)
			...
			{
				{
					...
					var match = new StatelessDeltaMatch(msg, "MotherOfExistingFamilyToFemale__CC_232", numberOfNodes, 3, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					if(options.trackMatchingProcess)
	...
	protected void removeReference(ReferenceDeleted msg) {
			...
			case "FamiliesSmartEMF.Family_mother_FamilyMember": 
		{
			...
			var match = new StatelessDeltaMatch(msg, "MotherOfExistingFamilyToFemale__CC_232", numberOfNodes, 3, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[0] = msg.source;
			objs[2] = msg.target;
			if(options.trackMatchingProcess)
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof PersonsSmartEMF.Female) {
			var match_5 = new StatelessDeltaMatch(initialMessage, "MotherOfExistingFamilyToFemale__CC_232", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_5.registerSignatureIndex(5);
		...
		if(obj instanceof FamiliesSmartEMF.Family) {
			var match_0 = new StatelessDeltaMatch(initialMessage, "MotherOfExistingFamilyToFemale__CC_232", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_0.registerSignatureIndex(0);
		...
		if(obj instanceof FamiliesSmartEMF.FamilyMember) {
			var match_2 = new StatelessDeltaMatch(initialMessage, "MotherOfExistingFamilyToFemale__CC_232", numberOfNodes, 3, UsingDeltaMode.ATTRIBUTE);
			match_2.registerSignatureIndex(2);
