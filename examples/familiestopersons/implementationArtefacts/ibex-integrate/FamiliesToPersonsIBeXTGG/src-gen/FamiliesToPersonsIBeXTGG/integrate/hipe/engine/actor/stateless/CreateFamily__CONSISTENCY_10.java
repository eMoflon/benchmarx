...
public class CreateFamily__CONSISTENCY_10 extends GenericStatelessSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						...
						edge_explorer_3_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_CreateFamily) o).getCONTEXT__SOURCE__families();
						edge_explorer_3_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesSmartEMF.FamilyRegister) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_CreateFamily_CONTEXT__SOURCE__families().getEOpposite());
						edge_explorer_3 = new DeltaAwareEdgeExplorer(this, 2, 0, edge_explorer_3_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_CreateFamily_CONTEXT__SOURCE__families());
			...
			case "FamilyRegister_object_SP3": 
				{
					if(!lazy_initialization) {
						{
							// families
							var match_0 = new StatelessDeltaMatch(msg, "CreateFamily__CONSISTENCY_10", numberOfNodes, 0, UsingDeltaMode.CREATE);
			...
			case "Family_object_SP3": 
				{
					if(!lazy_initialization) {
						{
							// family
							var match_1 = new StatelessDeltaMatch(msg, "CreateFamily__CONSISTENCY_10", numberOfNodes, 0, UsingDeltaMode.CREATE);
				...
				break;
			case "ProtocolNode_CreateFamily_object": 
				{
					{
						// _eMoflon_ProtocolNode_
						var match_2 = new StatelessDeltaMatch(msg, "CreateFamily__CONSISTENCY_10", numberOfNodes, 0, UsingDeltaMode.CREATE);
			...
			case "FamilyRegister_object_SP3": 
				{
					{
						// families
						var match_0 = new StatelessDeltaMatch(msg, "CreateFamily__CONSISTENCY_10", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_0.getNodes()[0] = objs[0];
						match_0.registerSignatureIndex(0);
						if(options.trackMatchingProcess)
			...
			case "Family_object_SP3": 
				{
					{
						// family
						var match_1 = new StatelessDeltaMatch(msg, "CreateFamily__CONSISTENCY_10", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_1.getNodes()[1] = objs[0];
						match_1.registerSignatureIndex(1);
						if(options.trackMatchingProcess)
			...
			case "ProtocolNode_CreateFamily_object": 
				{
					{
						// _eMoflon_ProtocolNode_
						var match_2 = new StatelessDeltaMatch(msg, "CreateFamily__CONSISTENCY_10", numberOfNodes, 0, UsingDeltaMode.DELETE);
						match_2.getNodes()[2] = objs[0];
						match_2.registerSignatureIndex(2);
						if(options.trackMatchingProcess)
			...
			{
				{
					...
					var match = new StatelessDeltaMatch(msg, "CreateFamily__CONSISTENCY_10", numberOfNodes, 0, UsingDeltaMode.CREATE);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					if(options.trackMatchingProcess)
	...
	protected void removeReference(ReferenceDeleted msg) {
			...
			case "FamiliesSmartEMF.FamilyRegister_families_Family": 
		{
			...
			var match = new StatelessDeltaMatch(msg, "CreateFamily__CONSISTENCY_10", numberOfNodes, 0, UsingDeltaMode.DELETE);
			Object[] objs = match.getNodes();
			objs[0] = msg.source;
			objs[1] = msg.target;
			if(options.trackMatchingProcess)
