...
public class SonToMale__CONSISTENCY_318 extends GenericStatelessSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						...
						edge_explorer = new DeltaAwareEdgeExplorer(this, 6, 5, edge_explorer_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonToMale_CREATE__TARGET__p());
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						...
						edge_explorer_3_methods.checkTargetType = (o) -> o instanceof FamiliesToPersonsIBeXTGG.FamilyMemberToPersonCorr;
						edge_explorer_3_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_SonToMale) o).getCREATE__CORRESPONDENCE__familyMember2Persons();
						edge_explorer_3_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesToPersonsIBeXTGG.FamilyMemberToPersonCorr) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonToMale_CREATE__CORRESPONDENCE__familyMember2Persons().getEOpposite());
						edge_explorer_3 = new DeltaAwareEdgeExplorer(this, 6, 3, edge_explorer_3_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonToMale_CREATE__CORRESPONDENCE__familyMember2Persons());
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						...
						edge_explorer_5_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_SonToMale) o).getCREATE__SOURCE__f();
						edge_explorer_5_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesSmartEMF.Family) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonToMale_CREATE__SOURCE__f().getEOpposite());
						edge_explorer_5 = new DeltaAwareEdgeExplorer(this, 6, 1, edge_explorer_5_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonToMale_CREATE__SOURCE__f());
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						...
						edge_explorer_6 = new DeltaAwareEdgeExplorer(this, 6, 4, edge_explorer_6_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonToMale_CONTEXT__TARGET__persons());
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						...
						edge_explorer_7 = new DeltaAwareEdgeExplorer(this, 3, 5, edge_explorer_7_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getFamilyMemberToPersonCorr_Target());
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						...
						edge_explorer_8 = new DeltaAwareEdgeExplorer(this, 1, 2, edge_explorer_8_methods, FamiliesSmartEMF.FamiliesSmartEMFPackage.eINSTANCE.getFamily_Sons());
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						...
						edge_explorer_9 = new DeltaAwareEdgeExplorer(this, 0, 1, edge_explorer_9_methods, FamiliesSmartEMF.FamiliesSmartEMFPackage.eINSTANCE.getFamilyRegister_Families());
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						...
						edge_explorer_10_methods.unique_lookup = (o) -> ((FamiliesToPersonsIBeXTGG.ProtocolNode_SonToMale) o).getCREATE__SOURCE__fm();
						edge_explorer_10_methods.multi_opposite_lookup = (o) -> (Collection<? extends Object>) ((FamiliesSmartEMF.FamilyMember) o).eGet(FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonToMale_CREATE__SOURCE__fm().getEOpposite());
						edge_explorer_10 = new DeltaAwareEdgeExplorer(this, 6, 2, edge_explorer_10_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonToMale_CREATE__SOURCE__fm());
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						...
						edge_explorer_11 = new DeltaAwareEdgeExplorer(this, 6, 0, edge_explorer_11_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getProtocolNode_SonToMale_CONTEXT__SOURCE__families());
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						...
						edge_explorer_12 = new DeltaAwareEdgeExplorer(this, 3, 2, edge_explorer_12_methods, FamiliesToPersonsIBeXTGG.FamiliesToPersonsIBeXTGGPackage.eINSTANCE.getFamilyMemberToPersonCorr_Source());
		...
		disjoint_explorer_5 = new DisjointExplorer(this, observedResources, 6, (o) -> o instanceof FamiliesToPersonsIBeXTGG.ProtocolNode_SonToMale, true);
			...
			case "FamilyRegister_object_SP6": 
				{
					{
						// families
						var match_0 = new StatelessDeltaMatch(msg, "SonToMale__CONSISTENCY_318", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Family_object_SP15": 
				{
					{
						// f
						var match_1 = new StatelessDeltaMatch(msg, "SonToMale__CONSISTENCY_318", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "FamilyMember_object_SP13": 
				{
					{
						// fm
						var match_2 = new StatelessDeltaMatch(msg, "SonToMale__CONSISTENCY_318", numberOfNodes, 3, UsingDeltaMode.CREATE);
				...
				{
					{
						...
						var match_3 = new StatelessDeltaMatch(msg, "SonToMale__CONSISTENCY_318", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "PersonRegister_object_SP10": 
				{
					{
						// persons
						var match_4 = new StatelessDeltaMatch(msg, "SonToMale__CONSISTENCY_318", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "Male_object_SP3": 
				{
					{
						// p
						var match_5 = new StatelessDeltaMatch(msg, "SonToMale__CONSISTENCY_318", numberOfNodes, 3, UsingDeltaMode.CREATE);
				...
				{
					{
						...
						var match_6 = new StatelessDeltaMatch(msg, "SonToMale__CONSISTENCY_318", numberOfNodes, 3, UsingDeltaMode.CREATE);
			...
			case "SonToMale_fm_father_0_incoming_SOURCE__FILTER_NAC_SRC_287": 
				{
					...
					{
						var match_0 = new StatelessDeltaMatch(msg, "SonToMale__CONSISTENCY_318", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "SonToMale_fm_daughters_3_incoming_SOURCE__FILTER_NAC_SRC_290": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_1 = new StatelessDeltaMatch(msg, "SonToMale__CONSISTENCY_318", numberOfNodes, 3, UsingDeltaMode.DELETE);
				...
				break;
			case "SonToMale_fm_mother_1_incoming_SOURCE__FILTER_NAC_SRC_293": 
				{
					var inputMatch = (StatelessDeltaMatch) match;
					{
						var match_2 = new StatelessDeltaMatch(msg, "SonToMale__CONSISTENCY_318", numberOfNodes, 3, UsingDeltaMode.DELETE);
			...
			case "FamilyMemberToPersonCorr_object_SP1": 
				{
					{
						// familyMember2Persons
						var match_3 = new StatelessDeltaMatch(msg, "SonToMale__CONSISTENCY_318", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_3.getNodes()[3] = objs[0];
						match_3.registerSignatureIndex(3);
						if(options.trackMatchingProcess)
			...
			case "PersonRegister_object_SP10": 
				{
					{
						// persons
						var match_4 = new StatelessDeltaMatch(msg, "SonToMale__CONSISTENCY_318", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_4.getNodes()[4] = objs[0];
						match_4.registerSignatureIndex(4);
						if(options.trackMatchingProcess)
			...
			case "Male_object_SP3": 
				{
					{
						// p
						var match_5 = new StatelessDeltaMatch(msg, "SonToMale__CONSISTENCY_318", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_5.getNodes()[5] = objs[0];
						match_5.registerSignatureIndex(5);
						if(options.trackMatchingProcess)
			...
			case "ProtocolNode_SonToMale_object": 
				{
					{
						// _eMoflon_ProtocolNode_
						var match_6 = new StatelessDeltaMatch(msg, "SonToMale__CONSISTENCY_318", numberOfNodes, 3, UsingDeltaMode.DELETE);
						match_6.getNodes()[6] = objs[0];
						match_6.registerSignatureIndex(6);
						if(options.trackMatchingProcess)
