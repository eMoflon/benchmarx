...
public class SYNC_App extends SYNC {
	...
	protected void registerUserMetamodels() throws IOException {
		...
		loadAndRegisterMetamodel("BenchmarxFamiliesToPersons/lib/ibex/" + options.projectName() + ".ecore");
	}

	protected Resource loadFlattenedTGGResource() throws IOException {
		return loadResource("BenchmarxFamiliesToPersons/lib/ibex/" + options.projectName() + "_flattened.tgg.xmi");
	}

	protected Resource loadTGGResource() throws IOException {
		return loadResource("BenchmarxFamiliesToPersons/lib/ibex/" + options.projectName() + ".tgg.xmi");
	}
