...
import org.emoflon.neo.api.eneofamiliestopersons.org.benchmarx.eneo.f2p.tgg.API_F2P_BWD;
...
public class F2P_BWD_Run {
	protected static final Logger logger = Logger.getLogger(F2P_BWD_Run.class);
	protected String srcModelName;
	protected String trgModelName;
	
	public static void main(String[] args) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new F2P_BWD_Run(SRC_MODEL_NAME, TRG_MODEL_NAME);
		app.run();
	}
	
	public F2P_BWD_Run(String srcModelName, String trgModelName) {
	...
	public NeoGenerator createGenerator(NeoCoreBuilder builder) {
		return new NeoGenerator(//
				new API_F2P_BWD(builder).getAllRulesForF2P_BWD(), //
