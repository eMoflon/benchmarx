 ...
 * @generated
 */
public class PersonRegisterImpl extends EObjectImpl implements PersonRegister {
	/**
	...
	protected EClass eStaticClass() {
		return PersonsPackage.Literals.PERSON_REGISTER;
	}
	...
	public EList<Person> getPersons() {
		if (persons == null) {
			persons = new EObjectContainmentWithInverseEList<Person>(Person.class, this,
					PersonsPackage.PERSON_REGISTER__PERSONS, PersonsPackage.PERSON__PERSONS_INVERSE);
		}
		return persons;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case PersonsPackage.PERSON_REGISTER__PERSONS:
