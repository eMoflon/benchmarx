...
public class SYNC_App extends SYNC {
	...
	protected void registerUserMetamodels() throws IOException {
		...
		loadAndRegisterMetamodel("BenchmarxPetrinetToPetrinetWeighted/lib/eMoflon/" + options.projectName() + ".ecore");
	}

	protected Resource loadFlattenedTGGResource() throws IOException {
		return loadResource("BenchmarxPetrinetToPetrinetWeighted/lib/eMoflon/" + options.projectName() + "_flattened.tgg.xmi");
	}

	protected Resource loadTGGResource() throws IOException {
		return loadResource("BenchmarxPetrinetToPetrinetWeighted/lib/eMoflon/" + options.projectName() + ".tgg.xmi");
	}
