...
public class _SchemaBasedAutoRegistration {
	...
	public static void register(OperationalStrategy strategy) throws IOException {
		strategy.loadAndRegisterMetamodel("platform:/resource/Petrinet/model/PetriNet.ecore");
		strategy.loadAndRegisterMetamodel("platform:/resource/PetrinetWeighted/model/PetriNetWeighted.ecore");
	}
