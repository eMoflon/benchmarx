 ...
 * @generated
 */
public class PnSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static PnPackage modelPackage;
	...
	public PnSwitch() {
		if (modelPackage == null) {
			modelPackage = PnPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PnPackage.NET_ELEMENT: {
				NetElement netElement = (NetElement)theEObject;
				T result = caseNetElement(netElement);
				if (result == null) result = caseNamedElement(netElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PnPackage.TRANSITION: {
