package org.benchmarx.examples.pn2pnw.implementations.medini;
...
public class MediniQVTPn2Pnw extends BXToolForEMF<pn.Net, pnw.Net, Decisions> {
	private static final String RULESET = "pn2pnw.qvt";
	...
	private static final String fwdDir = "weightedPetriNet";
	private static final String bwdDir = "petriNet";
	...
	public void initiateSynchronisationDialogue() {
		...
		source.getContents().add(PnFactory.eINSTANCE.createNet());
		launchFWD();
	}
	...
	protected void collectMetaModels(Collection<EPackage> metaPackages) {
		metaPackages.add(pn.PnPackage.eINSTANCE);
		metaPackages.add(pnw.PnwPackage.eINSTANCE);
	}
